<?php
	...
	/**
	 * Prueba unitaria de la clase ViewAdvancedFilterTest
	 *
	 * @codingStandardsIgnoreStart
	 * @SuppressWarnings(PHPMD)
	 */
	class ViewAdvancedFilterTest extends PHPUnit_Framework_TestCase {
		public function testGettersAndSetters () {
			$object         = ViewAdvancedFilter::getInstance ();
			$testClass      = get_class ($object);
			$testProperties = [
				'columnName' => 'my_column_name',
				'comparator' => array (ViewAdvancedFilterInterface::COMPARATOR_AFTER, ViewAdvancedFilterInterface::COMPARATOR_BEFORE, ViewAdvancedFilterInterface::COMPARATOR_BETWEEN, ViewAdvancedFilterInterface::COMPARATOR_CONTAINS, ViewAdvancedFilterInterface::COMPARATOR_DOES_NOT_CONTAIN, ViewAdvancedFilterInterface::COMPARATOR_ENDS_WITH, ViewAdvancedFilterInterface::COMPARATOR_EQUALS, ViewAdvancedFilterInterface::COMPARATOR_GREATER, ViewAdvancedFilterInterface::COMPARATOR_GREATER_OR_EQUALS, ViewAdvancedFilterInterface::COMPARATOR_LESS, ViewAdvancedFilterInterface::COMPARATOR_LESS_OR_EQUALS, ViewAdvancedFilterInterface::COMPARATOR_NOT_EQUALS, ViewAdvancedFilterInterface::COMPARATOR_STARTS_WITH),
		...
		public function testEmptyColumnNameValidation () {
			...
			$this->expectExceptionMessage (ViewAdvancedFilterException::ERROR_VIEW_ADVANCED_FILTER_EMPTY_COLUMN_NAME);
			$object->validate ();
		}
		...
		public function testEmptyOrInvalidComparatorValidation () {
			...
			$this->expectException (ViewAdvancedFilterException::class);
			$this->expectExceptionMessage (ViewAdvancedFilterException::ERROR_VIEW_ADVANCED_FILTER_EMPTY_COMPARATOR);
			$object->validate ();
		...
		public function testEmptyOrInvalidDataTypeValidation () {
			...
			$this->expectException (ViewAdvancedFilterException::class);
			$this->expectExceptionMessage (ViewAdvancedFilterException::ERROR_VIEW_ADVANCED_FILTER_EMPTY_DATA_TYPE);
			$object->validate ();
		...
		public function testEmptyFieldNameValidation () {
			...
			$this->expectException (ViewAdvancedFilterException::class);
			$this->expectExceptionMessage (ViewAdvancedFilterException::ERROR_VIEW_ADVANCED_FILTER_EMPTY_FIELD_NAME);
			$object->validate ();
		}
		...
		public function testEmptyLabelValidation () {
			$object = ViewAdvancedFilter::getInstance ()
				...
				->setGroupId (6);
			$this->expectException (ViewAdvancedFilterException::class);
			$this->expectExceptionMessage (ViewAdvancedFilterException::ERROR_VIEW_ADVANCED_FILTER_EMPTY_LABEL);
			$object->validate ();
		}
		...
		public function testEmptySequenceValidation () {
			...
			$this->expectException (ViewAdvancedFilterException::class);
			$this->expectExceptionMessage (ViewAdvancedFilterException::ERROR_VIEW_ADVANCED_FILTER_EMPTY_SEQUENCE);
			$object->validate ();
		}
		...
		public function testConstructorWithValidField () {
			...
			$object = ViewAdvancedFilter::getInstance ($field);
		...
		public function testDuplicate () {
			...
			$duplicatedObject = $object->duplicate ($object->getViewId (), $object->getGroupId ());
			...
			$this->assertEquals (ViewAdvancedFilterInterface::COMPARATOR_EQUALS, $duplicatedObject->getComparator (), 'Comparators do not match');
			...
			$this->assertEquals (4, $duplicatedObject->getViewId (), 'View IDs do not match');
