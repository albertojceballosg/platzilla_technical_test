			...
			this.addBoards = function (boards) {
				...
				for (var boardkey in boards) {
					...
					if(board.id != undefined){
						...
						if (board.CalculationTitle !== '') {
                            var calculationData  = document.createElement('calculation');
                            var percentageHtml = board.CalculationPercentage ? ' <span class="calc-percentage">(' + board.CalculationPercentage + ')</span>' : '';
                            calculationData.innerHTML = '<div class="calculation-data"><p><span class="calc-title">' + board.CalculationTitle + ' ' + board.CalculationField + '</span><br><span class="calc-value">' + board.CalculationValue + percentageHtml + '</span></p></div>';
						}
						//content board
                        ...
                        if (board.CalculationTitle !== '') {
                            boardNode.appendChild(calculationData);
                        }
