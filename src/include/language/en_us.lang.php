<?php
$app_strings = Array(
'Control Hoy'=>'Control Today',
'Negocio'=>'Business',
'La Empresa'=>'Enterprise',
'An&aacute;lisis Informaci&oacute;n'=>'Information Analysis',
'Gr&aacute;ficos'=>'Graphics',
...
'Proyectos'=>'Projects',
'Formación'=>'Training',
'Crear tarea'=>'New ticket',
'LBL_EMAIL_NOT_FOUND'=>'Email not found!',
'LBL_NO_EMAIL_RECEIVED'=>'No email received',
'LBL_EMAIL_LINK_HAS_BEEN_SENT'=>'We sent you a link to reset your password, please check your email',
'LBL_SMTP_ERROR'=>'SMTP server error',
'LBL_NO_TEMPLATE_FOUND'=>'No template for this event',
'LBL_UNKNOWN_ERROR_WHEN_SENDING_MAIL'=>'Unknown error when sending the email',
'TICKET_OPEN'=>'Open',
'TICKET_ASSIGNED'=>'Assigned',
'TICKET_TO_VALIDATE'=>'To validate',
'TICKET_VERIFIED'=>'Verified',
'TICKET_PENDING_CONFIRMATION_OF_CUSTOMER'=>'Pending confirmation of customer',
'TICKET_ACCEPTED'=>'Accepted',
'LBL_RECENT_NEWS'=>'Recent news',
'El Ticket se ha cerrado correctamente, estamos para ayudarle muchas gracias'=>'The Ticket is closed correctly, we are here to help thank you very much',
'todotasks'=>'Todo Tasks',
'todo tasks'=>'Todo Tasks',
'LBL_TODO_TASKS'=>'Todo Tasks',
'LBL_NO_HAY_NOTICIAS_PUBLICADAS'=>'No news published',
'LBL_ESPERE_MIENTRAS_CONECTAMOS_AL_CENTRO_SOPORTE'=>'Please wait. We are connecting to the support center',
...
'LBL_HOME_CALENDAR_EMPTY_TITLE' => 'No data to display',
'LBL_HOME_CALENDAR_EMPTY_DESC'  => 'Try adjusting filters, the date range, or assign new records to this calendar to see events.',
...
'LBL_CREATE_INSTANCE'=>'Create instance',
''=>'platzilla',
''=>'',
'LBL_ADMINISTRAR_RELACIONES' => 'Relationship Administrator',
'LBL_ADMINISTRAR_RELACIONES_PLATAFORMAS' => 'Relationship Administrator',
);
...
'LBL_FILTER_BY_SUPPLIER'=> 'Filter by supplier',
'LBL_NO_SUPPLIERS_REGISTERED'=> 'No suppliers registered',
'LBL_NO_SUPPLIERS_AVAILABLE'=> 'No suppliers available',
'LBL_NO_TASKS_FOR_SUPPLIER'=> 'No information available for the supplier',
'LBL_SELECT_SUPPLIER'=> 'Select a supplier',
'LBL_SUPPLIER'=> 'Supplier',
'sys_lfortnightly'                      => 'Fortnightly',
'cada_cuant'                            => 'Every how many periods',
'mes_anualida'                          => 'Month/Annual',
);?>
