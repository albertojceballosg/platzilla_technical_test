...
function changeModule(){
	...
	if (oModulePick.selectedIndex !== -1) {
		...
		'index.php',
		{
			...
			onComplete: function(response) {
				if(response.responseText){
					...
					//[ TT11270 ] Resoluci�n de fallas Setting Editor de Listas Desplegables - Jesus A.- 11/08/2016
...
function getChildByTagName(elem,tagName){
	//[ TT11270 ] Resoluci�n de fallas Setting Editor de Listas Desplegables - Jesus A.- 11/08/2016
  //Si el elemento es un <tr> se trata diferente y se busca de atras hacia adelante
