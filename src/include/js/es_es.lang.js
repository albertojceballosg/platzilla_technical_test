...
var alert_arr = {
      'DELETE':'¿Borrar los ',
      'RECORDS':' registros?',
      'SELECT':'Debes seleccionar algún registro, para poder eliminarlo',
      ...
      'EXCEEDS_MAX_DECIMALES':' Supera las cifras decimales permitidas ',
      'EXCEEDS_TAXES':' El porcentaje de Comisiones no puede ser mayor a 100 ',
...
//------------ [TT11315] Modificado por Keyla Rodriguez
      'ENTER_TAX_NAME_NUMERIC':'El Nombre del Impuesto no puede ser Númerico',
      'LABEL_TAX_VALUE_EMPTY':'El Valor del Impuesto no puede estar vacío',
      'ENTER_TAX_VALUE_NUMERIC':'El Valor del Impuesto debe ser un valor númerico',
      'ENTER_TAX_VALUE_SUPERIOR':'El Valor del Impuesto no debe ser superior a 100',
      'ENTER_POSITIVE_TAX_VALUE':'Introduzca un Valor de Impuesto positivo',
      'ENTER_CERO_TAX_VALUE':'Introduzca un Valor de Impuesto superior a cero',
      'ENTER_PUNT_TAX_VALUE':'Introduzca un Valor de Impuesto con el separador decimal de punto "." ',
      'LBL_ERR_SOME_TAX_LABELS_EDIT':'Debe seleccionar solo un registro para editar',
      ...
      'ERR_TAX_LABELS': 'Puede haber algún problema al crear el impuesto. Por favor, inténtelo de nuevo',
//-------------------------------------------------------------
      ...
      'LBL_WRONG_IMAGE_TYPE':'Los tipos de archivo permitidos son: jpeg, png, jpg, pjpeg, x-png o gif',
      'LBL_WRONG_IMAGE_FORMAT':'El tipo de archivo permitido es: png',
      ...
      'PLEASE_MOVE_THE_FIELDS_TO_ANOTHER_BLOCK' : 'Por favor del bloque a eliminar: mueve los campos a otro bloque o elimínalos',
      ...
      /* Inventory validation strings */
	    //Ajustando mensaje de validación para el grid de selección de productos.
      ...
      'NO_LINE_ITEM_SELECTED' : 'No hay ningun producto o servicio seleccionado. Por favor seleccione al menos uno.',
      'LINE_ITEM' : 'Línea',
      'LIST_PRICE': 'Precio Lista',
      'INVALID_AMOUNT_CERO_QTY': 'La cantidad debe ser mayor que cero(0)',
      'LINE_ITEM_PRODUCT' : 'Producto o Servicio',
	...
	'CUSTOMER_ROLEID_REQUIRED':'Tipo de cliente requerido',

      //Messages for validate Accounts
      //dmolero
      'PAYMENT_MONTHS_METHOD_PAY' : 'Debe ingresar la cantidad de meses de pago si agrego un m\u00E9todo de pago',
      'PAYMENT_MONTHS_METHOD_PAYPAL' : 'Si el medio de pago es PayPal, la cantidad de meses no debe ser menor a 3 ni mayor a 60',
      'PAYMENT_MONTHS_METHOD_DOMBANC' : 'Si el medio de pago es Domiciliaci\u00F3n Bancaria, la cantidad de meses no debe ser menor a 1 ni mayor a 60',
      'BANKINGACCOUNT_METHOD_DOMBANC' : 'Debe ingresar la informaci\u00F3n de su cuenta corriente si el m\u00E9todo de pago es Domiciliaci\u00F3n Bancaria',
      'PAYMENT_MONTHS_INTEGER' : 'La cantidad de meses debe ser un  n\u00FAmero entero',
      'PAYMENT_MONTHS_MAX' : 'La cantidad de meses no debe ser mayor a 60',
      'HOURS_HELP_FORMAT' : 'Para el campo Horas de Soporte, debe ingresar un n\u00FAmero en formato horas.minutos',
      'EAMIL_REPEAT' : 'El email o email alternativo ya est\u00E1 registrado en otra cuenta',
      'NO_DELETE_ACCOUNT' : 'Esta cuenta no se puede eliminar ya que est\u00E1 asociada a otros m\u00F3dulos',

      //Messages for validate Contacts
      //dmolero
      'EAMIL_REPEAT_CONTACS' : 'El email o email alternativo ya est\u00E1 registrado para otro contacto',
      'MAX_AGE_CONTACS' : 'Fecha de Nacimiento inv\u00E1lida. La edad debe ser mayor a 15 y menor a 130 a\u00F1os',
      'EMAILS_ALTER_DIFERENTS' : 'El email principal y el email secundario deben ser diferentes',

      //Messages Products
      //dmolero
      'NO_DELETE_PRODUCTS' : 'Este producto no se puede eliminar ya que est\u00E1 asociado a otros m\u00F3dulos',

      'INVALID_PERCENTAGE' : 'Inv\u00E1lido porcentaje en ',

      'INVALID_AMOUNT_CERO' : 'El monto debe ser mayor que cero',

      'AMOUNT_DEFAULT_VALUE': ' debe ser al menos 0.00',

      'NUM_DEFAULT_VALUE': ' debe ser al menos 0',

      'EAMIL_REPEAT_LEADS' : 'El email o email alternativo ya est\u00E1 registrado para otro potencial cliente',

      'FIELD_CREATED_SUCCESS' : 'El campo se ha creado correctamente',

      'FIELD_DELETE_SUCCESS' : 'El campo se ha eliminado correctamente',

      'LBL_SUCCESS_WHILE_DELETING_FOLDER' : 'La carpeta ha sido eliminada correctamente',

      'ERROR_SUBMODE' : 'Ha ocurrido un error. Intente de nuevo',

      'CONFIG_APPS_LISTMODULE' : 'Lista de módulos asignados',

      'NAME_REPEAT_CONTRACT' : 'Este contrato de trabajo  ya est\u00E1 registrado',

      'EAMIL_REPEAT_CANDIDATO' : 'El email ya est\u00E1 registrado para otro candidato',
      'NO_IDENT_NOT_EMPTY' : 'Si seleccion\u00F3 un Tipo de Documento de Identidad, debe ingresar Nro de Identidad',
      'TYPE_IDENT_NOT_EMPTY' : 'Si ingres\u00F3 Nro de Identidad, debe seleccionar un Tipo de Documento de Identidad',
      'NAME_REPEAT_PROFESION' : 'Esta Profesi\u00F3n  ya est\u00E1 registrada',
      'NAME_REPEAT_HABILIDAD' : 'Esta Habilidad Profesional ya est\u00E1 registrada',
      'NAME_REPEAT_HABILIDAD_SOCIAL' : 'Esta Habilidad Social ya est\u00E1 registrada',
      'NAME_REPEAT_IDIOMAS' : 'Este Idioma ya est\u00E1 registrado',

      'ERROR_SUBMODE' : 'Ha ocurridoun error. Intente de nuevo',

      'VALID_FIELD_DEPEND' : 'Debe indicar ',

      'MAX_AGE_EMPLOYEES' : 'Fecha de Nacimiento inv\u00E1lida. La edad debe ser mayor a 16 y menor a 120 a\u00F1os',
      'EAMIL_REPEAT_EMPLOYEES' : 'El email ya est\u00E1 registrado para otro empleado',
      'CID_REPEAT_EMPLOYEES' : 'El No. Documento Identidad ya est\u00E1 registrado para otro empleado',
      'SELECT_MODULE_PLAN' : 'Para visualizar los planes del cliente seleccionado, debe seleccionar el módulo',

      'NO_DELETE' : 'No se puede eliminar este registro. Por favor contacte al administrador del sistema',

      'EAMIL_REPEAT_PROVEEDOR' : 'El email ya est\u00E1 registrado para otro proveedor',
      'MAX_LABEL_ERROR': 'El valor máximo no puede ser menor que el valor mínimo',
      'INI_LABEL_ERROR': 'El valor ini debe estar entre valor máximo y mínimo',

      'ACTIVITIES': '¿Desea crear una tarea común para ',

      'VALID_REPORT_MODULE_ACTIVE': 'ya posee un reporte activo',
      'ACTIVATE_REPORT_PDF': 'Debe activar un reporte',

      //Indicators Panel
      'SAVE_BLOCK' : 'El bloque se ha registrado correctamente',
      'SAVE_EDIT_BLOCK' : 'El bloque se ha editado correctamente',
      'COLORBASE_NO_EMPTY' : 'Debe seleccionar un color base',
      'SAVE_NAME_INDICATORS':'Debe agregar el nombre del indicador',
      'SAVE_MONTH_INDICATORS':'Debe seleccionar un mes',
      'SAVE_OBJECTIVE':'Debe indicar un valor objetivo',
      'SAVE_MESOBJECTIVE':'Debe seleccionar el mes',
      'REPETEAT_MESOBJECTIVE':'El mes objetivo no puede duplicarse. Seleccione otro mes',
      'SAVE_CUMPL':'Algún valor de cumplimiento es vacio o inválido. Ingrese valores válidos en cada uno de los campos cumplimiento',
      'FORMAT_PORCENTUAL':'El valor señalado debe mantener el formato original ya sea númerico o porcentual',
      'VALUESUP_MAYOR':'El valor superior debe ser mayor que el valor inferior',
      'RANGO_ENOTRO':'Verificar valores de los rangos. Un rango no puede estar incluido en otro',
      'FORMAT_PORCENTUAL_VAL':'Verificar valores de los rangos. Si especificó valores con el simbolo de %, ambos valores deben indicarse como %',
      'FORMAT_PORCENTUAL_EDIT':'El valor señalado debe mantener el formato especificado en el objetivo ya sea númerico o porcentual',
      'MESS_DELETE_INDICATOR' : 'Está seguro que desea borrar el indicador seleccionado? ',
      'delete_on':'El registro se ha eliminado correctamente',
      'SELECT_ELEMENT_INDICATOR':'Debe seleccionar un elemento indicador para agregar al cálculo',
      'SELECT_ELEMENT_OPERATION':'Debe seleccionar una operación a aplicar entre los Box Score',
      'DELETE_BLOCK':'Si elimina el bloque se eliminarán los indicadores y cálculos registrados. Está seguro que desea borrar el bloque seleccionado?',
      'SELECT_APP_BLOCK':'Seleccione una aplicación',
      'ALL_MONTH_OBJECT':'Todos los meses',

    //Alerts Panel
      'SELECT_ALERT_TYPE':'Seleccione una aplicación',
	  'LBL_SELECT_ALERT':'Seleccione ...',
      'MESS_DELETE_ALERT':'Esta seguro que desea eliminar la alerta seleccionada? ',
      'SAVE_ALERT':'Se ha creado la alerta satisfactoriamente',
	  'SAVE_EDIT_ALERT':'Se ha editado la alerta satisfactoriamente',
	  'INVALID_DATES_SEARCH':'Inválido rango de fecha a consultar',
      'SELECT_ALERT_TITLE':'Debe indicar un nombre para la alerta',
	  'SELECT_ALERT_TYPEALERT':'Seleccione la fuente de la alerta',
	  'SELECT_ALERT_SCALE':'Seleccione la frecuencia de aplicación para la alerta',
      'SELECT_ALERT_ELEMENT':'Seleccione el elemento al cual se aplica la alerta',
      'SELECT_ALERT_FIELD':'Seleccione un campo',
      'SELECT_ALERT_OPERATOR':'Seleccione la condición a aplicar',
      'SELECT_ALERT_VALUE':'Indique el valor de comparación',
