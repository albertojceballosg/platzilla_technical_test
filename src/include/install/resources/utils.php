...
class Migration_Utils {
	...
	static function copyModuleFiles($moduleName, $sourceDirectory, $destinationDirectory) {
		...
		if (!empty($moduleName) && !empty($sourceDirectory) && !empty($destinationDirectory) && $sourceDirectory != $destinationDirectory) {
			...
			if(file_exists("$sourceDirectory/Smarty/templates/{$theme}/modules/$moduleName")) {
				if(!file_exists("$destinationDirectory/Smarty/templates/{$theme}/modules/$moduleName")) {
					mkdir("$destinationDirectory/Smarty/templates/{$theme}/modules/$moduleName".'/',0777);
				}
				Migration_Utils::getFilesFromFolder("{$sourceDirectory}/Smarty/templates/{$theme}/modules/$moduleName/","{$destinationDirectory}/Smarty/templates/{$theme}/modules/$moduleName/");
			}
...
class Common_Install_Wizard_Utils {
	...
	public static $writableFilesAndFolders = array (
		...
		'Smarty Modules Directory' => "./Smarty/templates/centaurus/modules/",
