...
<html>
<head>
<title><?php  echo getTranslatedString('Zona Clientes, Time Management');?></title>
...
<body>
	<table cellspacing="0" cellpadding="0" class="outerTab">
	   ...
	   <tr>
		<td>&nbsp;</td>
		<td class="tableMidone">
			<table class="innerTab"  cellspacing="0" cellpadding="0"   width="100%" border="0">
			   <tr >
				<td  align="center"><img src="images/logotm.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
					...
					<table class="loginTab"  cellspacing="0" cellpadding="0" align="center" >
						...
						<td valign="top">
							<form name="login" action="CustomerAuthenticate.php" method="post">
								...
								<input type="hidden" name="return_action" value="<?php echo $_REQUEST['action']?>">
								<input type="hidden" name="return_id" value="<?php echo $_REQUEST['recordid']?>">
								<input type="hidden" name="ticketid" value="<?php echo $_REQUEST['ticketid']?>">
								<input type="hidden" name="fun" value="<?php echo $_REQUEST['fun']?>">
							   ...
							   <tr>
							   <td colspan="2" class="detailedViewHeader"><b><?php echo getTranslatedString('customerportal');echo " "; ?></b></td>
							   </tr>
							   <tr>
							   ...
							   <tr>
								...
								<td class="dvtCellInfo">
									<select name='login_language' style="width:70%" ONCHANGE="window.location.href = 'login.php?login_language='+this.options[this.selectedIndex].value;">
							   ...
							   <tr>
								<td colspan="2" align="center"><input type="image" width="115" HEIGHT="30" src="boton_entrar_s1.jpg" onclick="return validateLoginDetails();"></td>
							   </tr>
							   <tr>
							   <tr>
								<td>&nbsp;</td>
								<td align="right"><a href='javascript:void(0);' onclick='window.open("supportpage.php?param=forgot_password&login_language=<?php echo $default_language; ?>","ForgotPassword","width=400,height=250");'><?php  echo getTranslatedString('LBL_FORGOT_LOGIN');?></a></td>
							   </tr>							   
...
function validateLoginDetails()
{
	...
	if(user != '')
	{
		...
		{
			alert("<?php echo getTranslatedString('LBL_PLEASE_ENTER_VALID_PASSWORD');?>");
			return false;
		}
	}
	else
	{
		alert("<?php echo getTranslatedString('LBL_PLEASE_ENTER_VALID_USERNAME');?>");
		return false;
	}
}
function trim(s)
