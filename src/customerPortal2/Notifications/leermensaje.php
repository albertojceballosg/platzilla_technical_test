<?php
$notificationid=$_REQUEST['nuemro'];
$notificationid=18993;
	...
	$conex1= mysql_connect((getenv('NOTIF_DB_HOST')?:'127.0.0.1:3306'),(getenv('NOTIF_DB_USER')?:'timeuser'),getenv('NOTIF_DB_PASSWORD'),true) or die("Error al intentar establecer la conexión.");
