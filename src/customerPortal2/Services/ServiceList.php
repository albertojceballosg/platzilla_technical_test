...
$module = 'Services';	
	...
	echo '<tr>
	 			<td><span class="lvtHeaderText">'.getTranslatedString("LBL_SERVICE").'</span</td>';    
		$allow_all = $client->call('show_all',array('module'=>$module),$Server_Path, $Server_Path);
	
	    if($allow_all == 'true'){
	      		echo '<td align="right" style="padding-right:50px;"> <b>'.getTranslatedString('SHOW').'</b>&nbsp; <select name="list_type" onchange="getList(this, \'Services\');">
