				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<td>
									<a href="index.php?module=hito&action=EditView&record={$hito.id}&return_module=proyectos&return_action=DetailView&return_id={$ID}&parenttab="><i class="fa fa-pencil"></i></a>

									<a href="javascript:confirmdelete('index.php?module=proyectos&delmodule=hito&action=DeleteRegistroAsociado&record={$hito.id}&return_module=proyectos&return_action=DetailView&return_id={$ID}&parenttab=')"><i class="fa fa-trash-o"></i></a>

									<button type="button" id="open-wizard-{$hito.id}" idProyecto="{$ID}" idHito="{$hito.id}" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Tarea</button>
								...
								<td>
									...
									<table class="table">
										<tbody>
											...
											<tr>
												<td>
													<a href="index.php?module=todotasks&action=EditView&record={$ticket.ticketid}&return_module=proyectos&return_action=DetailView&return_id={$ID}&parenttab="><i class="fa fa-pencil"></i></a>

													<a href="javascript:confirmdelete('index.php?module=proyectos&delmodule=todotasks&action=DeleteRegistroAsociado&record={$ticket.ticketid}&return_module=proyectos&return_action=DetailView&return_id={$ID}&parenttab=')"><i class="fa fa-trash-o"></i></a>
												</td>
