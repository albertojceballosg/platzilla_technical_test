...
<div class="row" id="task-gantt-{$idGanttDiagram}">
    ...
    <script type="text/javascript" src="themes/centaurus/draggable-kanban-board-ui/js/kanbanJobs.js"></script>
    <script type="text/javascript" src="themes/centaurus/draggable-kanban-board-ui/js/KanbanJobUtils.js"></script>
    <script>
                ...
                jQuery.post('index.php', arguments, function (data) {
                    try {
                        ...
                        if (message.error !== 'OK') {
                            ...
                            alert('El estatus del trabajo han sido actualizado')
                        }
                    }
                    catch (e) {
                        alert (e);
...
{else}
    <div class="alert alert-info">No hay trabajos!  en el periodo</div>
{/if}
