...
<div class="row">
	<div class="col-lg-12">
		<h1>
			<a class="hdrLink" href="index.php?action=index&module={$MODULE}&parenttab={$CATEGORY}">{$MODULELABEL}</a>
		<h1>
	</div>
</div>
<br>
	...
	<div class="col-lg-12">	
		<div class="main-box">
			...
			<header class="main-box-header clearfix">
				<h2 id="settings_mail_fldrname">{'JSLBL_Settings'|@getTranslatedString}</h2>
