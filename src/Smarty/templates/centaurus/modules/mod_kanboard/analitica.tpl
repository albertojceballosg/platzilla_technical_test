							...
							<div class="filter-block pull-right">
								...
								<div class="form-group pull-left col-xs-3" >
									<div class="input-group">
										...
										<input type="text" class="form-control" name="fecha_desde" id="fecha_desde" placeholder="Desde">
									</div>
								</div>
								<div class="form-group pull-left col-xs-3" >
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
										<input type="text" class="form-control" name="fecha_hasta" id="fecha_hasta" placeholder="Hasta">
									</div>
								</div>
				...
				{foreach item=rg2 key=k from=$TODOS_REGISTROS_GENERICOS}
						<div class="cd-timeline-block">
							...
							<div class="cd-timeline-content">
								<h2>[{$rg2.ticket_no}] {$rg2.title}</h2>
								<p>{$rg2.status|@getTranslatedString:$MODULE}<br/>
								Cliente: {$rg2.accountname}<br/>
								Asignado a: {$rg2.user_name}
								</p>
								<div class="clearfix">
									<a class="btn btn-primary pull-right" href="index.php?action=DetailView&module=HelpDesk&record={$rg2.ticketid}">Ver</a>
								</div>
