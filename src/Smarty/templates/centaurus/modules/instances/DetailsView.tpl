...
<div class="col-lg-12">
	...
	<div class="pull-right text-right">
		...
		<form action="index.php" method="post" onclick="return confirm ('¿Estás seguro que quieres actualizar la instancia {$INSTANCE->getCode ()}?');" style="display: inline; margin-left: 5px;">
			...
			<button type="submit" class="btn btn-info" title="Actualizar">Actualizar</button>
		</form>
		...
		<div class="main-box">
			...
			<div class="main-box-body clearfix">
				...
				<div class="col-md-6">
					<div class="col-md-4">
						<div class="label-input">
							<label for="status">Perfil de uso</label>
						</div>
					</div>
					<div class="form-group col-md-8">
						<div class="input-group" style="width: 100%;">
							<span id="status" class="form-control" readonly="readonly">{$INSTANCE->getProfileCode ()}</span>
						</div>
					</div>
				</div>
