		...
		<div class="main-box no-header clearfix" style="">
			<form onsubmit="VtigerJS_DialogBox.block();" action="index.php" method="POST" name="EditView">
					<div align="center">
						...
						<table width="95%" cellspacing="0" cellpadding="0" border="0" class="table" align="center">
							<tr>
								<td>
									<table width="100%" cellspacing="0" cellpadding="3" border="0" class="table">
									<tr>
										<td nowrap="" style="width: 10px;" >&nbsp;</td>
										<td width="75" nowrap="" align="center"  style="width: 15%;"><b>{$MOD.LBL_CONFIG_FILE}</b></td>
												...
												<td align="left" style="padding:10px;">
													<table border=0 cellspacing=0 cellpadding=5 width=100% class="table">
														<tr>
															<td colspan=2>
																<div align="center">
																	<input type='submit' class="btn btn-primary" value="{$APP.LBL_SAVE_LABEL}" onclick="if(valid(this)){ldelim}return true;{rdelim}else{ldelim}return false;{rdelim}">
																	<input type='button' class="btn btn-cancel" value="{$APP.LBL_CANCEL_BUTTON_LABEL}" onclick="location.href='index.php?module=Settings&action=index&parenttab=Settings'">
																...
																<tr bgcolor=white valign=center style="height:25px;">
																	...
																	<td >
																		{if $CONFIGLINE->isEditable()}
																			{if $VARMETA.values}
																				<select class="form-control" name="key_{$CONFIGLINE->variableName()}" id="key_{$CONFIGLINE->variableName()}">
																			...
																			{else}
																				...
																				{else}
																						<input type="text" name="key_{$CONFIGLINE->variableName()}" id="key_{$CONFIGLINE->variableName()}" value="{$CONFIGLINE->variableValue()}"  onblur="this.className='detailedViewTextBox'" onfocus="this.className='detailedViewTextBoxOn'"  >
																				{/if}
																			{/if}
																		{else}
