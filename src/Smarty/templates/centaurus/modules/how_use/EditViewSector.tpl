{strip}
    {if ($COMPANY_SECTOR neq NULL)}
        {assign var='id' value=$COMPANY_SECTOR->getId()}
        {assign var='description' value=$COMPANY_SECTOR->getDescription()}
        {assign var='name' value=$COMPANY_SECTOR->getName()}
    {else}
    ...
    <form class="form-horizontal" name="company-sector-form" role="form" method="post" action="index.php">
        ...
        <input type="hidden" name="action" value="SaveSector"/>
        ...
        <div class="row">
            <div class="col-xs-12">
                <h1 class="pull-left">
                    <a href="index.php?module=how_use&action=ListView&tab=company_sector&parenttab=Settings">{$MOD['how_use']}</a>
                </h1>
                <div class="action-bar pull-right">
                    <button type="submit" class="btn btn-info">Guardar</button>
                    <a href="index.php?module=how_use&action=ListView&tab=company_sector&parenttab=Settings" class="btn btn-warning"
            ...
            <div class="col-xs-12">
                <div class="main-box">
                    <header class="main-box-header clearfix">
                        <h2 class="pull-left">Sector: Información general</h2>
                    </header>
                            ...
                            <div class="form-group">
                                ...
                                <div id="cs-div-description" class="col-md-7">
                                    <textarea class="form-control" name="description" id="sector_description"
                                              rows="3"
                                              placeholder="Breve descripción del sector económico">{$description}</textarea>
