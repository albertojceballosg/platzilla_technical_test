{strip}
    {if ($COMPANY_TYPE neq NULL)}
        {assign var='id' value=$COMPANY_TYPE->getId()}
        {assign var='description' value=$COMPANY_TYPE->getDescription()}
        {assign var='name' value=$COMPANY_TYPE->getName()}
    {else}
    ...
    <form class="form-horizontal" name="company-sector-form" role="form" method="post" action="index.php">
        ...
        <input type="hidden" name="action" value="SaveType"/>
        ...
        <div class="row">
            <div class="col-xs-12">
                <h1 class="pull-left">
                    <a href="index.php?module=how_use&action=ListView&tab=company_type&parenttab=Settings">{$MOD['how_use']}</a>
                </h1>
                <div class="action-bar pull-right">
                    <button type="submit" class="btn btn-info">Guardar</button>
                    <a href="index.php?module=how_use&action=ListView&tab=company_type&parenttab=Settings"
            ...
            <div class="col-xs-12">
                <div class="main-box">
                    <header class="main-box-header clearfix">
                        <h2 class="pull-left">Tipos de empresas: Información general</h2>
                    </header>
                            ...
                            <div class="form-group">
                                ...
                                <div id="ct-div-name" class="col-md-7">
                                    <input type="text" class="form-control" id="sector_name" name="name"
                                           ...
                                           placeholder="Nombre del tipo de empresa">
                            ...
                            <div class="form-group">
                                ...
                                <div id="ct-div-description" class="col-md-7">
                                    <textarea class="form-control" name="description" id="sector_description"
                                              rows="3"
                                              placeholder="Breve descripción del tipo de empresa">{$description}</textarea>
