...
<div class="row">
	<div class="col-xs-12">
		<h1 class="pull-left"><a href="index.php?module=backgroundtasks&action=ListView&parenttab=Settings">Registro de eventos tarea automátizada</a></h1>
		<div class="action-bar pull-right">
			<form action="index.php" method="post" onsubmit="return confirm ('Se eliminará el registro de eventos. ¿Estás seguro?');">
				...
				<input type="hidden" name="record" value="{$TASK_ID}" />
					...
					<div class="col-md-12">
						...
						<div class="form-group col-md-11 field-container">
							<div class="input-group" style="width: 100%;">
								<input type="text" id="taskname" name="taskname" value="{$TASK_NAME}" class="form-control" disabled="disabled" />
							</div>
						</div>
					</div>
				</div>
...
{if (!empty ($LOG_FILE_HANDLE))}
	...
	{/while}
{else}
								No hay eventos registrados para la tarea
{/if}
							</textarea>
						</div>
					</div>
