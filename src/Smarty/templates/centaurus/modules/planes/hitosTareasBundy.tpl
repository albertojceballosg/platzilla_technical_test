				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<td>
									<a href="index.php?module=intervencion&action=EditView&record={$hito.id}&return_module={$MODULE}&return_action=DetailView&return_id={$ID}&parenttab="><i class="fa fa-pencil"></i></a>

									<a href="javascript:confirmdelete('index.php?module={$MODULE}&delmodule=intervencion&action=DeleteRegistroAsociado&record={$hito.id}&return_module={$MODULE}&return_action=DetailView&return_id={$ID}&parenttab=')"><i class="fa fa-trash-o"></i></a>
