    ...
    <div id="gv-div-description" class="form-group col-lg-11 col-md-11 col-sm-11" style="margin-bottom: 2px!important;">
        <div class="row">
            <div class="col-md-4 text-right">
                <label for="fromfieldname">Tipo de empresa:</label>
            </div>
            <div id="div-drb-name" class="form-group col-md-6 field-container">
                <select class="form-control"
                    ...
                    {if isset($BUSINESS_TYPE) && $BUSINESS_TYPE neq NULL}
                        <option value="">Seleccionar tipo de empresa</option>
                        {foreach $BUSINESS_TYPE->getValues() as $values}
                        ...
                        {/foreach}
                    {else}
                        <option value="">Upoo! no hay tipos de empresas disponibles</option>
                    {/if}
                </select>
