...
{else}
	<div class="row">
		<div class="col-md-6" style="margin-top: 2px!important;">
			<div class="btn-group btn-control pull-left" style="margin-left: -2.5em!important;">
				<button type="button" class="btn btn-primary" title="Graficos" style=" font-size: 15px!important; height: 2.3em; margin-right:0.05em;margin-left:0.05em;"><i class="fa fa-bar-chart-o"></i>
				</button>
				<a data-toggle="tab" href="#tab-metrics-reports-{$idDetailView}" class="btn btn-default" style=" font-size: 15px!important;height: 2.3em; margin-right:0.05em;margin-left:0.05em;" title="Informes" onclick="DetailViewTabUtils.activeReportsTab (event, '{$idDetailView}', '{$FLMODULE}')"><i class="fa fa-file" aria-hidden="true"></i></a>
			</div>
