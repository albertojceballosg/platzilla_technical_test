            ...
            <table class="table table-condensed" width="100%">
                ...
                <tr class="no-bordered">
                    ...
                    <td width="20%" align="left">
                        ...
                        <p class="invoice-company">Factura</p>
                        <div id="logo" style="max-width: 158px;overflow: hidden">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-12" style="margin-top: 15px; height: 10px">
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table-invoice table-bordered">
                    ...
                    {if $totalDataGrid gt 0}
                        ...
                        <tr>
                            ...
                            <td class="invoice-cell-numbre" width="20%" align="right">{$CUSTOMER_ORDER['tax'][$k]}</td>
                            <td class="invoice-cell-numbre" width="20%" align="right">{$CUSTOMER_ORDER['discount'][$k]}</td>
                            <td class="invoice-cell-numbre" width="20%" align="right">{$CUSTOMER_ORDER['amount'][$k]}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="table-bordered invoice-cell-numbre" width="20%" align="right">{$TOTAL_AMOUNT}</td>
                        </tr>
                        <tr>
                            <td colspan="4" width="80%" align="right">&nbsp;Saldo Tax</td>
                            <td class="table-bordered invoice-cell-numbre" width="20%" align="right">{$tax}</td>
                        </tr>
                        <tr>
                            <td  class="no-bordered" colspan="4" width="80%" align="right"><p class="invoice-company"  style="color: #ff2222">TOTAL</p></td>
                            <td class="active table-bordered invoice-cell-numbre" width="20%"><p class="invoice-company" style="color: #ff2222">{($TOTAL_AMOUNT  + $tax)}</p></td>
                        </tr>
                    {else}
                        <tr>
                        ...
                        <tr>
                            <td  class="no-bordered" colspan="4" width="80%" align="right"><p class="invoice-company" style="color: #ff2222">TOTAL</p></td>
                            <td class="active  invoice-cell-numbre" width="20%"><p class="invoice-company" style="color: #ff2222">99.99</p></td>
                        </tr>
                    {/if}
                    </tbody>
                </table>
