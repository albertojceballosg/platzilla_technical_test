<div class="container">
    <div class="row">
        <div class="col-md-12">
            <p class="invoice-company" style="text-align:center">{$NAME_ORGANIZATION}</p>
        </div>
        <div class="col-md-12">
            <table class="table table-condensed" width="100%">
                ...
                <tr class="no-bordered">
                    <td width="30%"  align="center" valign="top">
                        <p>&nbsp;</p>
                        <p style="margin-top:0px ">{$ADDRESS_ORGANIZATION}</p>
                        <p style="text-align: left">{$ORGANIZATION_PCODE}</p>
                    </td>
                    <td width="40%" align="center" style="vertical-align: top">
                        &nbsp; <p class="invoice-big-title">FACTURA PROFORMA</p>
                    </td>
    ...
    <div class="row" >
        <div class="col-md-12">
            <div>
                <table class="table table-bordered"   bgcolor="#f0f2ff">
                    <tbody>
                    <tr class="active">
                    ...
                    {if $totalDataGrid gt 0}
                        ...
                        <tr>
                            ...
                            <td class=" invoice-cell-numbre" width="20%" align="right">{$tax|number_format:2:",":"."}</td>
                        </tr>
                        <tr>
