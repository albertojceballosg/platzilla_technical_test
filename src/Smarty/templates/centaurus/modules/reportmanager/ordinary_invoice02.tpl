    ...
    <div class="row">
        <div class="col-md-12">
            <table  width="100%">
                ...
                <tr bgcolor="#0489B1"  class="no-bordered">
                    <td  width="80%"  align="left" style="vertical-align:middle;padding: 6px">
                        <div style="margin: 25px">
                            <p class="invoice-company" style="color: white; text-align: left;padding: 6px">{$NAME_ORGANIZATION}</p>
                            <p style="color: white; text-align: left;padding: 6px">{$ADDRESS_ORGANIZATION}</p>
                            <p style="color: white; text-align: left;padding: 6px">{$ORGANIZATION_PCODE}</p>
                        </div>
                    </td>
                    <td  width="20%" style="vertical-align:middle;padding: 6px">
                        <div style="margin: 25px">
                             <p class="invoice-company" style="color: white; text-align: right;padding: 6px">FACTURA</p>
                        </div>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="col-md-12" style="margin-top: 45px; height: 25px"></div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div>
                ...
                <table class="table-invoice table-bordered">
                    ...
                    {if $totalDataGrid gt 0}
                        ...
                        <tr>
                            ...
                            <td class="table-bordered invoice-cell-numbre" width="20%" align="right">{$TOTAL_AMOUNT|number_format:2:",":"."}</td>
                        </tr>
                        <tr>
                            <td colspan="4" width="80%" align="right">&nbsp;Impuesto</td>
                            <td class="table-bordered invoice-cell-numbre" width="20%" align="right">{$tax|number_format:2:",":"."}</td>
                        </tr>
                        <tr>
                            <td  class="no-bordered" colspan="4" width="80%" align="right"><p class="invoice-company">TOTAL</p></td>
                            <td class="active table-bordered invoice-cell-numbre" width="20%">{($TOTAL_AMOUNT  + $tax)|number_format:2:",":"."}</td>
                        </tr>
                    {else}
                        <tr>
