            ...
            <div>
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tr class="active">
                        ...
                        <th width="14%" align="center" style="font-size: 11px">PRECIO ({$CURRENCY})</th>
                        <th width="14%" align="center" style="font-size: 11px">DESCUENTO&nbsp;(%)</th>
                        <th width="14%" align="center" style="font-size: 11px">SUBTOTAL ({$CURRENCY})</th>
                        <th width="14%" align="center" style="font-size: 11px">IMPUESTO ({$CURRENCY})</th>
                    ...
                    {if $totalDataGrid gt 0}
                        ...
                        <tr>
                            ...
                            <td class="invoice-cell-numbre" width="14%" align="right"  style="padding-right: 12px;vertical-align: top">{$row.descuento_|number_format:2:",":"."}</td>
