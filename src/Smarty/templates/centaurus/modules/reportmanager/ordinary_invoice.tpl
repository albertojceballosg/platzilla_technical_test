            ...
            <div>
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    {if $totalDataGrid gt 0}
                        ...
                        <tr>
                            <td width="22%" align="left" style="vertical-align: top">&nbsp;{$row.articulo}</td>
                            ...
                            <td class="invoice-cell-numbre" width="14%" align="right"  style="padding-right: 12px;vertical-align: top">{$row.sub_total|number_format:2:",":"."}</td>
