            ...
            <table class="table rules justify-content-center">
                ...
                {foreach $ANSWERS_OPTIONS as $answerOption}
                    ...
                    <tr class="rule ">
                        ...
                        <td style="width: 15%" style="vertical-align: top!important;">
                        ...
                        <td style="vertical-align: top!important;width: 65%">
                            <div class="checkbox pull-left" style="margin-top: 0;width: 100%!important;">
    ...
    <div class="col-md-8 rounded border" style="padding: 10px; background-color: #f9f8f7">
        <div class="table-responsive">
            <table class="table rules justify-content-center">
                <thead>
                <tr>
                    <th class="" style="width: 20%">Foto</th>
                    <th class="" style="width: 40%;text-align: right">Etiqueta</th>
                    <th class="" style="width: 410%">Valor</th>
                </tr>
                </thead>
