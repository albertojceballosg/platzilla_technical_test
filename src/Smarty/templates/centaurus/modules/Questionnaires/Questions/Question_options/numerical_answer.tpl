                ...
                <div class="col-md-6" style="margin-top: 8px">
                    ...
                    <div class="col-md-4">
                        <div class="label-input">
                            <label for="number_answere" class="animate__animated ">
                                Respuesta numerica</label>
                        </div>
                    </div>
...
<div class="row-question-view justify-content-center"  style="margin-bottom: 20px">
    ...
    <div class="col-md-6"  style="margin-top: 8px">
        ...
        <div class="form-group col-md-8 field-container">
            <input type="number" tabindex=""  name="question[{$ID}][response][0][value]" id="question_response" value="" class="form-control">
        </div>
    </div>
    <div class="col-md-6">
        <div class="col-md-4">
    ...
    <div class="col-md-12 text-center"><small>Inserte la respuesta esperada.</small></div>
    </div>
</div>
{/if}