    ...
    <div class="col-md-8 rounded border" style="padding: 10px; background-color: #f9f8f7">
        <div class="table-responsive">
            <table class="table rules justify-content-center">
                ...
                <tbody id="TBODY-MORE_THAT_ONE_IMAGES-{$idOption}" data-next-option="{$NUM_ROWS}">
                {foreach $ANSWERS_OPTIONS as $answerOption}
                    ...
                    <tr class="rule ">
                        ...
                        <td class="">
                            </button>&nbsp;<button type="button" class="btn btn-link" data-tamplate="MORE_THAT_ONE_IMAGES" title="Eliminar"
        ...
        <div class="action-bar text-center">
            ...
            <button type="button" class="btn btn-link"
                    title="Agregar opción" data-tamplate="MORE_THAT_ONE_IMAGES"
    ...
    <div class="col-md-8 rounded border" style="padding: 10px; background-color: #f9f8f7">
        <div class="table-responsive">
            <table class="table rules justify-content-center">
                ...
                <tbody id="TBODY-MORE_THAT_ONE_IMAGES-{$idOption}" data-next-option="1">
                <tr class="rule ">
                    <td style="vertical-align: top!important;width: 20%">
                        <div class="fileUpload btn btn-simple pull-left" style="width: 9em;">
                            <span>Examinar</span>
                            ...
                            <input type="hidden" name="question[{$ID}][response][0][image_type]" id="photo-{$idOption}"
                                   value="">
                        </div>
                    </td>
                    <td style="width: 15%;vertical-align: top!important">
                    ...
                    <td style="vertical-align: top!important;;width: 45%">
                        <div class="checkbox pull-left" style="margin-top: 0;width: 100%">
                            <label class="col-md-12" style="margin-bottom: 1px">
                    ...
                    <td class="">
                        </button>&nbsp;<button type="button" class="btn btn-link" data-tamplate="MORE_THAT_ONE_IMAGES"
                                               title="Eliminar"
        ...
        <div class="action-bar text-center">
            ...
            <button type="button" class="btn btn-link" title="Agregar opción" data-tamplate="MORE_THAT_ONE_IMAGES"
                    onclick="QuestionUtils.addResponseOption (this, '{$idOption}');"><i class="fa fa-plus"></i></button>
        </div>
    </div>
</div>
{/if}
<script type="text/html" id="MORE_THAT_ONE_IMAGES-TEMPLATE-{$idOption}">
    <tr class="rule ">
        <td style="vertical-align: top!important;;width: 20%">
            <div class="fileUpload btn btn-simple pull-left" style="width: 9em;">
                <span>Examinar</span>
