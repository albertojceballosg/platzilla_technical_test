    ...
    <div class="row-question-view justify-content-center" style="margin-bottom: 20px">
        <div class="col-md-11 rounded border" style="padding: 10px; background-color: #f9f8f7">
            <div class="table-responsive">
                <table class="table rules justify-content-center" style="width: 100%">
                    <thead>
                    <tr>
                        <th  class="" style="width: 15%">Foto</th>
                        <th class="" style="width: 65%; text-align: left">Etiqueta</th>
                    ...
                    {foreach $ANSWERS_OPTIONS as $answerOption}
                        ...
                        <tr class="rule ">
                            ...
                            <td style="width: 65%;vertical-align: top!important;">
                                <div class="field-container pull-left" style="width: 100%!important;">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <input type="radio" class=" pull-right" disabled name="question[{$ID}][response][0][selected]"
