    {if $EMAILS_ARCHIVED|@count gt 0}
        {foreach $EMAILS_ARCHIVED as $emails}
            <a  class="list-group-item {if $emails.module == 'emailssent'}parley-link-own{/if} " title="Responder">
                {if $emails.module == 'emailssent'}
                    <div class="row parley-own rounded">
                        ...
                        <div class="col-md-11">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <button style="font-size: x-small !important;"  type="button" class="btn btn-link btn-sm associated-to" data-ref="index.php?module={$emails.relmodule}&parenttab=&action=DetailView&record={$emails.relcrmid}"
                                            onclick="NotificationCenterUtils.relatedEmailLink(this)">Asociada a:&nbsp;{$emails.relmodule},&nbsp;Registro: {$emails.relcrmid}</button>
                                </div>
                                <div class="col-md-3">
                        ...
                        {if $emails.send_body neq ''}
                            <div class="col-md-12" style="margin-top: 6px">
                                <button style="font-size: x-small !important;"  type="button" class="btn btn-link btn-sm" data-record="{$emails.send_id}"  data-target="#body-send_{$emails.send_id}" onclick="NotificationCenterUtils.redArchivedEmail(this)">
                    ...
                    <div class="row parley-others rounded">
                        <div class="col-md-11">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <button style="font-size: x-small !important;"  type="button" class="btn btn-link btn-sm associated-to" data-ref="index.php?module={$emails.relmodule}&parenttab=&action=DetailView&record={$emails.relcrmid}"
                                            onclick="NotificationCenterUtils.relatedEmailLink(this)">Asociado a:&nbsp;{$emails.relmodule},&nbsp;Registro: {$emails.relcrmid}</button>
                                </div>
                                <div class="col-md-4">
                        ...
                        {if $emails.recived_subject neq ''}
                            <div class="col-md-12">
                                <button style="font-size: x-small !important;"  type="button" class="btn btn-link btn-sm" data-record="{$emails.recived_id}" data-target="#body-recived_{$emails.recived_id}" onclick="NotificationCenterUtils.redArchivedEmail(this)">
                                    ver&nbsp;<span id="btn-chat" class="glyphicon glyphicon-plus"></span>
                                </button>
