	...
	{foreach item=curso from=$CURSOS}
		...
		<div class="main-box-body clearfix" id="user-profile">
			...
			<div class="project-box-header gray-bg">
				<div class="name">
					<a href="index.php?module=formacion_cursos&parenttab=Analytics&action=DetailView&record={$curso.formacion_cursosid}" title="{$curso.titulo}">
						{$curso.titulo|truncate:35:"...":true}
					</a>
				</div>
			</div><!-- /.box -->
			<div class="">
			...
			<div class="project-box-footer clearfix">
				<div style="  padding: 9px;font-size: 0.875em;font-weight: 300;color: #344644;  max-height: 35px;" title="{$curso.descripcion}">
					{$curso.descripcion|strtolower|ucfirst|truncate:50:"...":true}
				</div>
			</div>
					...
					<div class="story-content pull-right" style="padding-top: 7px;padding-left: 0px;">
						<footer class="story-footer">
							<a href="#" class="story-comments-link">
								<i class="fa fa-comment fa-lg"></i> 120 Comentarios
							</a>
							<a href="#" class="story-likes-link">
								<i class="fa fa-heart fa-lg"></i> 82 Likes
							</a>
						</footer>
					</div>
				</div>
