...
<div id="pickListDependencyList">
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="table">
		<tr>
			<td  width="70%" nowrap>
				...
				<select name="pickmodule" id="pickmodule"  onChange="changeDependencyPicklistModule();">
			...
			<td  align=right>
				<input title="{$MOD_PICKLIST.LBL_NEW_DEPENDENCY}" class="btn btn-primary" type="button" name="New" value="{$MOD_PICKLIST.LBL_NEW_DEPENDENCY}" onclick="addNewDependencyPicklist();"/>
			</td>
		</tr>
	</table>
	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="table">
		<tr>
			...
			<th  valign=top width=25%>{$APP.LBL_MODULE}</th>
			<th  valign=top width=30%>{$MOD_PICKLIST.LBL_SOURCE_FIELD}</th>
			<th  valign=top width=30%>{$MOD_PICKLIST.LBL_TARGET_FIELD}</th>
			<th  valign=top width=10%>{$MOD_PICKLIST.LBL_TOOLS}</th>
		</tr>
		...
		<tr>
			<td  valign=top>{$smarty.foreach.dependencylist.iteration}</td>
			<td  valign=top>{$FIELD_MODULE|@getTranslatedString:$FIELD_MODULE}</td>
			<td  valign=top>{$dependencyvalues.sourcefieldlabel|@getTranslatedString:$FIELD_MODULE}</td>
			<td  valign=top>{$dependencyvalues.targetfieldlabel|@getTranslatedString:$FIELD_MODULE}</td>
