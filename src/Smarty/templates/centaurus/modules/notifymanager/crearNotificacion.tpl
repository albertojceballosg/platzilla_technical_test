...
<form action="index.php" method="post" name="EditView" id="notifyForm">
	...
	<input type="hidden" class="form-control" name="mode" value="Creacion" />
	<div class="col-lg-12">
		<div class="row">
			<div class="col-lg-12">
				<div class="col-lg-12">
					<h1 class="col-lg-8 pull-left">{$MOD.notifymanager}</h1>
				...
				<div class="main-box-body no-header clearfix" style="padding-top: 15px;">
					<div class="row">
						<div class="form-group">
							...
							<input class="form-control" name="title" id="title" placeholder="Escriba un titulo para esta Notificación" type="text">
						</div>
						<div class="form-group">
							<label for="description">Descripción</label>
							<input class="form-control" name="description" id="description" placeholder="Describa la Notificación" type="text">
						</div>
						<div class="form-group">
...
{foreach key=keyModulo item=modulo from=$MODULOSDECAMPOS}
								<option value="{$modulo.name}">{$modulo.tablabel} ({$modulo.name})</option>
{/foreach}
							</select>
						</div>
						<div class="form-group">
