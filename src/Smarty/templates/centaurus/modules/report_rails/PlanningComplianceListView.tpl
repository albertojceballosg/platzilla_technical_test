...
{strip}
    ...
    {/block}
    {block name="url_created_file"}index.php?module=report_rails&action=PlanningComplianceEditView&parenttab=Settings&master_report={$MASTER_REPORT->getId()}{/block}
    {block name="lbl_created_btn"}&nbsp;Crear reporte actividades semanales{/block}
    {block name="tab_description"}Gestionar de actividades semanales.{/block}
