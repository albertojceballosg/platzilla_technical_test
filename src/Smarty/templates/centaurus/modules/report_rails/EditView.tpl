...
<form method="post" action="index.php" onsubmit="return NewsUtils.validateForm (this);">
	...
	<div class="row">
		<div class="col-xs-12">
			<h1 class="pull-left">
				<a href="index.php?module=News&action=EditView&parenttab=Settings{block name="selectedTab"}{/block}">Anuncios</a>
			</h1>
			<div class="action-bar pull-right">
				<button type="submit" class="btn btn-info">Guardar</button>
				<a href="index.php?module=News&action=EditView&parenttab=Settings{block name="selectedTab"}{/block}" class="btn btn-warning" style="margin-left: 5px;">Cancelar</a>
			</div>
		</div>
	</div>
