...
{/if}
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            {section name=bar start=1 loop=($TOTAL_CATEGRIES + 1) step=1}
                                <td style="text-align: center;width: 8%;"><small style="text-align: center">{if $VALUE_TYPE eq 'NUMBER'}Suma{else}Conteo{/if}</small></td>
                            {/section}
    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
        <div class="col-lg-4 col-md-4 col-xs-4"></div>
            <div class="col-lg-8 col-md-8 col-xs-8 text-left">
                <div id="piechart_3d" style="margin-top: -10px"></div>
            </div>
        </div>
    </div>
