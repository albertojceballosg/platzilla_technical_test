                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6">
                        <div class="btn-group pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left answer-export" role="menu">
                                    <li><a data-questionnaire="{$askingForQuestionnaireId}"
                                           ...
                                           href="index.php?module=answers&action=AjaxAnswersUtils&questionnaire={$askingForQuestionnaireId}&askingfor={$askingForId}&function=EXPORT_RECORD&open=1&Ajax=true">
                                            Pregunta actual</a>
                                    </li>
                                    <li><a  data-questionnaire="{$askingForQuestionnaireId}"
                                            data-asking-for="{$askingForId}"
                            ...
                            <button type="button"
                                    onclick="ResponseEvaluationUtils.exportTablePdf({$askingForId}, {$askingForQuestionnaireId}, 'survey_open_question')"
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
            <div class="col-lg-6 col-md-6 col-xs-6">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <ul class="list-unstyled">
                        {foreach $askingForResponseOption as $responseOption}
                            <li>{$responseOption->getSurveyTotal()}&nbsp;({$responseOption->getSuveyPorcent()}%)&nbsp;
                                - Valor esperado: {$responseOption->getValue()}<br><span class="help-block">Coincidencias en algunas palabras y/o números</span> </li>
                        {/foreach}
                    </ul>
                </div>
                {/if}
                {if $askingForalculation neq NULL}
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <p class="vorlage" style="float: left">{$CALCULATION}:&nbsp;<strong>{$askingForalculation}
                                <strong></p>
                    </div>
                {/if}
            </div>
