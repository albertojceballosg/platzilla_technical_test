                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            {section name=bar start=1 loop=($TOTAL_CATEGRIES + 1) step=1}
                                <td style="text-align: center;width: 8%;"><small style="text-align: center">Importancia<br>{$smarty.section.bar.index}&nbsp;(Total)</small></td>
                            {/section}
