			...
			<form role="form" action="index.php?module=store&action=createInstanceFromInvitation" method="post" name="signup-form">
				...
				<div id="login-box">
					...
					<div id="login-box-inner">
						<h2>Has recibido una invitación a compartir módulo de Platzilla. Esto significa que:</h2>
						<ul>
						...
						<button type="submit" class="btn btn-success nextBtn">Estoy de acuerdo. Proceder
