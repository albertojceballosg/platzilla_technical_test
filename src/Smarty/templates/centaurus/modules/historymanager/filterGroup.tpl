    ...
    <div class="condition-group list-group filter_goup" id="group-{$groupId}"  data-id="{$groupId}">
        <div class="condition-group-header list-group-item">
            <div class="row">
                ...
                <div class="col-xs-1 text-right">
                    <button type="button" class="btn btn-link" onclick="HistoryUtils.eraseFilterGroup (this);" title="Eliminar grupo de condiciones"><i class="fa fa-trash-o"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="condition-group-footer list-group-item">
            <div class="row text-center">
                <button type="button" class="btn btn-link" onclick="HistoryUtils.setFilterRow (this);" title="Agregar condición"><i class="fa fa-plus"></i></button>
            </div>
        </div>
