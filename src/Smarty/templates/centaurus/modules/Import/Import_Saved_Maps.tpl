...
<div class="form-group col-xs-6">
	<label for="save_map_as">{'LBL_USE_SAVED_MAPPING'|@getTranslatedString:$MODULE}</label>
	<select name="saved_maps" id="saved_maps" class="form-control" onchange="ImportJs.loadSavedMap();">
