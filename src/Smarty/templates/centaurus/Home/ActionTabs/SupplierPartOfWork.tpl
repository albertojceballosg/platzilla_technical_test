...
{strip}
    {block name="css"}
        ...
        <style type='text/css'>
            ...
            /* Uniformar tamaño de fuente en todas las columnas de la tabla */
    ...
    {block name="page_header"}
        <div class="row module-buttons">
            <div class="col-lg-12"
                ...
                <div class="pull-left">
                    <a href="index.php?module=Home&action=index" title="Volver a Acciones en curso" style="text-decoration: none">
    ...
    {block name = "header_title"}
        <div class="row">
            <div class="col-md-12">
                <h2 style="text-align: center">Parte de Trabajo - Proveedor</h2>
            </div>
            <div class="col-md-6 pull-left" style="padding: 0 25px">
                <span style="font-weight: bold">Fecha:&nbsp;</span>{$PERIOD_DATES['startdate']}&nbsp;al&nbsp;{$PERIOD_DATES['enddate']}
            </div>
            <div class="col-md-6" style="padding: 0 25px">
                <button type="button" class="btn btn-primary pull-right"
                        onclick="DataViewUtils.printPartWork(this, 'supplier_part_work')"
                        title="Descargar PDF">
        ...
        <div class="row" style="margin-top: 15px;">
            <div class="col-md-12" style="padding: 0 25px;">
                <div class="supplier-info-box">
                    <h4><i class="fa fa-truck"></i>&nbsp;{$SUPPLIER_INFO.supplier_name}</h4>
                    <div class="row">
                        {if $SUPPLIER_INFO.nombre_de_la_sociedad neq ''}
                        <div class="col-md-4 info-item">
                            <span class="info-label">Razón Social:</span> {$SUPPLIER_INFO.nombre_de_la_sociedad}
                        </div>
                        {/if}
                        {if $SUPPLIER_INFO.telefono neq ''}
                        <div class="col-md-4 info-item">
                            <span class="info-label">Teléfono:</span> {$SUPPLIER_INFO.telefono}
                        </div>
                        {/if}
                        {if $SUPPLIER_INFO.email neq ''}
                        <div class="col-md-4 info-item">
                            <span class="info-label">Email:</span> {$SUPPLIER_INFO.email}
                        </div>
                        {/if}
                    </div>
                </div>
        ...
        {else}
            <tr>
                <td colspan="7" class="text-center" style="padding: 20px; color: #999;">
                    <i class="fa fa-info-circle"></i>&nbsp;No hay tareas asignadas a este proveedor en el período seleccionado.
                </td>
            </tr>
        {/if}
    {/block}
