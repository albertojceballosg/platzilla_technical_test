...
{/if}
<div class="conversation-item item-right clearfix"{if ($IS_EMAIL) && (isset ($MESSAGE_ID))} data-id="{$MESSAGE_ID}"{/if}{if ($IS_EMAIL) && (isset ($ACCOUNT_NAME))} data-account="{$ACCOUNT_NAME}"{/if}>
	<div class="conversation-user">
		<img src="{if (!empty ($AVATAR_URI))}{$AVATAR_URI}{else}themes/centaurus/img/avatar_2x.png{/if}" class="img-responsive" alt="">
	</div>
	<div class="conversation-body{if ($IS_EMAIL)} email{/if}">
		<div class="row">
