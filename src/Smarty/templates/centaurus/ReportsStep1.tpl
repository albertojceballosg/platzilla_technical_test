...
<tr>
	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="5" class="table">
			<tr>
				<th width="80%"><h1>{$MOD.LBL_CREATE_REPORT} </h1></th>
				<th  width=30% nowrap class="componentName" align=right>{$MOD.LBL_CUSTOM_REPORTS}</th>
			</tr>
		</table>
		...
		<td>
					...
					<td width="25%" valign="top">
						<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
							<tr><td  style="padding-left:10px;">1. {$MOD.LBL_REPORT_DETAILS}</td></tr>
							<tr><td  style="padding-left:10px;">2. {$MOD.LBL_RELATIVE_MODULE} </td></tr>
					...
					<tr>
						...
						<input type="button" id="back_rep" name="back_rep" value=" &nbsp;&lt;&nbsp;{$APP.LBL_BACK}&nbsp; " class="btn btn-default" onClick="changeStepsback1();">&nbsp;
						<input type="button" id="next" name="next" value=" &nbsp;{$APP.LNK_LIST_NEXT}&nbsp;&rsaquo;&nbsp; " class="btn btn-primary" onClick="changeSteps1();">
