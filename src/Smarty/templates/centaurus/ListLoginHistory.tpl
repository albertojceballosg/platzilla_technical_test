...
<div class="row">
	<div class="col-lg-12">
		...
		<h1>{$MOD.LBL_LOGIN_HISTORY_DESCRIPTION}</h1>
	</div>
</div>
		...
		<div class="col-lg-12">
			<div class="main-box clearfix">
				<header class='main-box-header'>
					<h2>{$MOD.LBL_LOGIN_HISTORY_DETAILS}</h2>
				</header>
				<div class="main-box-body clearfix">
					...
					<div id="" class="table-responsive">
						...
						<table class="table">
							<tbody>
								<tr>
									<td><strong>{$MOD.LBL_USER_AUDIT}</strong></td>
									<td>
										<select name="user_list" id="user_list" onchange="fetchlogin_js({$ID});" class="form-control">
					...
					<div id="login_history_cont" style="">holaaaa</div>
	        ...
	        new Ajax.Request(
                	...
                	{queue: {position: 'end', scope: 'command'},
	                        ...
	                        onComplete: function(response) {
        	                        ...
        	                        console.log("aqui deberia salir " + 'module=Users&action=UsersAjax&file=ShowHistory&ajax=true&record='+id)
