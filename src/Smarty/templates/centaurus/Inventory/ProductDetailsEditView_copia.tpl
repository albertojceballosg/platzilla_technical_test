...
<table width="100%"  border="0" align="center" cellpadding="1" cellspacing="0" class="table" id="proTab">
   ...
   <tr valign="top">
	<th width=5% valign="top" class="text-center" align="right"><b><i title="{$APP.LBL_TOOLS}" class="fa fa-fw fa-wrench"></i></b></th>
	<th width=40% class="text-center"><font color='red'>*</font><b>{$APP.LBL_ITEM_NAME}</b></th>
	{if $MODULE neq 'PurchaseOrder'}
		<th width=10% class="text-center"><i title="{$APP.LBL_QTY_IN_STOCK}" class="fa fa-fw fa-sort-numeric-asc"></i></th>
	{/if}
	<th width=10% class="text-center"><i title="{$APP.LBL_QTY}" class="fa fa-fw fa-plus-circle"></i> {$APP.LBL_QTY}</th>
	<th width=10% class="text-center" align="right"><i title="{$APP.LBL_LIST_PRICE}" class="fa fa-fw fa-list-ol"></i></th>
	<th width=12% nowrap class="text-center" align="right"><b>{$APP.LBL_TOTAL}</b></th>
		...
		{foreach key=row_no item=data from=$ASSOCIATEDPRODUCT name=outer1}
			...
			{assign var="netPrice" value="netPrice"|cat:$row_no}
   			...
   			<tr id="row{$row_no}" style="vertical-align: top;">
				...
				<td id="row{$row_no}_col{$row_no}" class="crmTableRow small text-center">
					{*if $row_no neq 1*}
				...
				<td class="crmTableRow small text-center">
					<input id="{$qty}" name="{$qty}" type="text" onkeyup="validateDecimalGeneral('{$qty}')" class="small form-control" style="width:120px" onfocus="this.className='detailedViewTextBoxOn form-control small'" onBlur="settotalnoofrows(); loadTaxes_Ajax('{$row_no}'); calcTotal(); 
					...
					<table width="100%" cellspacing="0" cellpadding="0">
					   <tr>
							<td class="mini-products" align="right">
								<input id="{$listPrice}" name="{$listPrice}" value="{$data.$listPrice}" type="text" class="form-control text-right" onBlur="calcTotal(); setDiscount(this,'{$row_no}');callTaxCalc('{$row_no}');" style="width:200px" onkeyup="validateDecimalGeneral('{$listPrice}')"/>
							</td>
					   </tr>
					   <td align="right" class="mini-products">&nbsp;</td>
					   <tr>
					   		<!--Descuentos -->
								...
								<div class="discountUI" id="discount_div{$row_no}" style="display:none">
									...
									<div id="email-box" class="clearfix" nowrap>
										<div style="float:left;padding-left:10px;width:100%;font-size:0.9em;">
											<div class="main-box infographic-box" style="float:left;width:360px;max-width:360px;height:250px;max-height:250px;margin-left:5px;padding:10px;">
												...
												<div class="form-group">
													<table width="100%" cellpadding="0" cellspacing="0" class="table">
														<tbody>
															<tr>
																<td style="padding: 1; font-size:0.9em; text-align: left;">
																	<div>
																...
																<td style="padding: 1; font-size:0.9em; text-align: left;"></td>
															</tr>
															<tr>
						...
						<tr><td class="mini-products">&nbsp;</td></tr>
						<tr>
							<td align="right" style="padding:5px;" nowrap><b>{$APP.LBL_TOTAL_AFTER_DISCOUNT} :</b></td>
						</tr>
						<tr><td class="mini-products">&nbsp;</td></tr>
						<tr id="individual_tax_row{$row_no}" class="TaxShow">
							<td align="right" style="padding:5px;" nowrap>(+)&nbsp;<b>
								<a href="javascript:doNothing();" onClick="displayCoords(this,'tax_div{$row_no}','tax','{$row_no}')" >{$APP.LBL_TAX} </a> : </b>
								<div class="discountUI" id="tax_div{$row_no}" style="display:none">
									<!-- we will form the table with all taxes -->
									<div d="tax_table{$row_no}" class="clearfix" nowrap>
														...
														<tbody>
															{foreach key=tax_row_no item=tax_data from=$data.taxes}
															   ...
															   <tr>
																...
																<td align="center" style="padding: 1;  font-size:0.9em;">{$tax_data.taxlabel}</td>
				...
				<td align="right" class="text-center" style="vertical-align: bottom; font-size:0.9em;">
...
{assign var="FINAL" value=$ASSOCIATEDPRODUCT.1.final_details}
   ...
   <tr valign="top" >
	...
	<td class="mini-total" align="right" colspan="2">
		...
		<div class="discountUI" id="discount_div_final" style="display:none">
			...
			<div id="email-box" class="clearfix" nowrap>
				<div style="float:left;padding-left:10px;width:100%;">
					<div class="main-box infographic-box" style="float:right;width:360px;max-width:360px;height:250px;max-height:250px;margin-left:5px;padding:10px;">
	...
	<td id="discountTotal_final"  align="right">{$FINAL.discountTotal_final}</td>
   </tr>
   ...
   <tr id="group_tax_row" valign="top" class="TaxHide" >
	...
	<td id="tax_final" class="mini-total" align="right">0.00</td>
   </tr>
   <!-- Group Tax - ends -->
