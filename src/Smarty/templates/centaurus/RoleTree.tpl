...
<ol class="dd-list" id="{$roleId}">
	<li class="dd-item dd-item-list" onMouseOver="fnVisible ('layer_{$roleId}')" onMouseOut="fnInVisible ('layer_{$roleId}')">
		...
		<div class="dd-handle">
			...
			<div class="nested-links">
				<span class="badge badge-primary">
					<a href="index.php?module=Settings&action=createrole&parenttab=Settings&parent={$roleId}">
	...
	{else}
		...
		<div class="dd-handle{if ($ROLE_DETAILS[$roleId][1] == '1')} green-bg txt-white-hover{elseif ($ROLE_DETAILS[$roleId][1] == '2')} yellow-bg txt-white-hover{elseif ($ROLE_DETAILS[$roleId][1] == '3')} emerald-bg txt-white-hover{elseif ($ROLE_DETAILS[$roleId][1] == '4')} white-bg txt-white-hover{/if}">
			...
			<a href="javascript: put_child_ID ('user_{$roleId}');" class="x" id="user_{$roleId}">{$ROLE_DETAILS[$roleId][0]}</a>
			<div class="nested-links">
				<span class="badge badge-primary">
					<a href="index.php?module=Settings&action=createrole&parenttab=Settings&parent={$roleId}"><i class="glyphicon glyphicon-plus"></i>1</a>
				</span>
				<span class="badge badge-info">
					<a href="index.php?module=Settings&action=createrole&parenttab=Settings&roleid={$roleId}&mode=edit"><i class="glyphicon glyphicon-pencil"></i></a>
				</span>
	...
	{if (count ($children) > 0)}
		{include file="RoleTree.tpl" ROLES=$children}
	{/if}
</ol>
{/foreach}
{/strip}