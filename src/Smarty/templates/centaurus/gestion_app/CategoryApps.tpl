	...
	<div class="col-lg-12">	
			...
			<tr>
				...
				<td class="heading2" valign="bottom">
					<ol class="breadcrumb">				
						<li><h1><a href="index.php?module=gestion_app&action=ConfigApps">{$MOD.LBL_CATEGORYAPPS_BUTTON_LABEL} </a><h1></li>	
					</ol>
				</td>
			</tr>
			<tr>
		...
		<div class="col-lg-12">
			<div class="main-box clearfix">
				...
				<div class="pull-right" style="margin-right: 20px;">
						...
						<a class="btn btn-info" href="index.php?module=gestion_app&action=ConfigApps">
							{$MOD.CONFIG_APPS}
						</a>
				...
				<div class="main-box-body clearfix">
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table-responsive">
				  	...
				  	<br/>
				  	<div id="appscontents">
						{include file='gestion_app/CatAppsContents.tpl'}
					</div>
				</div>
			</div>
		</div>
...
function saveApp(mode,id){
	...
	if(mode == 'create'){
		...
		var param= 'code=' + code + '&name=' + name  + '&descripcion=' + description + '&status=' + status + '&mode=' + mode;
        ...
        new Ajax.Request(
        	...
        	{queue: {position: 'end', scope: 'command'},
                method: 'post',
                postBody: 'action=gestion_appAjax&module=gestion_app&file=SaveEditCatApps&'+param,
		...
		if(confirm("¿Est\u00E1 seguro que dese eliminar la categoria?")){
	        ...
	        new Ajax.Request(
	        	...
	        	{queue: {position: 'end', scope: 'command'},
	                method: 'post',
	                postBody: 'action=gestion_appAjax&module=gestion_app&file=CatAppDelete&'+param,
	                onComplete: function(response) {
	                	console.log(response.responseText);
