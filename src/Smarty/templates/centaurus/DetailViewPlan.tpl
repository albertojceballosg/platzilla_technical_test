							...
							<div class="col-lg-12">
								<div class="main-box">
									...
									<div class="main-box-body clearfix" id="tbl_hitosTareas">
										{include file='modules/planes/hitosTareasBundy.tpl'}
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-lg-12">
								<div class="main-box no-header">
									...
									<div class="main-box-body clearfix" id="tbl_GANTT">
										{include file='modules/planes/GANTT.tpl'}
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="main-box">
								...
								<div class="main-box-body clearfix" id="tbl_GANTT">
									{include file='modules/proyectos/kanban.tpl'}
								</div>
							</div>
						</div>
					</div>
...
{block name="content-extra" append}
