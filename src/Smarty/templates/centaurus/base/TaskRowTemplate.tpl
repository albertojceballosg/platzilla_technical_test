<script type="text/html" id="task-row-template-{$idTaskDetailView}">
        ...
        <div class="flex-container nowrap space-between items-align-star">
            <div class="flex-container wrap flex-start items-align-baseline">
                <h4 id="subject-__ID__" style="width: 100%; margin: 0;font-weight: bold">__SUBJECT__
                    {*<span id="priorityname-__ID__" class="badge btn-default">&nbsp;__PRIORYTT__&nbsp;</span>
                ...
                <div style="width: 100%; display: inline; vertical-align: center">
                    <span id="priorityname__ID__" class="badge btn-default">&nbsp;<small>Prioridad:&nbsp;__PRIORYTT__
                        </small>&nbsp;</span>
                    <span id="statusname__ID__" class="badge btn-default">&nbsp;<small>Estado:&nbsp;__STATUS__
                        </small>&nbsp;</span>
                    <span id="importance__ID__" class="badge btn-default">&nbsp;<small>Importancia:&nbsp;__IMPORTANCE__
                        </small>&nbsp;</span>
                </div>
                ...
                <div id="username-__ID__" class="item-date">&nbsp;<i class="fa fa-user"
                        aria-hidden="true"></i>&nbsp;__USER__
                </div>
            </div>
            <div class="btn-group">
                <button type="button" class="edit btn btn-primary" onclick="DetailViewTabUtils.editTask ('__ID__')">
                ...
                <button type="button" class="edit btn btn-success" onclick="DetailViewTabUtils.setCompleted ('__ID__')">
        ...
        <form id="main_input_box-__ID__">
            ...
            <div class="flex-container nowrap space-between items-align-star">
                ...
                <div class="flex-container nowrap space-between items-align-star" style="margin-top: 0.5em">
                    ...
                    <div class="btn-group">
                        <button type="button" title="Actualizar tarea"
                            class="edit btn btn-primary" data-id-main="{$idTaskDetailView}" 
                            onclick="DetailViewTabUtils.createTask (this, '__ID__', 'UPDATE')">
                ...
                <div class="flex-container wrap flex-start space-between items-align-baseline">
                        ...
                        <div class="input-group">
                            ...
                            <select id="activitytype-__ID__" name="activitytype" class="form-control">
                                {foreach $AVAILABLE_ACTIVITY_TYPES as $activityType => $activityLabel}
                                    <option value="{$activityType}">{$activityLabel}</option>
                                {/foreach}
                            </select>
                        </div>
                    </div>
                    <div class="item-date" style="margin-right: 0.5em">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control datepickerDate-{$idTaskDetailView}"
                                name="date_start" placeholder="Fecha de inicio" type="text" 
                    ...
                    <div class="item-date" style="margin-right: 0.5em">
                        <div class="input-group">
                            <span class="input-group-addon border"><i class="fa fa-calendar"></i></span>
                            <input class="form-control datepickerDate-{$idTaskDetailView}"
                                name="due_date" placeholder="Fecha de inicio" type="text" 
                                value="__DUE_DATE__">
                        </div>
                    </div>
                    ...
                    <div class="" style="margin-right: 0.5em">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="estimated_time"
                                ...
                                placeholder="Duración estimada" value="__ESTIMATED_TIME__" id="estimated_time-__ID__">
                        </div>
                        {* estimated time*}
                    </div>
                    <div class="" style="margin-right: 0.5em">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="estimated_cost" data-number-format="decimal"
                                data-default-value="0" data-decimals="2" placeholder="0.00" value="__ESTIMATED_COST__"
                                id="estimated_cost-__ID__">
                        </div>
                    </div>
                ...
                <div class="flex-container nowrap space-between items-align-star" style="margin-top: 0.5em">
                            ...
                            <ul id="detailview-task-user-__ID__" class="dropdown-menu scroll-user-menu" role="menu">
                                ...
                                {if $AVAILABLE_USERS|count gt 0}
                                    {foreach $AVAILABLE_USERS as $id => $user}
                                        <li>
                                            <a href="#" title="{$user['name']}" rel="{{$id}}"  onclick="DetailViewTabUtils.selectedUser (event, this, '__ID__')">
                    ...
                    {if $AVAILABLE_IMPORTANCE neq NULL}
                        <div class="btn-group">
                            <button id="btn-group-importance-__ID__" type="button"
                                class="btn btn-primary dropdown-toggle dropdown-toggle" title="Importancia de la tarea"
                                style="font-size: 15px!important;margin-left: 0.1em" data-toggle="dropdown">
                                <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                                <span class="caret"></span>
                            </button>
                            <ul id="detailview-task-importance-__ID__" class="dropdown-menu scroll-user-menu" role="menu">
                    ...
                    {if $AVAILABLE_TASK_PRIORITIES neq NULL}
                        <div class="btn-group">
                            ...
                            <ul id="detailview-task-priority-__ID__" class="dropdown-menu scroll-user-menu" role="menu">
                                ...
                                {foreach $AVAILABLE_TASK_PRIORITIES as $priority}
                                    ...
                                    <li>
                                        <a href="#" title="{$priority}" rel="{$priority}"  onclick="DetailViewTabUtils.selectedPriority (event, this, '__ID__')">
                                            {$priority}
                                        </a>
                                    </li>
                                {/foreach}
                    ...
                    {if $AVAILABLE_EVENT_STATUSES neq NULL}
                        <div class="btn-group">
                            <button id="btn-group-task-status-__ID__" type="button" class="btn btn-primary dropdown-toggle"
                                title="Estado de la tarea" style="font-size: 15px!important;margin-left: 0.2em"
                                data-toggle="dropdown">
                                <i class="fa fa-exchange" aria-hidden="true"></i>
                                <span class="caret"></span>
                            </button>
                            <ul id="detailview-task-status-__ID__" class="dropdown-menu scroll-user-menu" role="menu">
                    ...
                    {if $CATEGORIES neq NULL}
                        <div class="btn-group">
                            <button id="btn-group-task-categories-__ID__" type="button"
                                class="btn btn-primary dropdown-toggle" style="height: 2.4em!important;margin-left: 0.1em"
                            ...
                            <ul id="detailview-task-categories-__ID__" class="dropdown-menu" role="menu">
                                ...
                                {foreach $CATEGORIES as $id => $name}
                                    <li>
                                        <a href="#" title="{$name}" rel="{$id}"  onclick="DetailViewTabUtils.setCategory (event, this, '__ID__')">
                                            {$name}
                                        </a>
                                    </li>
                                {/foreach}
...
<script type="text/html" id="category-row-template-{$idTaskDetailView}">
    <li>
        <a href="#" title="__TITLE__" rel="__CATEGORYID__"
            onclick="DetailViewTabUtils.setCategory (event, this, '__ID__')">__TITLE__</a>
    </li>
</script>