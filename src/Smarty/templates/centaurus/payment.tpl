...
{/literal}
	<header class="main-box-header clearfix">
		<h2>¡Muy bien!  Haz seleccionado el {$PLAN_PAGO}. <a href="/platzilla/module-Users-action-pricing-parenttab-">Cambiar plan</a></h2>
		<h2>Para obtener tu suscripción, solo falta que selecciones cómo prefieres pagar</h2>
	</header>
	<form action="/platzilla/module-Users-action-checkout-parenttab-" id="my-sample-form" name="mysampleform" method="post">
