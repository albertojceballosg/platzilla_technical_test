...
<table class="table" bgcolor="#ffffff" border="0" cellpadding="5" cellspacing="0"  valign="top" height="500" width="100%">
	<tbody><tr>
	<td colspan="4">
	<span>{$MOD.LBL_SELECT_COLUMNS}</span><br>
	...
	<select id="availList" multiple size="16" name="availList" class="form-control">
	{$BLOCK1}
	</select>
	</td>
	<td style="padding: 5px;" align="center" width="10%">
	<input name="add" value=" {$APP.LBL_ADD_ITEM} &gt " class="btn btn-primary" type="button" onClick="addColumn()">
	</td>
	<input type="hidden" name="selectedColumnsString"/>
	<td style="padding-left: 5px;" align="left" width="40%">
	<select id="selectedColumns" size="16" name="selectedColumns" onchange="selectedColumnClick(this);" multiple class="form-control">
	{$BLOCK2}
	</select>
	</td>
