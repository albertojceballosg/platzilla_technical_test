<div class="row">
    ...
    {/if}
    <div class="col-xs-12">
        <form action="index.php" name="delete-change-owner">
            ...
            <div class="row" id="block_{$RECORD}">
                <div class="col-xs-12">
                    <div class="col-xs-5 label-input">
                        ...
                        <label for="assigneduser" style="font-weight: bold">Asignado a:&nbsp;
                        </label>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                            <span>
                               <button type="button" class="btn btn-primary btn-xs" onclick="changeAndDeleteUser(this)">Eliminar y asignar</button>
                            </span>
                    <span>&nbsp;
    ...
    <script type="text/javascript">
        function changeAndDeleteUser(obj) {
            var sendButton = jQuery(obj),
                myForm = jQuery("form[name='delete-change-owner']"),
            ...
            jQuery.post('index.php', arguments, function (data) {
                ...
                try {
                    ...
                    if (message.error !== 'OK') {
                        ...
                        modalTitle.html(modalTitle.html() + '&nbsp;<span class="help-block" style="color: red">Recargando usuarios...</span>');
                        location.reload();
                    }
                }
                catch (e) {
