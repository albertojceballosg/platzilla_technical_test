...
-->*}
<!-- BEGIN: main -->
<div id="roleLay" style="display:block;width:400px;"  class="modal fade in" role="dialog">
...
<div class="modal-body">
	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="table">
		<tr>
			<td width="90%" align="left">{$MOD.SELECT_EMAIL}
			...
			<td width="10%" align="right">
				<a href="javascript:fninvsh('roleLay');" alt="{$APP.LBL_CLOSE}" title="{$APP.LBL_CLOSE}"><i class="glyphicon glyphicon-remove"></i></a>
			</td>
		</tr>
	</table>
	<table border=0 cellspacing=0 cellpadding=5 width=95% align=center class="table"> 
		<tr><td>
			<table border=0 cellspacing=0 cellpadding=5 width=100% align=center bgcolor=white class="table">
				<tr>
					<td align="left">
					...
					{/if}
						<div style="height:120px;overflow-y:auto;overflow-x:hidden;" align="center">
							<table border="0" cellpadding="5" cellspacing="0" width="90%" class="table">
	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="table">
		<tr><td align=center class="small">
			<input type="button" name="{$APP.LBL_SELECT_BUTTON_LABEL}" value=" {$APP.LBL_SELECT_BUTTON_LABEL} " class="btn btn-success btn-sm" onClick="validate_sendmail('{$IDLIST}','{$FROM_MODULE}');"/>&nbsp;&nbsp;
			<input type="button" name="{$APP.LBL_CANCEL_BUTTON_LABEL}" value=" {$APP.LBL_CANCEL_BUTTON_LABEL} " class="btn btn-warning btn-sm" onclick="fninvsh('roleLay');" />
		</td></tr>
	</table>
</div>
</div>
