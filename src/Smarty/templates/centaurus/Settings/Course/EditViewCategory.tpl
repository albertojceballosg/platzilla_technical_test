{strip}
    {if ($CATEGORY neq NULL)}
        {assign var='id' value=$CATEGORY->getId()}
        {assign var='name' value=$CATEGORY->getName()}
        {assign var='status' value=$CATEGORY->getStatus()}
    {else}
    ...
    <form class="form-horizontal" name="company-sector-form" role="form" method="post" action="index.php">
        ...
        <input type="hidden" name="action" value="SaveCourseCategory"/>
        <input type="hidden" name="tab" value="courses_categories"/>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="action-bar pull-right">
                    ...
                    <a href="index.php?module=Settings&action=CourseListView&parenttab=Settings&tab=courses_categories"
            ...
            <div class="col-xs-12">
                <div class="main-box">
                    <header class="main-box-header clearfix">
                        <h2 class="pull-left">Categoría de curso: Información general</h2>
                    </header>
