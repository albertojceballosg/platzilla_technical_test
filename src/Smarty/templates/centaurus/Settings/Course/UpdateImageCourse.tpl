{strip}
    ...
    <form id="form-{$idImage}" method="post" enctype="multipart/form-data" action="index.php">
        <input type="hidden" name="module" value="Settings"/>
        <input type="hidden" name="action" value="CourseAjaxUtils"/>
        <input type="hidden" name="Ajax" value="true"/>
        <input type="hidden" name="function" value="SAVE_COURSE_PHOTO"/>
        ...
        <div id="basic-section" class="main-box">
            <div class="main-box-body">
                <div class="row-panel-course">
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12" style="height: 50px">&nbsp;</div>
                    {* photo course *}

    {if (!isset ($IS_ERROR))}
                    <div class="col-xs-12 col-md-12 col-lg-12" style="text-align: center!important;">
                        <div class="fileUpload btn btn-simple" style="width: 9em;">
                            <span>Examinar</span>
                            <input id="imagePhoto-{$idImage}"  type="file" name="imagePhoto" class="upload" value="" tabindex=""
                                   onchange="CoursePanelUtils.showPreview(this, '{$idImage}'); CoursePanelUtils.validatePhotoSize(this,'{$UPLOAD_MAXSIZE}');">
                            <input type="hidden" name="imageType" id="photo-{$idImage}"
                                   value="">
                        </div>

                    </div>
                    <div class="col-xs-12 col-md-12 col-lg-12" style="text-align: center!important;">
                        <label class="center-block" for="course-description">Imagen del curso (Max 2M): <span
    ...
    {/if}
                ...
                <div class="row-panel-course justify-content-center" style="margin-top: 20px">
                    <div class="col-xs-12 col-md-12 col-lg-12">
                        <div class="actions pull-right">
                            <button type="button" class="btn btn-info" {if (isset ($IS_ERROR))}disabled{/if}
                                    onclick="CoursePanelUtils.updateCoursePhoto('{$idImage}')">Guardar</button>&nbsp;
