							...
							<td align="left" valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="5">
									...
									<tr class="dvtCellLabel">
										...
										<td>{$MOD.LBL_LEGEND}</td>
										<td>
											<input name="legend" id="legend" class="detailedViewTextBox" onfocus="this.className='detailedViewTextBoxOn'" onblur="this.className='detailedViewTextBox'" type="text" value="{$LEGEND}" placeholder="" />
										</td>
									</tr>
									<tr>
										<td colspan="4">&nbsp;</td>
...
{include file='Settings/PanelPropertiesSelect' COLUMN=$CHOOSE_COLUMNS[0] ROW=1}
										<td>
											<select name="opcolumn1" id="opcolumn1" class="small" title="">
												{$OPERATIONS}
											</select>
										</td>
										<td>
