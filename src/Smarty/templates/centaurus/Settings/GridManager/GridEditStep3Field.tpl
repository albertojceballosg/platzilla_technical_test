            ...
            <div style="width: auto; display: block;">
                <header class="main-box-header clearfix" style="margin-top: 0; padding-bottom: 0; padding-top: 0;">
                    ...
                    <div class="filter-block pull-right">
                        <a href="#" class="btn btn-primary pull-right" data-block-number="{$BLOCK_NUMBER}"
                           onclick="GridPropertiesUtils.addFieldToGrid (this); return false;">
                            <i class="fa fa-plus-circle fa-lg"></i>{$MOD.LBL_ADD_CAMPO}
                        </a>
                    </div>
                </header>
                <table id="lvt-edit-table" width="100%" cellspacing="0" cellpadding="0" border="0"
                       class="lvt small block-fields">
                    <thead>
                    <tr>
                        <th class="lvtCol"
                            width="{if !isset($NOMBRE_WIDTH)}30% {else}$NOMBRE_WIDTH) {/if}">{$MOD.LBL_NOMBRE_CAMPO}</th>
                        <th class="lvtCol" width="12%" align="right">{$MOD.POS_CAMPO}</th>
                        <th class="lvtCol" width="20%">{$MOD.LBL_ETIQUETA_CAMPO}</th>
                        <th class="lvtCol" width="20%">{$MOD.LBL_TIPO_CAMPO}</th>
                        <th class="lvtCol" width="20%">Propiedad / Valor</th>
