...
<form action="index.php?module=Settings&action=SaveEditKpisBoxscore" method="post" id="SaveEditKpisBoxscore" name="index" onsubmit="">
	<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-9 pull-left">
				<h1>
					<a href="index.php?module=Settings&action=kpisBoxscore&parenttab=Settings">{$MOD.LBL_KPIS_BOXSCORE_CREATE} </a>
				</h1>
			</div>
			<div class="col-lg-3 pull-right text-right">
				...
				<a class="btn btn-warning" href="index.php?module=Settings&action=kpisBoxscore">{$MOD.LBL_CANCEL_BUTTON}</a>
			</div>
		</div>
	</div>
	<div class="row">
			...
			<div class="main-box no-header">
				<div class="main-box-body clearfix" id="">
					...
					<div class="form-group">
						...
						<input type="text" placeholder="{$MOD.LBL_KPIS_BOXSCORE_TITLE}" id="title" name="title" class="form-control" title="{$MOD.LBL_KPIS_BOXSCORE_TITLE}" />
					</div>
					<div class="form-group">
						<label for="description" id="label_description">{$MOD.LBL_KPIS_BOXSCORE_DESCRIPCION}</label>&nbsp;<span style="color: red;">*</span>
						<input type="text" placeholder="Descripción" id="description" name="description" class="form-control" title="{$MOD.LBL_KPIS_BOXSCORE_DESCRIPCION}" />
					</div>
					<div class="form-group">
...
{/foreach}
					...
					<div class="form-group">
						<label for="active">{$MOD.LBL_KPIS_BOXSCORE_ACTIVE}</label>
					...
					<div class="form-group">
						...
						<textarea placeholder="{$MOD.LBL_KPIS_BOXSCORE_QUERY}" id="query" name="query" class="form-control" title="{$MOD.LBL_KPIS_BOXSCORE_QUERY}"></textarea>
					</div>
					<div class="form-group">
						<label for="querysemanal" id="label_querysemanal">{$MOD.LBL_KPIS_BOXSCORE_QUERY_SEMANAL}</label>&nbsp;
						<textarea placeholder="{$MOD.LBL_KPIS_BOXSCORE_QUERY_SEMANAL}" id="querysemanal" name="querysemanal" class="form-control" title="{$MOD.LBL_KPIS_BOXSCORE_QUERY_SEMANAL}"></textarea>
					</div>
				</div>
			</div>
		</div>
