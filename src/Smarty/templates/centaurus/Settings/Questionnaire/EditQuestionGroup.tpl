{strip}
    {if ($GROUP neq NULL)}
        ...
        {assign var='description' value=$GROUP->getDescription()}
    ...
    <form class="form-horizontal" name="company-sector-form" role="form" method="post" action="index.php">
        ...
        <input type="hidden" name="action" value="SaveQuestionGoup"/>
        ...
        <div class="row">
            <div class="col-xs-12">
                <h1 class="pull-left">
                    <a href="index.php?module=Settings&action=QuestionnaireDataListView&parenttab=Settings">{$MOD['LBL_CONFIG_QUESTIONNAIRE']}</a>
                </h1>
                <div class="action-bar pull-right">
                    <button type="submit" class="btn btn-info">Guardar</button>
                    <a href="index.php?module=Settings&action=QuestionnaireDataListView&parenttab=Settings"
            ...
            <div class="col-xs-12">
                <div class="main-box">
                    <header class="main-box-header clearfix">
                        <h2 class="pull-left">Cuestionarios: Fundamentos</h2>
                    </header>
                            ...
                            <div class="form-group">
                                ...
                                <div id="ct-div-name" class="col-md-7">
                                    <input type="text" class="form-control" id="basic_name" name="name"
                                           value="{$name}"
                                           title="El nombre del fundamento"
                            ...
                            <div class="form-group">
                                ...
                                <div id="ct-div-description" class="col-md-7">
                                    <textarea class="form-control" name="description" id="sector_description"
                                              rows="3"
                                              placeholder="Breve descripción del fundamento">{$description}</textarea>
