...
<li id="row-0" class="condition list-group-item" data-id="{$conditionId}">
    <div class="row">
        ...
        <div class="col-xs-2">
            ...
            <s
            pan  class="help-block" style="color: red"></s>
        </div>
        ...
        <div class="col-xs-4">
            <div class="input-group">
                ...
                <div class="input-group-addon" onclick="CBUtils.eraseFilterValue (this);" title="Borrar" alt="Borrar"><i class="fa fa-eraser"></i></div>
            </div>
            <span  class="help-block" style="color: red"></span>
        </div>
        ...
        <div class="col-xs-1 text-right">
            <button type="button" class="btn btn-link hidden" onclick="CBUtils.eraseFilterRow (this);" title="Eliminar condición"><i class="fa fa-trash-o"></i></button>
        </div>
