...
<div style="position: relative; display: block;" id="orgLay" class="layerPopup">
	<table border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine" align="center">
		<tr>
			<td align="left">
				<span class="layerPopupHeading">{'LBL_MENUS_TO_SHOW'|@getTranslatedString}</span>
				<br>
	...
	<table border="0" cellspacing="0" cellpadding="5" width="100%" id="assignPicklistTable" align="center">
		...
		<tr>
			<td width="auto;">
				...
				<select multiple id="availList" name="availList" class="small crmFormList" style="overflow:auto; height: 150px;width:200px;border:1px solid #666666;font-family:Arial, Helvetica, sans-serif;font-size:11px;" title="">
			...
			<td width="auto;">
				...
				<select multiple id="selectedColumns" name="selectedColumns" class="small crmFormList" style="overflow:auto; height: 150px;width:200px;border:1px solid #666666;font-family:Arial, Helvetica, sans-serif;font-size:11px;" size="11" title="">
