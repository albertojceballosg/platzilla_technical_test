{strip}
    ...
    <div class="row">
        <div class="col-xs-12">
            <h1>
                <a href="index.php?module=Settings&action=KanbanViewListView&parenttab=Settings&tab=gantt-task">
                    Vistas Gantt de tareas
                </a>
            </h1>
        </div>
    </div>
    ...
    <form method="post" action="index.php" id="KambanTaskForm" name="KanbanTask">
        ...
        <input type="hidden" name="action" value="GanttTaskSaveView"/>
                    ...
                    <div class="main-box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4 text-right">
                                        <label for="fromfieldname">Vista de detalle</label>
                                    </div>
                                    <div class="form-group col-md-8 field-container">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="label-input">
                                            <label for="appname">Vista de lista</label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-8 field-container">
