...
{$BLOCKJS_STD}
<table class="table" bgcolor="#ffffff" border="0" cellpadding="5" cellspacing="0" height='530' width="100%">
	<tbody>
	<tr valign='top'>
		<td colspan="2">
			<span>{$MOD.LBL_SHARING_TYPE}</span><br>
	...
	<table class="table" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td colspan="4">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="table">
					<tbody>
						<tr>
					    	<td nowrap="" align="center" id="mi" style="width: 100px;" colspan="2" ><!--onclick="fnLoadRepValues('mi','pi','mnuTab2','mnuTab')"-->
					     	<b>{$MOD.LBL_SHARING}</b>
					    	</td>
						</tr>
					</tbody>
		...
		<tr>
			<td colspan=4>
				<table width="100%" cellspacing="0" cellpadding="0" class="table" height="190px">
					<tr valign=top><td colspan="2">
						<table width="100%" border="0" cellpadding="5" class="table" cellspacing="0" align="center">
							<tr>
								<td align="right" class="dvtCellLabel" width="50%">{$MOD.SELECT_FILTER_TYPE} :</td>
								<td  width="50%" align="left">
									<select name="stdtypeFilter" id="stdtypeFilter" class="form-control" onchange='toggleAssignType(this.options[this.selectedIndex].value );'>
							...
							<tr>
								<td colspan="2">
									<div id="assign_team" style="display:none">
										<table width="100%" border="0" cellpadding="0" class="table" cellspacing="0" align="center">
											<tr>
												<td align=left colspan=2 class='dvtCellLabel' valign=top>
													<select id="memberType" name="memberType" class="form-control" onchange="show_Options()">
													<option value="groups" selected>{$MOD.LBL_GROUPS}</option>
													<option value="users">{$MOD.LBL_USERS}</option>
													</select>
													<input type="hidden" name="findStr" >&nbsp;
												</td>
												<th align=right colspan=1  valign=top>
													<b>{$MOD.LBL_MEMBERS}</b>
												</th>
											</tr>
											<tr>
												<td valign=top width=45%>
														<select id="availableList" name="availableList" multiple size="5" class="form-control"></select>
														<input type="hidden" name="selectedColumnsStr"/>
												</td>
												<td width="10%">
													<div align="center">
														<input type="button" name="Button" value="&nbsp;&rsaquo;&rsaquo;&nbsp;" onClick="addColumns()" class="btn btn-primary"/><br /><br />
														<input type="button" name="Button1" value="&nbsp;&lsaquo;&lsaquo;&nbsp;" onClick="removeColumns()" class="btn btn-default"/>
													</div>
												</td>
												<td  width="45%" align='right' valign=top>
													<select id="columnsSelected" name="columnsSelected" multiple size="5" class="form-control">
