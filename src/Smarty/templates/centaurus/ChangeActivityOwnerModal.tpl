<div class="row">
    ...
    {/if}
    <div class="col-xs-12">
        <form action="index.php" name="kanban-task-change-owner">
            <input type="hidden" name="module" value="{$MODULE}"/>
            <input type="hidden" name="action" value="AjaxDetailViewUtils"/>
            <input type="hidden" name="function" value="SAVE-ENTITY-OWNER"/>
            ...
            <div class="row" id="block_{$RECORD}">
                <div class="col-xs-12">
                    ...
                    <div class="form-group col-xs-7 field-container"
                        ...
                        <select name="assigned_user_id" class="form-control border"
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <span>&nbsp;
                        <button id="btn-task-cancel"  type="button" class="btn btn-default btn-xs" data-dismiss="modal">Cancelar</button>
    ...
    <script type="text/javascript">
        ...
        function saveEditableFields (obj) {
            var sendButton  = jQuery(obj),
                closeButton = jQuery('#btn-task-cancel'),
                myForm      = jQuery("form[name='kanban-task-change-owner']"),
            ...
            jQuery.post ('index.php', arguments, function (data) {
                ...
                try {
                    ...
                    if (message.error !== 'OK') {
                        ...
                        alert('El registro ha sido guardado con éxito, Recargue el kanban para reflejar el cambio');
