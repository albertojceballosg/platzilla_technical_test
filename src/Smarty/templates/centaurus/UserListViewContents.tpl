...
<tr>
	...
	<td class="listTableRow small" valign=top><b><a href="index.php?module=Users&action=DetailView&parenttab=Settings&record={$userid}"> {$listvalues.records.3} </a></b><br><a href="index.php?module=Users&action=DetailView&parenttab=Settings&record={$userid}"> {$listvalues.records.1} </a> ({$listvalues.records.2})</td>
	<td class="listTableRow small" valign=top>{$listvalues.records.5}&nbsp;</td>
	<td class="listTableRow small" valign=top>{$listvalues.records.7}&nbsp;</td>
	<td class="listTableRow small" valign=top>{$listvalues.records.6}&nbsp;</td>
	{if $listvalues.records.4|@strip_tags|@trim eq 'Active'}
