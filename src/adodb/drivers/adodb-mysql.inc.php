...
class ADODB_mysql extends ADOConnection {
	...
	var $_getTableSeq = "show tables like '%s'";
	...
	{
		if (!defined ('MAX_SEQUENCE_QUERIES')) {
			define ('MAX_SEQUENCE_QUERIES', 10); //Se intenta 10 veces
		}
		...
		$this->_logsql = false;
		$i = 0;
		$gettableseq = sprintf($this->_getTableSeq,$seqname);
		$res = $this->Execute($gettableseq);
		$bExistTable = $res->_numOfRows;

		while ($i < MAX_SEQUENCE_QUERIES) {
