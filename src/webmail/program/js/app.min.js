...
this.init_messageform()):"get"==this.env.action?(this.enable_command("download",!0),bw.mz&&"application/pdf"==this.env.mimetype?(a=0,$(this.gui_objects.messagepartframe).on("load",function(){if(a++)try{this.contentWindow.document,f.enable_command("print",!0)}catch(k){}})):this.enable_command("print",!0)):"print"!=this.env.action||!this.env.uid||this.env.is_pgp_content||this.env.pgp_mime_part||this.print_dialog();this.gui_objects.mailboxlist&&(this.env.unread_counts={},this.gui_objects.folderlist=
this.gui_objects.mailboxlist,this.http_request("getunread",{_page:this.env.current_page}));this.gui_objects.contactslist&&(this.contact_list=new rcube_list_widget(this.gui_objects.contactslist,{multiselect:!0,draggable:!1,keyboard:!0}),this.contact_list.addEventListener("initrow",function(a){f.triggerEvent("insertrow",{cid:a.uid,row:a})}).addEventListener("select",function(a){f.compose_recipient_select(a)}).addEventListener("dblclick",function(a){f.compose_add_recipient()}).addEventListener("keypress",
...
(d._flag="mdnsent",b="mark");this.http_post(b,d)}this.check_mailvelope(this.env.action);this.is_framed()||this.env.extwin||this.browser_capabilities_check();break;case "addressbook":this.env.address_group_stack=[];this.gui_objects.folderlist&&(this.env.contactfolders=$.extend($.extend({},this.env.address_sources),this.env.contactgroups));this.enable_command("add","import",this.env.writable_source);this.enable_command("list","listgroup","pushgroup","popgroup","listsearch","search","reset-search","advanced-search",
!0);this.gui_objects.contactslist&&(this.contact_list=new rcube_list_widget(this.gui_objects.contactslist,{multiselect:!0,draggable:this.gui_objects.folderlist?!0:!1,keyboard:!0}),this.contact_list.addEventListener("initrow",function(a){f.triggerEvent("insertrow",{cid:a.uid,row:a})}).addEventListener("keypress",function(a){f.contactlist_keypress(a)}).addEventListener("select",function(a){f.contactlist_select(a)}).addEventListener("dragstart",function(a){f.drag_start(a)}).addEventListener("dragmove",
function(a){f.drag_move(a)}).addEventListener("dragend",function(a){f.drag_end(a)}).init(),$(this.gui_objects.qsearchbox).focusin(function(){f.contact_list.blur()}),this.update_group_commands(),this.command("list"));this.gui_objects.savedsearchlist&&(this.savedsearchlist=new rcube_treelist_widget(this.gui_objects.savedsearchlist,{id_prefix:"rcmli",id_encode:this.html_identifier_encode,id_decode:this.html_identifier_decode}),this.savedsearchlist.addEventListener("select",function(a){f.triggerEvent("selectfolder",
{folder:a.id,prefix:"rcmli"})}));this.set_page_buttons();this.env.cid&&(this.enable_command("show","edit",!0),this.gui_objects.editform&&$("input.groupmember").change(function(){f.group_member_change(this.checked?"add":"del",f.env.cid,f.env.source,this.value)}));this.gui_objects.editform?(this.enable_command("save",!0),"add"!=this.env.action&&"edit"!=this.env.action&&"search"!=this.env.action||this.init_contact_form()):"print"==this.env.action&&this.print_dialog();break;case "settings":this.enable_command("preferences",
"identities","responses","save","folders",!0);"identities"==this.env.action?this.enable_command("add",2>this.env.identities_level):"edit-identity"==this.env.action||"add-identity"==this.env.action?(this.enable_command("save","edit","toggle-editor",!0),this.enable_command("delete",2>this.env.identities_level),this.editor_init(this.env.editor_config,"rcmfd_signature")):"folders"==this.env.action?this.enable_command("subscribe","unsubscribe","create-folder","rename-folder",!0):"edit-folder"==this.env.action&&
...
!1))};this.doc_mouse_up=function(a){var b,d=rcube_event.get_target(a);if(!$(d).closest(".ui-dialog, .ui-widget-overlay").length){window.rcube_list_widget&&rcube_list_widget._instances.length&&$.each(rcube_list_widget._instances,function(b,d){d&&!rcube_mouse_is_over(a,d.list.parentNode)&&d.blur()});if(this.buttons_sel){for(b in this.buttons_sel)"function"!==typeof b&&this.button_out(this.buttons_sel[b],b);this.buttons_sel={}}setTimeout(function(a){var b,e,k,l,m=$(d).parents();for(l=f.menu_stack.length-
1;0<=l;l--)k=f.menu_stack[l],b=$("#"+k),!b.is(":visible")||d==b.data("opener")||d==b.get(0)||m.is(b.data("opener"))||k==e||"true"==b.attr("data-editable")&&$(d).parents("#"+k).length||"true"==b.attr("data-sticky")&&rcube_mouse_is_over(a,b.get(0))||f.hide_menu(k,a),e=b.data("parent")},10,a)}};this.doc_keypress=function(a){var b=function(a){var b,d=0>a?"prevAll":"nextAll",e=0>a?"last":"first";return f.focused_menu&&(b=$("#"+f.focused_menu))?(a=b.find(":focus").closest("li")[d](":has(:not([aria-disabled=true]))").find("a,input")[e](),
...
!1):this.env.messages[b].ml||this.enable_command("reply-list",!1));this.enable_command("delete","move","copy","mark","forward","forward-attachment",0<a.selection.length);if(b||a.selection.length&&a.selection.length!=a.rowcount)this.select_all_mode=!1;b&&this.env.contentframe&&!a.multi_selecting&&!this.dummy_select?this.preview_timer=setTimeout(function(){f.msglist_get_preview()},this.dblclick_time):this.env.contentframe&&this.show_contentframe(!1)};this.msglist_click=function(a){a.multi_selecting||
...
d.msgicon==d.icon&&(d.replied&&(a+=" replied",b+=this.get_label("replied")+" "),d.forwarded&&(a+=" forwarded",b+=this.get_label("forwarded")+" "),a+=" status"),$(d.icon).attr("class",a).attr("title",b));d.msgicon&&d.msgicon!=d.icon&&(b="",a="msgicon",!d.unread&&d.unread_children&&(a+=" unreadchildren"),d.replied&&(a+=" replied",b+=this.get_label("replied")+" "),d.forwarded&&(a+=" forwarded",b+=this.get_label("forwarded")+" "),$(d.msgicon).attr("class",a).attr("title",b));d.flagicon&&(a=d.flagged?
"flagged":"unflagged",b=this.get_label(a),$(d.flagicon).attr("class",a).attr("aria-label",b).attr("title",b))};this.set_message_status=function(a,b,d){var e=this.message_list.rows[a];if(!e)return!1;"unread"==b&&e.unread!=d&&this.update_thread_root(a,d?"unread":"read");-1<$.inArray(b,["unread","deleted","replied","forwarded","flagged"])&&(e[b]=d)};this.set_message=function(a,b,d){var e=this.message_list&&this.message_list.rows[a];if(!e)return!1;b&&this.set_message_status(a,b,d);if(-1<$.inArray(b,["unread",
"deleted","flagged"]))$(e.obj)[e[b]?"addClass":"removeClass"](b);this.set_unread_children(a);this.set_message_icon(a)};this.set_unread_children=function(a){a=this.message_list.rows[a];a.parent_uid||(a.unread||!a.unread_children||a.expanded?$(a.obj).removeClass("unroot"):$(a.obj).addClass("unroot"))};this.copy_messages=function(a,b){if(a&&"object"===typeof a)a=a.id;else if(!a)return this.folder_selector(b,function(a){f.command("copy",a)});if(a&&a!=this.env.mailbox){var d=this.selection_post_data({_target_mbox:a});
d._uid&&this.http_post("copy",d,this.display_message(this.get_label("copyingmessage"),"loading"))}};this.move_messages=function(a,b){if(a&&"object"===typeof a)a=a.id;else if(!a)return this.folder_selector(b,function(a){f.command("move",a)});if(a&&(a!=this.env.mailbox||this.is_multifolder_listing())){var d=!1,e=this.selection_post_data({_target_mbox:a});e._uid&&("show"==this.env.action?d=this.set_busy(!0,"movingmessage"):this.show_contentframe(!1),this.enable_command(this.env.message_commands,!1),
this._with_selected_messages("move",e,d))}};this.delete_messages=function(a){var b=this.message_list,d=this.env.trash_mailbox;if(this.env.flag_for_deletion)return this.mark_message("delete"),!1;d&&this.env.mailbox!=d?this.env.delete_junk&&this.env.junk_mailbox&&this.env.mailbox==this.env.junk_mailbox?this.permanently_remove_messages():b&&b.modkey==SHIFT_KEY||a&&rcube_event.get_modifier(a)==SHIFT_KEY?confirm(this.get_label("deletemessagesconfirm"))&&this.permanently_remove_messages():this.move_messages(d):
this.permanently_remove_messages();return!0};this.permanently_remove_messages=function(){var a=this.selection_post_data();a._uid&&(this.show_contentframe(!1),this._with_selected_messages("delete",a))};this._with_selected_messages=function(a,b,d){var e=0,g="delete"==a||!this.is_multifolder_listing();if(this.message_list){var h,f,l,m=[],n=this.message_list.get_selection();h=0;for(len=n.length;h<len;h++)f=n[h],this.env.threading&&(e+=this.update_thread(f),l=this.message_list.find_root(f),l!=f&&0>$.inArray(l,
m)&&m.push(l)),g&&this.message_list.remove_row(f,this.env.display_next&&h==n.length-1);!this.env.display_next&&g&&this.message_list.clear_selection();h=0;for(len=m.length;h<len;h++)this.add_tree_icons(m[h])}0>e?b._count=-1*e:0<e&&g&&this.delete_excessive_thread_rows();g||(b._refresh=1);d||(d=this.display_message(this.get_label("move"==a?"movingmessage":"deletingmessage"),"loading"));this.http_post(a,b,d)};this.selection_post_data=function(a){"object"!=typeof a&&(a={});a._mbox=this.env.mailbox;if(!a._uid){var b=
this.env.uid?[this.env.uid]:this.message_list.get_selection();a._uid=this.uids_to_list(b)}this.env.action&&(a._from=this.env.action);this.env.search_request&&(a._search=this.env.search_request);this.env.display_next&&this.env.next_uid&&(a._next_uid=this.env.next_uid);return a};this.mark_message=function(a,b){var d=[],e=[],g,h,f,l=this.message_list;b?d[0]=b:this.env.uid?d[0]=this.env.uid:l&&(d=l.get_selection());if(l)for(l.focus(),h=0,g=d.length;h<g;h++)f=d[h],("read"==a&&l.rows[f].unread||"unread"==
a&&!l.rows[f].unread||"delete"==a&&!l.rows[f].deleted||"undelete"==a&&l.rows[f].deleted||"flagged"==a&&!l.rows[f].flagged||"unflagged"==a&&l.rows[f].flagged)&&e.push(f);else e=d;if(e.length||this.select_all_mode)switch(a){case "read":case "unread":this.toggle_read_status(a,e);break;case "delete":case "undelete":this.toggle_delete_status(e);break;case "flagged":case "unflagged":this.toggle_flagged_status(a,d)}};this.toggle_read_status=function(a,b){var d,e=b.length,g=this.selection_post_data({_uid:this.uids_to_list(b),
_flag:a}),f=this.display_message(this.get_label("markingmessage"),"loading");for(d=0;d<e;d++)this.set_message(b[d],"unread","unread"==a?!0:!1);this.http_post("mark",g,f)};this.toggle_flagged_status=function(a,b){var d,e=b.length,g=this.selection_post_data({_uid:this.uids_to_list(b),_flag:a}),f=this.display_message(this.get_label("markingmessage"),"loading");for(d=0;d<e;d++)this.set_message(b[d],"flagged","flagged"==a?!0:!1);this.http_post("mark",g,f)};this.toggle_delete_status=function(a){var b=a.length,
d,e,g=!0,f=this.message_list?this.message_list.rows:{};if(1==b)return!this.message_list||f[a[0]]&&!f[a[0]].deleted?this.flag_as_deleted(a):this.flag_as_undeleted(a),!0;for(d=0;d<b;d++)if(e=a[d],f[e]&&!f[e].deleted){g=!1;break}g?this.flag_as_undeleted(a):this.flag_as_deleted(a);return!0};this.flag_as_undeleted=function(a){var b,d=a.length,e=this.selection_post_data({_uid:this.uids_to_list(a),_flag:"undelete"}),g=this.display_message(this.get_label("markingmessage"),"loading");for(b=0;b<d;b++)this.set_message(a[b],
"deleted",!1);this.http_post("mark",e,g)};this.flag_as_deleted=function(a){for(var b=[],d=this.selection_post_data({_uid:this.uids_to_list(a),_flag:"delete"}),e=this.display_message(this.get_label("markingmessage"),"loading"),g=this.message_list,f=g?g.rows:{},k=0,l=0,m=a.length;l<m;l++)uid=a[l],f[uid]&&(f[uid].unread&&(b[b.length]=uid),this.env.skip_deleted?(k+=this.update_thread(uid),g.remove_row(uid,this.env.display_next&&l==g.selection.length-1)):this.set_message(uid,"deleted",!0));this.env.skip_deleted&&
g&&(this.env.display_next&&g.rowcount||g.clear_selection(),0>k?d._count=-1*k:0<k&&this.delete_excessive_thread_rows());b.length&&(d._ruid=this.uids_to_list(b));this.env.skip_deleted&&this.env.display_next&&this.env.next_uid&&(d._next_uid=this.env.next_uid);this.http_post("mark",d,e)};this.flag_deleted_as_read=function(a){var b,d,e,g=this.message_list?this.message_list.rows:{};"string"==typeof a&&(a=a.split(","));d=0;for(e=a.length;d<e;d++)b=a[d],g[b]&&this.set_message(b,"unread",!1)};this.uids_to_list=
function(a){return this.select_all_mode?"*":1>=a.length?a.join(","):a};this.set_button_titles=function(){var a="deletemessage";this.env.flag_for_deletion||!this.env.trash_mailbox||this.env.mailbox==this.env.trash_mailbox||this.env.delete_junk&&this.env.junk_mailbox&&this.env.mailbox==this.env.junk_mailbox||(a="movemessagetotrash");this.set_alttext("delete",a)};this.init_pagejumper=function(a){$(a).addClass("rcpagejumper").on("focus",function(b){var d,e="";for(d=1;d<=f.env.pagecount;d++)e+="<li>"+
...
if(27!=b.which&&9!=b.which&&13!=b.which&&!d.is(":visible"))return f.show_menu("pagejump-selector",!0,b);if("keydown"==b.type)if(40==b.which)g.length>h&&(this.value=h+=1);else if(38==b.which)1<h&&g.length>h-1&&(this.value=--h);else{if(13==b.which)return $(this).change();if(27==b.which||9==b.which)return $(a).val(f.env.current_page)}$("li.selected",e).removeClass("selected");(b=$(g[h-1])).length&&(b.addClass("selected"),$("#pagejump-selector").scrollTop(e.height()/g.length*(h-1)-d.height()/2))}).on("change",
...
f.enable_command("spellcheck","insert-sig","toggle-editor","insert-response","save-response",!1);f.triggerEvent("compose-encrypted",{active:!0});f.env.attachments&&!$.isEmptyObject(f.env.attachments)&&(alert(f.get_label("encryptnoattachments")),$.each(f.env.attachments,function(a,b){f.remove_from_attachment_list(a)}))},function(a){console.error(a);console.log(b)}))};this.mailvelope_submit_messageform=function(a,b){var d=[];$.each(["to","cc","bcc"],function(a,b){for(var e,g=$.trim($('[name="_'+b+'"]').val());g.length&&
rcube_check_email(g,!0);)e=RegExp.$2,d.push(e),g=g.substr(g.indexOf(e)+e.length+1).replace(/^\s*,\s*/,"")});var e=0<d.length;f.mailvelope_keyring.validKeyForAddress(d).then(function(g){var h=[];$.each(g,function(a,b){!1===b&&(e=!1,h.push(a))});if(!e&&h.length)return f.show_popup_dialog(f.get_label("nopubkeyfor").replace("$email",h.join(", "))+"<p>"+f.get_label("searchpubkeyservers")+"</p>",f.get_label("encryptedsendialog"),[{text:f.get_label("search"),"class":"mainaction",click:function(){var a=$(this);
f.mailvelope_search_pubkeys(h,function(){a.dialog("close")})}},{text:f.get_label("cancel"),click:function(){$(this).dialog("close")}}]),!1;if(!e)return d.length||(alert(f.get_label("norecipientwarning")),$("[name='_to']").focus()),!1;var k=[],l=f.env.identities[$("[name='_from'] option:selected").val()];$.each(f.env.identities,function(a,b){k.push(b.email)});f.mailvelope_keyring.validKeyForAddress(k).then(function(e){valid_sender=null;$.each(e,function(a,b){if(!1!==b&&(valid_sender=a,valid_sender==
l))return!1});if(!valid_sender&&!confirm(f.get_label("nopubkeyforsender")))return!1;d.push(valid_sender);f.mailvelope_editor.encrypt(d).then(function(d){var e=f.gui_objects.messageform,g=$("[name='_pgpmime']",e),h=f.set_busy(!0,a||b?"savingmessage":"sendingmessage");e.target="savetarget";e._draft.value=a?"1":"";e.action=f.add_url(e.action,"_unlock",h);e.action=f.add_url(e.action,"_framed",1);b&&(e.action=f.add_url(e.action,"_saveonly",1));g.length||(g=$('<input type="hidden" name="_pgpmime">').appendTo(e));
g.val(d);e.submit()},function(a){console.log(a)})},function(a){console.error(a)})},function(a){console.error(a)});return!1};this.mailvelope_display_container=function(a,b,d,e){mailvelope.createDisplayContainer(a,b,d,{showExternalContent:this.env.safemode}).then(function(){$(a).addClass("mailvelope").children().not("iframe").hide();f.hide_message(e);setTimeout(function(){$(window).resize()},10)},function(a){console.error(a);f.hide_message(e);f.display_message("Message decryption failed: "+a.message,
"error")})};this.mailvelope_search_pubkeys=function(a,b){var d=[],e=new PublicKey,g=f.display_message(f.get_label("loading"),"loading");$.each(a,function(a,b){var g=$.Deferred();e.search(b,function(a,d){null!==d?g.resolve([b]):g.resolve([b].concat(a))});d.push(g)});$.when.apply($,d).then(function(){var a=[],d=[];$.each(arguments,function(b,e){var g=e.shift();e.length?d=d.concat(e):a.push(g)});f.hide_message(g);b(!0);d.length&&f.mailvelope_key_import_dialog(d);a.length&&f.display_message(f.get_label("nopubkeyfor").replace("$email",
a.join(", ")),"warning")}).fail(function(){console.error("Pubkey lookup failed with",arguments);f.hide_message(g);f.display_message("pubkeysearcherror","error");b(!1)})};this.mailvelope_key_import_dialog=function(a){var b=$("<div>").addClass("listing mailvelopekeyimport");$.each(a,function(a,e){var d=$("<div>").addClass("key");e.revoked&&d.addClass("revoked");e.disabled&&d.addClass("disabled");e.expired&&d.addClass("expired");d.append($("<label>").addClass("keyid").text(f.get_label("keyid")));d.append($("<a>").text(e.keyid.substr(-8).toUpperCase()).attr("href",
e.info).attr("target","_blank").attr("tabindex","-1"));d.append($("<label>").addClass("keylen").text(f.get_label("keylength")));d.append($("<span>").text(e.keylen));e.expirationdate&&(d.append($("<label>").addClass("keyexpired").text(f.get_label("keyexpired"))),d.append($("<span>").text((new Date(1E3*e.expirationdate)).toDateString())));e.revoked&&d.append($("<span>").addClass("keyrevoked").text(f.get_label("keyrevoked")));var h=$("<ul>").addClass("uids");$.each(e.uids,function(a,b){var d=$("<li>").addClass("uid");
b.revoked&&d.addClass("revoked");b.disabled&&d.addClass("disabled");b.expired&&d.addClass("expired");h.append(d.text(b.uid))});d.append(h);d.append($("<input>").attr("type","button").attr("rel",e.keyid).attr("value",f.get_label("import")).addClass("button importkey").prop("disabled",e.revoked||e.disabled||e.expired));b.append(d)});f.show_popup_dialog($("<div>").append($("<p>").html(f.get_label("encryptpubkeysfound"))).append(b),f.get_label("importpubkeys"),[{text:f.get_label("close"),click:function(){$(this).dialog("close")}}]);
b.on("click","input.button.importkey",function(){var a=$(this),b=a.attr("rel"),g=new PublicKey,h=f.display_message(f.get_label("loading"),"loading");g.get(b,function(d,e){f.hide_message(h);e?f.display_message(f.get_label("keyservererror"),"error"):f.mailvelope_keyring.importPublicKey(d).then(function(d){"REJECTED"!==d&&(d=b.substr(-8).toUpperCase(),a.closest(".key").fadeOut(),f.display_message(f.get_label("keyimportsuccess").replace("$key",d),"confirmation"))},function(a){console.log(a)})})})};this.expunge_mailbox=
...
(m={threads:this.env.autocomplete_threads,sources:this.env.autocomplete_sources});this.init_address_input_events(e,m);for(a in l)this.init_address_input_events($("[name='_"+l[a]+"']"),m);k||(a=this.env.top_posting&&this.env.compose_mode?0:f.value.length,"select-one"==d.prop("type")&&(this.set_caret_pos(f,0),this.change_identity(d[0])),this.set_caret_pos(f,a),a&&$(f).scrollTop(f.scrollHeight));this.env.save_localstorage&&this.compose_restore_dialog(0,k);""==e.val()?b=e:""==g.val()?b=g:f&&(b=f);$(b).filter(":visible").focus();
...
"E"==g.charAt(0)&&0>this.env.contactdata[g].indexOf("@")&&d.length)){var k=g.substr(1);this.group2expand[k]={name:this.env.contactdata[g],input:d.get(0)};this.http_request("group-expand",{_source:this.env.source,_gid:k},!1)}b.length&&d.length&&(g=d.val(),f=new RegExp(RegExp.escape(e)+"\\s*$"),g&&!f.test(g)&&(g+=e+" "),d.val(g+b.join(e+" ")+e+" ").change(),this.triggerEvent("add-recipient",{field:a,recipients:b}));return b.length};this.check_compose_input=function(a){var b=$("[name='_to']"),d=$("[name='_cc']"),
...
this.ksearch_pane.css({left:e.left+"px",top:e.top+this.ksearch_input.offsetHeight+"px",display:"none"}));if(a&&(h=a.length))for(e=0;e<h&&0<n;e++)k="object"===typeof a[e]?a[e].display||a[e].name:a[e],l="object"===typeof a[e]?a[e].type:"",g=e+this.env.contacts.length,$("<li>").attr("id","rcmkSearchItem"+g).attr("role","option").html('<i class="icon"></i>'+this.quote_html(k.replace(new RegExp("("+RegExp.escape(m)+")","ig"),"##$1%%")).replace(/##([^%]+)%%/g,"<b>$1</b>")).addClass(l||"").appendTo(b).mouseover(function(){f.ksearch_select(this)}).mouseup(function(){f.ksearch_click(this)}).get(0)._rcm_id=
g,--n;b.childNodes.length&&($(this.ksearch_input).attr("aria-haspopup","true").attr("aria-expanded","true").attr("aria-owns","rcmKSearchpane"),this.ksearch_pane.show(),this.env.contacts.length||this.ksearch_select($("li:first",b).get(0)));h&&(this.env.contacts=this.env.contacts.concat(a));this.ksearch_data.id==d&&this.ksearch_data.num--}};this.ksearch_click=function(a){this.ksearch_input&&this.ksearch_input.focus();this.insert_recipient(a._rcm_id);this.ksearch_hide()};this.ksearch_blur=function(){this.ksearch_timer&&
...
(b=a.val())&&f.http_post("group-create",{_source:f.env.source,_name:b},f.set_busy(!0,"loading"));$(this).dialog("close")}}])};this.group_rename=function(){if(this.env.group){var a=this.env.contactgroups["G"+this.env.source+this.env.group].name,b=$("<input>").attr("type","text").val(a),d=$("<label>").text(this.get_label("namex")).append(b);this.show_popup_dialog(d,this.get_label("grouprename"),[{text:this.get_label("save"),"class":"mainaction",click:function(){var d;(d=b.val())&&d!=a&&f.http_post("group-rename",
{_source:f.env.source,_gid:f.env.group,_name:d},f.set_busy(!0,"loading"));$(this).dialog("close")}}],{open:function(){b.select()}})}};this.group_delete=function(){if(this.env.group&&confirm(this.get_label("deletegroupconfirm"))){var a=this.set_busy(!0,"groupdeleting");this.http_post("group-delete",{_source:this.env.source,_gid:this.env.group},a)}};this.remove_group_item=function(a){var b="G"+a.source+a.id;this.treelist.remove(b)&&(this.triggerEvent("group_delete",{source:a.source,id:a.id}),delete this.env.contactfolders[b],
...
g)};this.search_create=function(){var a=$("<input>").attr("type","text"),b=$("<label>").text(this.get_label("namex")).append(a);this.show_popup_dialog(b,this.get_label("searchsave"),[{text:this.get_label("save"),"class":"mainaction",click:function(){var b;(b=a.val())&&f.http_post("search-create",{_search:f.env.search_request,_name:b},f.set_busy(!0,"loading"));$(this).dialog("close")}}])};this.search_delete=function(){if(this.env.search_request){var a=this.set_busy(!0,"savedsearchdeleting");this.http_post("search-delete",
{_sid:this.env.search_id},a)}};this.remove_search_item=function(a){this.savedsearchlist.remove("S"+a)&&this.triggerEvent("search_delete",{id:a,li:void 0});this.env.search_id=null;this.env.search_request=null;this.list_contacts_clear();this.reset_qsearch();this.enable_command("search-delete","search-create",!1)};this.listsearch=function(a){var b=this.set_busy(!0,"searching");this.contact_list&&this.list_contacts_clear();this.reset_qsearch();this.savedsearchlist?(this.treelist.select(""),this.savedsearchlist.select("S"+
a)):this.select_folder("S"+a,"",!0);this.env.current_page=1;this.http_request("search",{_sid:a},b)};this.section_select=function(a){var b;b=a.get_single_selection();a=window;var d={_action:"edit-prefs",_section:b};if(b){if(b=this.get_frame_window(this.env.contentframe))d._framed=1,a=b;this.location_href(d,a,!0)}return!0};this.identity_select=function(a){var b;if(b=a.get_single_selection())this.enable_command("delete",1<a.rowcount&&2>this.env.identities_level),this.load_identity(b,"edit-identity")};
...
function(a){a.query&&f.subscription_select()}).draggable({cancel:"li.mailbox.root,input,div.treetoggle"}).droppable({accept:function(a){if(!$(a).is(".mailbox"))return!1;a=f.folder_id2name($(a).attr("id"));var b=f.folder_id2name(this.id),e=f.env.subscriptionrows[a];return e&&!e[2]&&b!=a.replace(f.last_sub_rx,"")&&!b.startsWith(a+f.env.delimiter)},drop:function(a,d){var b=f.folder_id2name(d.draggable.attr("id")),g=f.folder_id2name(this.id);f.subscription_move_folder(b,g)}})};this.folder_id2name=function(a){return a?
f.html_identifier_decode(a.replace(/^rcmli/,"")):null};this.subscription_select=function(a){var b;a&&"*"!=a&&(b=this.env.subscriptionrows[a])?(this.env.mailbox=a,this.show_folder(a),this.enable_command("delete-folder",!b[2])):(this.env.mailbox=null,this.show_contentframe(!1),this.enable_command("delete-folder","purge",!1))};this.subscription_move_folder=function(a,b){if(a&&null!==b&&a!=b&&b!=a.replace(this.last_sub_rx,"")){var d=a.split(this.env.delimiter).pop(),d=""===b||"*"===b?d:b+this.env.delimiter+
d;d!=a&&this.http_post("rename-folder",{_folder_oldname:a,_folder_newname:d},this.set_busy(!0,"foldermoving"))}};this.create_folder=function(){this.show_folder("",this.env.mailbox)};this.delete_folder=function(a){a||(a=this.env.mailbox);a&&confirm(this.get_label("deletefolderconfirm"))&&this.http_post("delete-folder",{_mbox:a},this.set_busy(!0,"folderdeleting"))};this.add_folder_row=function(a,b,d,e,g,h,k,l){if(!this.gui_objects.subscriptionlist)return!1;this.subscription_list.is_search()&&(this.subscription_select(),
this.subscription_list.reset_search());this.subscription_list.draggable("destroy").droppable("destroy");var m,n,p,q,t,u="",w=[],x=[],v=[],y=$(this.gui_objects.subscriptionlist);m=k?k:$($("li",y).get(1)).clone(!0);if(!m.length)return this.goto_url("folders"),!1;m.attr({id:"rcmli"+this.html_identifier_encode(a),"class":h});k&&k.length||($("ul,div.treetoggle",m).remove(),m.removeData("filtered"));$("a:first",m).text(d);$('input[name="_subscribed[]"]:first',m).val(a).prop({checked:g?!0:!1,disabled:e?
!0:!1});this.env.subscriptionrows[a]=[b,d,!1];$.each(this.env.subscriptionrows,function(a,b){b[3]=a;w.push(b)});try{t=new Intl.Collator(this.env.locale.replace("_","-"))}catch(z){}w.sort(function(a,b){var d,e,g,h=a[0].split(f.env.delimiter),k=b[0].split(f.env.delimiter),l=h.length;for(d=0;d<l;d++){e=h[d];g=k[d];if(e!==g)return void 0===g?1:t?t.compare(e,g):e<g?-1:1;if(d==l-1)return-1}});for(n in w)d=w[n][3],w[n][2]?(b=d+this.env.delimiter,b!=this.env.prefix_ns&&(v.push(d),p=b)):p&&d.startsWith(p)?
v.push(d):(x.push(d),p=null);for(n=0;n<v.length;n++)a.startsWith(v[n]+this.env.delimiter)&&(q=v[n]);for(n=0;!q&&n<x.length;n++)n&&x[n]==a&&(q=x[n-1]);if(q&&(n=this.subscription_list.get_item(q,!0))){if(p=a.lastIndexOf(this.env.delimiter))u=a.substring(0,p),u=this.subscription_list.get_item(u,!0),$("div.treetoggle",u).length||$("<div>&nbsp;</div>").addClass("treetoggle collapsed").appendTo(u),$("ul",u).length||$("<ul>").css("display","none").appendTo(u);if(u&&n==u)$("ul:first",u).append(m);else{for(;(d=
$(n).parent().parent().get(0))&&(!u||d!=u)&&$(d).is("li.mailbox");)n=d;$(n).after(m)}}else y.append(m);$.extend(this.env.subscriptionrows,l||{});this.subscription_list.reset(!0);this.subscription_select();u&&this.subscription_list.expand(this.folder_id2name(u.id));m=m.show().get(0);m.scrollIntoView&&m.scrollIntoView();return m};this.replace_folder_row=function(a,b,d,e,g,h){if(!this.gui_objects.subscriptionlist)return this.is_framed()?window.parent.rcmail.replace_folder_row(a,b,d,e,g,h):!1;this.subscription_list.is_search()&&
...
resizable:!0,width:500,close:function(a,b){$(this).remove()}},e||{});g.dialog(e);b=$(window);a=b.width();b=b.height();var f=g.width(),k=g.height();g.dialog("option",{height:Math.min(b-40,k+75+(d?50:0)),width:Math.min(a-20,f+36)});$.each(e.button_classes||[],function(a,b){b&&$($(".ui-dialog-buttonpane button.ui-button",g.parent()).get(a)).addClass(b)});return g};this.set_page_buttons=function(){this.enable_command("nextpage","lastpage",this.env.pagecount>this.env.current_page);this.enable_command("previouspage",
...
{folder:a,mark:b,status:!0})};this.unmark_folder=function(a,b,d,e){$(this.get_folder_li(a,d,e)).removeClass(b);this.triggerEvent("markfolder",{folder:a,mark:b,status:!1})};this.get_folder_li=function(a,b,d){b||(b="rcmli");if(this.gui_objects.folderlist)return a=this.html_identifier(a,d),document.getElementById(b+a)};this.set_message_coltypes=function(a,b,d){var e=this.message_list,g=e?e.thead:null,f,k;this.env.listcols=a;this.env.coltypes||(this.env.coltypes={});if(g){if(b){g.innerHTML="";k=document.createElement("tr");
c=0;for(a=b.length;c<a;c++)f=document.createElement("th"),f.innerHTML=b[c].html||"",b[c].id&&(f.id=b[c].id),b[c].className&&(f.className=b[c].className),k.appendChild(f);g.appendChild(k)}k=0;for(a=this.env.listcols.length;k<a;k++)b=this.env.listcols[k],!(f=g.rows[0].cells[k])||"from"!=b&&"to"!=b&&"fromto"!=b||$(f).attr("rel",b).find("span,a").text(this.get_label("fromto"==b?d:b))}this.env.subject_col=null;this.env.flagged_col=null;this.env.status_col=null;this.env.coltypes.folder&&(this.env.coltypes.folder.hidden=
!(this.env.search_request||this.env.search_id)||"base"==this.env.search_scope);0<=(k=$.inArray("subject",this.env.listcols))&&(this.env.subject_col=k,e&&(e.subject_col=k));0<=(k=$.inArray("flag",this.env.listcols))&&(this.env.flagged_col=k);0<=(k=$.inArray("status",this.env.listcols))&&(this.env.status_col=k);e&&(e.hide_column("folder",this.env.coltypes.folder&&this.env.coltypes.folder.hidden||0>$.inArray("folder",this.env.listcols)),e.init_header())};this.set_rowcount=function(a,b){if(b&&b!=this.env.mailbox)return!1;
$(this.gui_objects.countdisplay).html(a);this.set_page_buttons()};this.set_mailboxname=function(a){this.gui_objects.mailboxname&&a&&(this.gui_objects.mailboxname.innerHTML=a)};this.set_quota=function(a){this.gui_objects.quotadisplay&&a&&"text"==a.type&&$(this.gui_objects.quotadisplay).text((a.percent||0)+"%").attr("title",a.title);this.triggerEvent("setquota",a);this.env.quota_content=a};this.set_trash_count=function(a){this[(a?"un":"")+"mark_folder"](this.env.trash_mailbox,"empty","",!0)};this.set_unread_count=
function(a,b,d,e){if(!this.gui_objects.mailboxlist)return!1;this.env.unread_counts[a]=b;this.set_unread_count_display(a,d);e?this.mark_folder(a,e,"",!0):b||this.unmark_folder(a,"recent","",!0)};this.set_unread_count_display=function(a,b){var d,e,g,f,k;if(g=this.get_folder_li(a,"",!0)){f=this.env.unread_counts[a]?this.env.unread_counts[a]:0;e=$(g).children("a").eq(0);d=e.children("span.unreadcount");!d.length&&f&&(d=$("<span>").addClass("unreadcount").appendTo(e));e=0;if((k=g.getElementsByTagName("div")[0])&&
k.className.match(/collapsed/))for(var l in this.env.unread_counts)l.startsWith(a+this.env.delimiter)&&(e+=this.env.unread_counts[l]);f&&d.length?d.html(this.env.unreadwrap.replace(/%[sd]/,f)):d.length&&d.remove();d=new RegExp(RegExp.escape(this.env.delimiter)+"[^"+RegExp.escape(this.env.delimiter)+"]+$");a.match(d)&&this.set_unread_count_display(a.replace(d,""),!1);0<f+e?$(g).addClass("unread"):$(g).removeClass("unread")}d=/^\([0-9]+\)\s+/i;b&&document.title&&(g=String(document.title),f=f&&g.match(d)?
...
this.http_post("headers",{_uid:this.env.uid,_mbox:this.env.mailbox},this.display_message(this.get_label("loading"),"loading")))};this.hide_headers=function(a,b){this.gui_objects.all_headers_row&&this.gui_objects.all_headers_box&&($(b).removeClass("hide-headers").addClass("show-headers"),$(this.gui_objects.all_headers_row).hide(),b.onclick=function(){f.command("show-headers","",b)})};this.folder_selector=function(a,b){var d=this.folder_selector_element;if(!d){var e=[],g=this.env.delimiter,h=$('<ul class="toolbarmenu">'),
k=document.createElement("a"),d=$('<div id="folder-selector" class="popupmenu"></div>');k.href="#";k.className="icon";$.each(this.env.mailboxes_list,function(){var a=0,b=0,d=f.env.mailboxes[this],h=d.id,q=$(k.cloneNode(!1)),t=$("<li>");d.virtual?q.addClass("virtual").attr("aria-disabled","true").attr("tabindex","-1"):q.addClass("active").data("id",d.id);for(d["class"]&&q.addClass(d["class"]);0<=(b=h.indexOf(g,b));)a++,b++;q.css("padding-left",a?16*a+"px":0);q.append($("<span>").text(d.name));t.append(q);
e.push(t)});h.append(e).appendTo(d);d.css({left:"-1000px",top:"-1000px"}).appendTo($("body")).show();10<e.length&&d.css("max-height",10*$("li",d)[0].offsetHeight+9);d.on("click","a.active",function(a){d.data("callback")($(this).data("id"));return!1});this.folder_selector_element=d}d.data("callback",b);this.show_menu("folder-selector",!0,a)};this.show_menu=function(a,b,d){var e="object"==typeof a?a.menu:a,f=$("#"+e),h=d&&d.target?$(d.target):$(f.attr("rel")||"#"+e+"link"),k=rcube_event.is_keyboard(d),
l=f.attr("data-align")||"",m=!1;"A"!=h.get(0).tagName&&h.closest("a").length&&(h=h.closest("a"));"string"==typeof a&&(a={menu:e});f.length||(f=this.triggerEvent("menu-get",{name:e,props:a,originalEvent:d}));if(!f||!f.length)return this.triggerEvent(!1===b?"menu-close":"menu-open",{name:e,props:a,originalEvent:d});f.appendTo(document.body);"undefined"==typeof b&&(b=f.is(":visible")?!1:!0);if(b&&h.length){var n=$(window),p=h.offset(),q=0<=l.indexOf("bottom"),m="menuitem"==h.attr("role")||0<h.closest("[role=menuitem]").length;
h.offsetWidth=h.outerWidth();h.offsetHeight=h.outerHeight();!q&&p.top+h.offsetHeight+f.height()>n.height()&&(q=!0);0<=l.indexOf("right")?p.left=p.left+h.outerWidth()-f.width():m&&(p.left=p.left+h.offsetWidth-5,p.top-=h.offsetHeight);p.left+f.width()>n.width()&&(p.left=n.width()-f.width()-12);p.top=Math.max(0,p.top+(q?-f.height():h.offsetHeight));f.css({left:p.left+"px",top:p.top+"px"})}if(b){for(l=this.menu_stack.length-1;m&&0<=l;l--)$(h).parents("#"+this.menu_stack[l]).length||"menuitem"==$(d.target).parent().attr("role")||
...
"attachment")}})},n=this.env.filedrop.single?0:d.length-1,p=b=0,q;b<=n&&(q=d[p]);p++){if(q.name||(q.name=q.fileName),q.size||(q.size=q.fileSize),q.type||(q.type="application/octet-stream"),!e&&/[^\x20-\x7E]/.test(q.name)&&(q.name_bin=unescape(encodeURIComponent(q.name))),!this.env.filedrop.filter||q.type.match(new RegExp(this.env.filedrop.filter))){if(e){if(e.append(g,q),b==n)return m()}else if(window.FileReader){var t=new FileReader;t.onload=function(a,b){return function(d){k+='Content-Disposition: form-data; name="'+
...
0};a.src=f.assets_path("program/resources/blank.tif")},10);return 0};this.pdf_support_check=function(){var a=navigator.mimeTypes?navigator.mimeTypes["application/pdf"]:{},b=navigator.plugins,d=b.length,e=/Adobe Reader|PDF|Acrobat/i;if(a&&a.enabledPlugin)return 1;if("ActiveXObject"in window){try{return a=new ActiveXObject("AcroPDF.PDF"),1}catch(g){}try{return a=new ActiveXObject("PDF.PdfCtrl"),1}catch(g){}}for(i=0;i<d;i++)if(a=b[i],"String"===typeof a){if(e.test(a))return 1}else if(a.name&&e.test(a.name))return 1;
window.setTimeout(function(){$("<object>").css({position:"absolute",left:"-10000px"}).attr({data:f.assets_path("program/resources/dummy.pdf"),width:1,height:1,type:"application/pdf"}).load(function(){f.env.browser_capabilities.pdf=1}).error(function(){f.env.browser_capabilities.pdf=0}).appendTo($("body"))},10);return 0};this.flash_support_check=function(){var a=navigator.mimeTypes?navigator.mimeTypes["application/x-shockwave-flash"]:{};if(a&&a.enabledPlugin)return 1;if("ActiveXObject"in window)try{return new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),
1}catch(b){}return 0};this.assets_path=function(a){this.env.assets_path&&!a.startsWith(this.env.assets_path)&&(a=this.env.assets_path+a);return a};this.set_cookie=function(a,b,d){setCookie(a,b,d,this.env.cookie_path,this.env.cookie_domain,this.env.cookie_secure)};this.get_local_storage_prefix=function(){this.local_storage_prefix||(this.local_storage_prefix="roundcube."+(this.env.user_id||"anonymous")+".");return this.local_storage_prefix};this.local_storage_get_item=function(a,b,d){var e,f;try{e=
localStorage.getItem(this.get_local_storage_prefix()+a),f=JSON.parse(e)}catch(h){}return f||b||null};this.local_storage_set_item=function(a,b,d){try{return localStorage.setItem(this.get_local_storage_prefix()+a,JSON.stringify(b)),!0}catch(e){return!1}};this.local_storage_remove_item=function(a){try{return localStorage.removeItem(this.get_local_storage_prefix()+a),!0}catch(b){return!1}};this.print_dialog=function(){bw.safari?setTimeout("window.print()",10):window.print()}}
rcube_webmail.long_subject_title=function(f,v){if(!f.title){var a=$(f);a.width()+15*(v||0)>a.parent().width()&&(f.title=rcube_webmail.subject_text(f))}};rcube_webmail.long_subject_title_ex=function(f){if(!f.title){var v=$(f),a=$.trim(v.text()),a=$("<span>").text(a).css({position:"absolute","float":"left",visibility:"hidden","font-size":v.css("font-size"),"font-weight":v.css("font-weight")}).appendTo($("body")),b=a.width();a.remove();b+15*$("span.branch",v).width()>v.width()&&(f.title=rcube_webmail.subject_text(f))}};
rcube_webmail.subject_text=function(f){f=$(f).clone();f.find(".skip-on-drag").remove();return f.text()};rcube_webmail.set_iframe_events=function(f){$("iframe").each(function(){var v=$(this);$.each(f,function(a,b){v.on("load",function(d){try{$(this).contents().on(a,b)}catch(e){}});try{v.contents().on(a,b)}catch(d){}})})};rcube_webmail.prototype.get_cookie=getCookie;rcube_webmail.prototype.addEventListener=rcube_event_engine.prototype.addEventListener;rcube_webmail.prototype.removeEventListener=rcube_event_engine.prototype.removeEventListener;
