...
"i")).test(a)?!0:!1:!1}function rcube_clone_object(a){var b={},c;for(c in a)b[c]=a[c]&&"object"===typeof a[c]?rcube_clone_object(a[c]):a[c];return b}function urlencode(a){return window.encodeURIComponent?encodeURIComponent(a).replace("*","%2A"):escape(a).replace("+","%2B").replace("*","%2A").replace("/","%2F").replace("@","%40")}
...
rcube_parse_query=function(a){if(!a)return{};var b={},c,d,e=/([^&=]+)=?([^&]*)/g,f=/\+/g;for(a=a.replace(/\?/,"");c=e.exec(a);)d=decodeURIComponent(c[1].replace(f," ")),c=decodeURIComponent(c[2].replace(f," ")),"[]"===d.substring(d.length-2)?(d=d.substring(0,d.length-2),(b[d]||(b[d]=[])).push(c)):b[d]=c;return b};
var Base64=function(){var a=function(a){var b=0,d="",e;for(c2=c3=0;b<a.length;)e=a.charCodeAt(b),128>e?(d+=String.fromCharCode(e),b++):191<e&&224>e?(c2=a.charCodeAt(b+1),d+=String.fromCharCode((e&31)<<6|c2&63),b+=2):(c2=a.charCodeAt(b+1),c3=a.charCodeAt(b+2),d+=String.fromCharCode((e&15)<<12|(c2&63)<<6|c3&63),b+=3);return d};return{encode:function(a){a=a.replace(/\r\n/g,"\n");for(var b="",d=0;d<a.length;d++){var e=a.charCodeAt(d);128>e?b+=String.fromCharCode(e):(127<e&&2048>e?b+=String.fromCharCode(e>>
6|192):(b+=String.fromCharCode(e>>12|224),b+=String.fromCharCode(e>>6&63|128)),b+=String.fromCharCode(e&63|128))}a=b;if("function"===typeof window.btoa)try{return btoa(a)}catch(n){}for(var f,k,l,g=0,h="",m=a.length;g<m;)f=a.charCodeAt(g++),b=a.charCodeAt(g++),d=a.charCodeAt(g++),e=f>>2,f=(f&3)<<4|b>>4,k=(b&15)<<2|d>>6,l=d&63,isNaN(b)?k=l=64:isNaN(d)&&(l=64),h=h+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l);return h},decode:function(b){if("function"===typeof window.atob)try{return a(atob(b))}catch(m){}var c,d,e,f,k,l,g=0,h="";b=b.replace(/[^A-Za-z0-9\+\/\=]/g,"");for(l=b.length;g<l;)c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(g++)),d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(g++)),
f="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(g++)),k="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(g++)),c=c<<2|d>>4,d=(d&15)<<4|f>>2,e=(f&3)<<6|k,h+=String.fromCharCode(c),64!=f&&(h+=String.fromCharCode(d)),64!=k&&(h+=String.fromCharCode(e));return a(h)}}}();
