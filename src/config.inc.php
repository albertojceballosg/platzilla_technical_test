...
//$PORTAL_URL = 'https://gestion.timemanagement.es/customerPortal2';
$PORTAL_URL = 'https://gen.pruebacrm.timemanagement.es/customerPortal2';

// helpdesk support email id and support name (Example: 'support@vtiger.com' and 'vtiger support')
$HELPDESK_SUPPORT_EMAIL_ID = 'lcastillo@timemanagement.es';
...
$platPrincipal = 'madre';
$modulesBasicosPlatzilla = array('Events','Users','Calendar','Home');
...
$application_unique_key = '2fcabe648f8ed3c4dbd9d47c0560418e';

// trim descriptions, titles in listviews to this value
$listview_max_textlength = 512;

// trim titles in calendar records
$calendarrecords_max_textlength = 15;

// Maximum time limit for PHP script execution (in seconds)
$php_max_execution_time = 300;

// Set the default timezone as per your preference
if (!isset($default_timezone)){	// EGC para zonas horarias por plataforma, caso fusion
...
//Estilo de demostracion
$demoModeStyle = 'color: transparent;text-shadow: rgba(0, 0, 0, 0.5) 0px 0px 10px;background:transparent url(themes/images/strike.png) repeat-x left 55%';

/** minimum cron frequency -- In minutes */
$MINIMUM_CRON_FREQUENCY = 15;

$plat_madre_empresafacil = 'marketing';

// Credenciales de acceso al servidor de correo
$mailServer = array (
	'host'     => 'mail.platzilla.com',
	'port'     => 587,
	'username' => 'no_reply@platzilla.com',
	'password' => 'KiO7w7xdmY',
	'security' => 'tls',
);

$webMailClient = array (
	'encryptionkey' => 'a4i8daigFzXhUSclEC0GQlVm',
	'database'    => array (
		'server'   => 'localhost',
		'port'     => 3306,
		'username' => 'usr_roundcube',
		'password' => md5 ('usr_roundcube'),
		'name'     => 'pg_roundcube',
	),
	'productname' => 'Platzilla Webmail',
);
