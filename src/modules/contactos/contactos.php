<?php
	...
	class contactos extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_contactos';
		public $table_index   = 'contactosid';
		...
		public $customFieldTable = array ('vtiger_contactoscf', 'contactosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_contactos', 'vtiger_contactoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'   => 'crmid',
			'vtiger_contactos'   => 'contactosid',
			'vtiger_contactoscf' => 'contactosid',
		);
		/**
		...
		public $list_fields = array (
			'Nombres'   => array ('contactos', 'nombre'),
			'Apellidos' => array ('contactos', 'apellidos'),
			'Email'     => array ('contactos', 'email'),
			'Teléfono'  => array ('contactos', 'telefono'),
		);
		/**
         ...
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_contactos';
		...
		public $search_fields = array (
			'Nombres' => array ('contactos', 'nombres'),
			'Apellidos' => array ('contactos', 'apellidos'),
		);
		/**
		 * @var array Format: Field Label => fieldname
		 ...
		 */
		public $popup_fields = array ('apellidos');
		 ...
		 */
		public $mandatory_fields = array ('cod_contactos');
		...
		public static function runPreUninstallTasks (PearDatabase $adb) {
			if (!file_exists (__DIR__ . '/lib/ContactsInstaller.class.php')) {
				return;
			}

			require_once ('modules/contactos/lib/ContactsInstaller.class.php');
			ContactsInstaller::getInstance ()->runPreUninstallTasks ($adb);
		}
		...
		public static function runPostInstallTasks (PearDatabase $adb) {
			...
			require_once ('modules/contactos/lib/ContactsInstaller.class.php');
			ContactsInstaller::getInstance ()->runPostInstallTasks ($adb);
		}
