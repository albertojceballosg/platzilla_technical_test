<?php
	...
	try {
		...
		HelpSettingsHelper::saveHelpArticle ($adb, $arguments);
		$_SESSION ['flashmessage'] = array (
			'iserror' => false,
			'message' => 'El caso de uso ha sido almacenado',
		);
		header ('Location: index.php?module=Settings&action=HelpSettingsListView&parenttab=Settings&tab=articles');
	} catch (Exception $e) {
		$_SESSION ['flashmessage'] = array (
			'iserror' => true,
		...
		header ("Location: index.php?module=Settings&action=HelpSettingsArticleEditView&record={$id}&parenttab=Settings");
	}
	exit ();