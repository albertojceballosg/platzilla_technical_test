<?php
	$mod_strings = array (
		...
		'ACCOUNTCUSTOMFIELDS'                               => 'Organisation Custom Fields',
		...
		'EDITPBPICKLISTVALUES'                              => 'Edit Price Book Picklist',
		...
		'LBL_PICK_LIST_VALUES'                              => 'Picklist Values: ',
		...
		'LBL_SETTING_DEFAULT_SHARING_ACCESS'                => ' - Setting Default Sharing Access within the Organisation',
		...
		'LBL_RATING'                                        => 'Rating',
		'LBL_ACCOUNT_TYPE'                                  => 'Organisation Type',
		...
		'LBL_MAIL_SERVER_NAME'                              => 'Mail Server Name or IP Address',
		...
		'leadCustomFieldDescription'                        => 'Map each of your organisation\'s Lead Custom Fields to each of your Custom Organisation, Contact or Opportunity fields. These mappings will be used when you convert Leads',
		'LBL_MAPPING_INFO'                                  => 'Mapping Information',
		'LBL_ACCOUNT_FIELD'                                 => 'Organisation Custom Field',
		...
		'LBL_MODULE_OWNERS_DESCRIPTION'                     => 'Assign Customer Support owners to vtiger CRM module',
		...
		'LBL_INVEN_TANDC_DESC'                              => 'Specify text for the Terms & Conditions section of Quotes, Orders, and Invoice modules',
		...
		'LBL_MAIL_MERGE_DESC'                               => 'Manage Mail Merge templates used in vtiger CRM modules',
		...
		'LBL_EDIT_PICKLIST'                                 => 'Edit Picklist',
		'LBL_PICKLIST_SAVEINFO'                             => 'Type the entries one-by-one below and click the Save button to save the list.',
		'LBL_SELECT_CRM_MODULE'                             => 'Select vtiger CRM Module',
		'LBL_TAX_SETTINGS'                                  => 'Tax Calculations',
		'LBL_INVENTORY_TAX_CONFIG'                          => 'Inventory Tax Configuration',
		'LBL_CUSTOM_MAPP_INFO'                              => 'Only in the Leads module can you map the fields with Organisations, Contacts, and Opportunities.',
		...
		'LBL_GROUP_MESG1'                                   => 'Groups are a flexible way to assign access rights, when complex access rights have to be defined. You can combine multiple entities like Roles, Users and Profiles etc. into a single group.',
		...
		'Sorry'                                             => 'Sorry',
		'uploaded_file_exceeds_maximum_limit'               => 'the uploaded file exceeds the maximum vtiger filesize limit',
		...
		'LBL_CUSTOMIZE_INVOICE_NUMBER'                      => 'Customise Invoice Number',
		'LBL_CUSTOMIZE_INVOICE_NUMBER_DESCRIPTION'          => 'Invoice Number Customisation',
		'LBL_CUSTOM_INVOICE_NUMBER_VIEW'                    => 'Invoice Number Customisation',
		...
		'LBL_CUSTOMIZE_INVENTORY_NUMBER'                    => 'Customise Inventory Sequence',
		'LBL_CUSTOMIZE_INVENTORY_NUMBER_DESCRIPTION'        => 'Inventory Sequence Customisation',
		'LBL_CUSTOM_QUOTE_NUMBER_VIEW'                      => 'Quote Number Customisation',
		...
		'LBL_CUSTOM_SO_NUMBER_VIEW'                         => 'Sales Order Number Customisation',
		...
		'LBL_CUSTOM_PO_NUMBER_VIEW'                         => 'Purchase Order Number Customisation',
		...
		'LBL_LOCAL'                                         => 'Local',
		'LBL_BACKUP'                                        => 'Backup',
		'LBL_BACKUP_LOCATION'                               => 'Backup lLcation',
		...
		'LBL_SOFTPHONE_SERVER_SETTINGS'                     => 'Soft Phone Server Settings',
		'LBL_SOFTPHONE_SERVER_SETTINGS_DESCRIPTION'         => 'Configure your softphone here',
		'ASTERISK_SERVER_IP'                                => 'Asterisk server IP address',
		...
		'VTLIB_LBL_REQ_VTIGER_VERSION'                      => 'Req. vtiger CRM version',
		...
		'AFTER'                                             => 'After',
		'ADD_BLOCK'                                         => 'Add Block',
		'ARRANGE_RELATEDLIST'                               => 'Arrange related list',
		'CUSTOMFIELD_MAPPING'                               => 'Custom Field Mapping',
		'LBL_MAPPED_FIELDS'                                 => 'Mapped Fields',
		'LEADS_CUSTOM_FIELD_MAPPING_DESCRIPTION'            => 'Map Your Leads\' Custom Fields with Organisation, Contacts and Opportunities',
		'LEADS_CUSTOM_FIELD_MAPPING'                        => 'Leads Custom Field Mapping',
		'LBL_CALENDER_CUSTOMFIELDS'                         => 'Calendar Custom Fields',
		'LBL_CALENDER_CUSTOMFIELDS_DESCRIPTION'             => 'You can create custom fields for the Calendar',
		'LBL_GO_BACK'                                       => 'Go Back',
		...
		'ERR_INVALID_PROFILE_ID'                            => 'Invalid Profile ID. Please specify a valid Profile ID',
		...
		'LBL_OPTIONS1'                                      => 'Send emails from your mail server<br />Enter the SMTP account details (Server Name, User Name, Password) for the same account as entered in the FROM email address.',
		'LBL_OPTIONS2'                                      => 'Add od1.vtiger.com server as a authorised sender for your domain.<br />If you prefer to retain the vtiger server as the outgoing server, we recommend that you configure your domain\'s SPF record to include the vtiger server as a valid sender for your domain. For additonal instruction on setting up SPF record, please email od-support@vtiger.com.',
		...
		'LBL_DESCRIPTION_Public: Read Only'                 => 'Users can only read other users ',
		'LBL_DESCRIPTION_Public: Read, Create/Edit'         => 'Users can read, create/edit other users ',
		'LBL_DESCRIPTION_Public: Read, Create/Edit, Delete' => 'Users can read, create/edit and delete other users ',
		...
		'LBL_EDIT_COMPANY_INFO'                             => 'To edit company details, please click on <span style=\'font-style:italic;color:blue;\'>Settings Icon > On Demand Admin > Company </span>',
		...
		'LBL_OPCIONES'                                      => 'Options',
		'LBL_LONGITUD'                                      => 'Length',
		'LBL_VALORES'                                       => 'Values',
		'LBL_PRECISION'                                     => 'Precision',
		'LBL_PREFIJO'                                       => 'Prefix',
		'LBL_SECUENCIA'                                     => 'Sequence',
		'LBL_ACTIONS'                                       => 'Actions',
	);
