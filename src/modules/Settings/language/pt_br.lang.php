<?php
	$mod_strings      = array (
		'LBL_SUPPORT_PERMISSIONS'                                      => 'Permissões de Suporte',
...
,Contato, ou Oportunidade. Este mapeamento será usado quando você converter Leads',
		...
		'LBL_OPTIONS1'                                                 => 'Enviar emails a partir do seu Servidor de Envio de Mensagens<br>- Digite os detalhes da Organização SMTP (Nome Servidor, Usuário, Senha) para a mesma Organização digitada no endereço do Remetente (DE:).',
		'LBL_OPTIONS2'                                                 => 'Adicionar o Servidor od1.vtiger.com como um remetente autorizado para seu domínio.<br>- Se você preferir manter o Servidor do vtiger como Servidor de Envio de Mensagem, recomendamos que configure seu registro SPF (Sender Policy Framework) do domínio, para incluir o Servidor do vtiger como um rementente válido para seu domínio. Para instruções adicionais sobre configuração do registro SPF, por gentileza, envie email para od-support@vtiger.com.',
		...
		// END
		'LBL_USER_ADDITION_INFO'                                       => "Para adicionar um novo Usuário, por favor clique sobre <span style='font-style:italic;color:blue;'>Menu Configurações-OD -> Admin On Demand -> Adicionar / Convidar Usuário </span>",
		...
		'LBL_EDIT_COMPANY_INFO'                                        => "Para editar os detalhes da empresa, por favor, clique sobre o <span style='font-style:italic;color:blue;'>Ícone Configurações > Admin On Demand > Empresa </span>",
		...
		'LBL_PORCENTAJE'                                               => '(%)',
		'LBL_NUMERO'                                                   => 'Número',
		'LBL_REFERENCIA_MODULO'                                        => 'Referencia modulo',
		...
		'LBL_COLUMNAS_FILTRO'                                          => 'Columnas del filtro inicial',
		...
		'LBL_CUSTOMER_ROLE'                                            => 'É função do cliente?',
		...
		'LBL_EDIT_LABELS'                                              => 'Tag Editor',
		'LBL_EDIT_LABELS_DESCRIPTION'                                  => 'Tag Editor Aplicações / Módulos',
		'LBL_OPCIONES'                                                 => 'Opções',
		'LBL_LONGITUD'                                                 => 'Comprimento',
		'LBL_VALORES'                                                  => 'Valores',
		'LBL_PRECISION'                                                => 'Precisão',
		'LBL_PREFIJO'                                                  => 'Prefixo',
		'LBL_SECUENCIA'                                                => 'Seqüência',
		'LBL_ACTIONS'                                                  => 'Ações',
	);
