<?php
	$mod_strings = array (
		...
		'LBL_OPTIONS1'                                      => 'Enviar emails desde su servidor de correo<br>- Introducir la configuración (Servidor, Usuario, Contraseña) de la misma cuenta de correo utilizada en la cuenta de respuesta.',
		'LBL_OPTIONS2'                                      => 'Añadir el servidor od1.vtiger.com como dominio autorizado desde su dominio.<br>- Si prefiere mantener el servidor saliente de vtiger, recomendamos que configure el registro SPF de tu dominio para incluir el servidor de vtiger como servidor autorizado. Para obtener instrucciones adicionales sobre cómo definir un registro SPF, contacte con od-support@vtiger.com .',
		...
		// END
		'LBL_USER_ADDITION_INFO'                            => "Para agregar un nuevo usuario, haga click en <span style='font-style:italic;color:blue;'>OD-Menú Configuración -> On Demand Admin -> Añadir / Invitar Usuario </span>",
