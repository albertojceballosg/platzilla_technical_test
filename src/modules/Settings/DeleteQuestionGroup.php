<?php
	...
	try {
		...
		Question::getInstance ($adb)->deleteQuestionGoup ($record);

		$_SESSION ['flashmessage'] = array (
			'iserror' => false,
			'message' => 'Se ha eliminado el fundamento de cuestionario!',
		);
	} catch (Exception $e) {
		$_SESSION ['flashmessage'] = array (
			'iserror' => true,
	...
	header ('Location: index.php?module=Settings&action=QuestionnaireDataListView&parenttab=Settings');
