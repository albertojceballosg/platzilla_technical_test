<?php
	...
	class process_cases extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_process_cases';
		public $table_index = 'process_casesid';
		...
		public $customFieldTable = array ('vtiger_process_casescf', 'process_casesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_process_cases', 'vtiger_process_casescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_process_cases'   => 'process_casesid',
			'vtiger_process_casescf' => 'process_casesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('process_cases', 'cod_process_cases'),
			'Título' => array ('process_cases', 'case_title'),
			'Fecha de inicio' => array ('process_cases', 'start_date'),
			'Hora de inicio' => array ('process_cases', 'start_time'),
			'Fecha  fin de caso' => array ('process_cases', 'due_date'),
			'Hora fin de caso' => array ('process_cases', 'end_time'),
			'Proceso' => array ('process_cases', 'process'),
			'Paso del proceso' => array ('process_cases', 'process_step'),
			'Nombre del paso' => array ('process_cases', 'step_name'),
			'Tipo de paso' => array ('process_cases', 'type_step'),
			'Fecha de inicio del paso' => array ('process_cases', 'start_step_date'),
			'Hora de inicio del paso' => array ('process_cases', 'star_step_time'),
			'Fecha fin de paso' => array ('process_cases', 'due_step_date'),
			'Hora fin de paso' => array ('process_cases', 'end_step_time'),
			'comentario' => array ('process_cases', 'comment'),
			'Tiempo estimado' => array ('process_cases', 'estimated_time'),
			'Porcentaje de error' => array ('process_cases', 'error_rate'),
			'Tiempo de ejecución del paso' => array ('process_cases', 'step_exec_time')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_process_cases',
			'Título' => 'case_title',
			'Fecha de inicio' => 'start_date',
			'Hora de inicio' => 'start_time',
			'Fecha  fin de caso' => 'due_date',
			'Hora fin de caso' => 'end_time',
			'Proceso' => 'process',
			'Paso del proceso' => 'process_step',
			'Nombre del paso' => 'step_name',
			'Tipo de paso' => 'type_step',
			'Fecha de inicio del paso' => 'start_step_date',
			'Hora de inicio del paso' => 'star_step_time',
			'Fecha fin de paso' => 'due_step_date',
			'Hora fin de paso' => 'end_step_time',
			'comentario' => 'comment',
			'Tiempo estimado' => 'estimated_time',
			'Porcentaje de error' => 'error_rate',
			'Tiempo de ejecución del paso' => 'step_exec_time'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname) selected on Creator
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'case_title';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_process_cases';
		 ...
		 */
		public $popup_fields = array ('case_title');
		 ...
		 */
		public $mandatory_fields = array ('case_title');
