<?php
	...
	class management_situations extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_management_situations';
		public $table_index = 'management_situationsid';
		...
		public $customFieldTable = array ('vtiger_management_situationscf', 'management_situationsid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_management_situations', 'vtiger_management_situationscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_management_situations'   => 'management_situationsid',
			'vtiger_management_situationscf' => 'management_situationsid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('management_situations', 'cod_management_situations'),
			'Nombre situación' => array ('management_situations', 'situation_name'),
			'Descripción' => array ('management_situations', 'situation_description'),
			'Tipos de empresa' => array ('management_situations', 'sys_business_type_m'),
			'Etapas donde aplica' => array ('management_situations', 'sys_business_phase_m'),
			'Directrices relacionadas' => array ('management_situations', 'sys_guideline_m'),
			'Estrategias' => array ('management_situations', 'business_strategy'),
			'Se puede relacionar con' => array ('management_situations', 'trigger_of')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_management_situations',
			'Nombre situación' => 'situation_name',
			'Descripción' => 'situation_description',
			'Tipos de empresa' => 'sys_business_type_m',
			'Etapas donde aplica' => 'sys_business_phase_m',
			'Directrices relacionadas' => 'sys_guideline_m',
			'Estrategias' => 'business_strategy',
			'Se puede relacionar con' => 'trigger_of'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_management_situations';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_management_situations';
		 ...
		 */
		public $popup_fields = array ('cod_management_situations');
		 ...
		 */
		public $mandatory_fields = array ('cod_management_situations');
