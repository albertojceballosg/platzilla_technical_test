<?php
	...
	class negociaciones extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_negociaciones';
		public $table_index   = 'negociacionesid';
		...
		public $customFieldTable = array ('vtiger_negociacionescf', 'negociacionesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_negociaciones', 'vtiger_negociacionescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'       => 'crmid',
			'vtiger_negociaciones'   => 'negociacionesid',
			'vtiger_negociacionescf' => 'negociacionesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('negociaciones', 'cod_negociacione'),
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_negociacione';
		...
		public $search_fields = array (
			'Cliente' => array (
				'negociaciones', 'cod_negociacione',
		 ...
		 */
		public $popup_fields = array ('cod_negociacione', 'cliente');
		 ...
		 */
		public $mandatory_fields = array ('cod_negociacione');
		...
		public static function runPreUninstallTasks (PearDatabase $adb) {
			if (!file_exists (__DIR__ . '/lib/NegotiationInstaller.class.php')) {
				return;
			}

			require_once ('modules/negociaciones/lib/NegotiationInstaller.class.php');
			NegotiationInstaller::getInstance ()->runPreUninstallTasks ($adb);
		}
		...
		public static function runPostInstallTasks (PearDatabase $adb) {
			...
			require_once ('modules/negociaciones/lib/NegotiationInstaller.class.php');
			NegotiationInstaller::getInstance ()->runPostInstallTasks ($adb);
		}
