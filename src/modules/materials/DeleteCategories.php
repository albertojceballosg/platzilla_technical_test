<?php
	...
	$categoryId = PlatzillaUtils::purify ($_POST, 'record', null);
	...
	try {
		...
		if (empty ($categoryId)) {
			throw new Exception ('Categoría no identificado');
		}

		FolderUtils::getInstance ($platPrincipal)->deleteCategory ($categoryId);
