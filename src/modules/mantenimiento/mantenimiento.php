<?php
	...
	class mantenimiento extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_mantenimiento';
		public $table_index = 'mantenimientoid';
		...
		public $customFieldTable = array ('vtiger_mantenimientocf', 'mantenimientoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_mantenimiento', 'vtiger_mantenimientocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_mantenimiento'   => 'mantenimientoid',
			'vtiger_mantenimientocf' => 'mantenimientoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('mantenimiento', 'cod_mantenimient'),
			'Titulo' => array ('mantenimiento', 'titulo'),
			'Descripción' => array ('mantenimiento', 'descripcion'),
			'Cliente' => array ('mantenimiento', 'cliente'),
			'Fecha prevista' => array ('mantenimiento', 'fecha_prevista'),
			'Estado' => array ('mantenimiento', 'estado'),
			'Dirección' => array ('mantenimiento', 'direccion'),
			'Ciudad' => array ('mantenimiento', 'ciudad'),
			'Código Postal' => array ('mantenimiento', 'codigo_postal')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_mantenimient';
		 ...
		 */
		public $popup_fields = array ('cod_mantenimient');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_mantenimient'));
