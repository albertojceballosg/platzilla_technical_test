<?php
	...
	class contactos_bdi extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_contactos_bdi';
		public $table_index = 'contactos_bdiid';
		...
		public $customFieldTable = array ('vtiger_contactos_bdicf', 'contactos_bdiid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_contactos_bdi', 'vtiger_contactos_bdicf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_contactos_bdi'   => 'contactos_bdiid',
			'vtiger_contactos_bdicf' => 'contactos_bdiid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('contactos_bdi', 'cod_contactos_bd'),
			'Nombre' => array ('contactos_bdi', 'nombre'),
			'Apellido' => array ('contactos_bdi', 'apellido'),
			'Tipo de Colaboración' => array ('contactos_bdi', 'tipo_de_colaboracion'),
			'Dirección' => array ('contactos_bdi', 'direccion'),
			'Población' => array ('contactos_bdi', 'poblacion'),
			'Código Postal' => array ('contactos_bdi', 'codigo_postal'),
			'Apdo de Correos' => array ('contactos_bdi', 'apdo_de_correos'),
			'Provincia' => array ('contactos_bdi', 'provincia'),
			'Pais' => array ('contactos_bdi', 'pais'),
			'Descripción' => array ('contactos_bdi', 'descripcion')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_contactos_bd',
			'Nombre' => 'nombre',
			'Apellido' => 'apellido',
			'Tipo de Colaboración' => 'tipo_de_colaboracion',
			'Dirección' => 'direccion',
			'Población' => 'poblacion',
			'Código Postal' => 'codigo_postal',
			'Apdo de Correos' => 'apdo_de_correos',
			'Provincia' => 'provincia',
			'Pais' => 'pais',
		 ...
		 */
		public $list_link_field = 'cod_contactos_bd';
		 ...
		 */
		public $popup_fields = array ('cod_contactos_bd');
		 ...
		 */
		public $mandatory_fields = array ('cod_contactos_bd');
