<?php
	...
	class incidencias extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_incidencias';
		public $table_index = 'incidenciasid';
		...
		public $customFieldTable = array ('vtiger_incidenciascf', 'incidenciasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_incidencias', 'vtiger_incidenciascf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_incidencias'   => 'incidenciasid',
			'vtiger_incidenciascf' => 'incidenciasid',
		);
		/**
		...
		public $list_fields = array (
			//'Código' => array ('incidencias', 'cod_incidencias'),
			'Titulo'      => array ('incidencias', 'titulo'),
			'Descripción' => array ('incidencias', 'descripcion'),
			'Categoría'   => array ('incidencias', 'categoria_del_asunt'),
			'Tipo'        => array ('incidencias', 'tipo_de_asunt'),
			'Estado'      => array ('incidencias', 'estado_incidencia'),
			//'Costes repercutidos' => array ('incidencias', 'costes_repercuti'),
			'Prioridad'   => array ('incidencias', 'prioridad'),
		);
		...
		public $list_fields_name = array (
			'Código'              => 'cod_incidencias',
			'Titulo'              => 'titulo',
			'Descripción'         => 'descripcion',
			'Categoría'           => 'categoria_del_asunt',
			'Tipo'                => 'tipo_de_asunt',
			'Estado'              => 'estado_incidencia',
			'Prioridad'           => 'prioridad',
			'Solución ejecutada'  => 'solucion_ejecutada',
			'Fecha resolución'    => 'fecha_resolucion',
			'Costes repercutidos' => 'costes_repercuti',
		);
		/**
         ...
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_incidencias';
		...
		public $search_fields = array (
			'Código' => array ('incidencias', 'cod_incidencias'),
			'Titulo' => array ('incidencias', 'titulo'),
			'Fecha evento' => array ('incidencias', 'fecha_evento'),
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		 ...
		 */
		public $popup_fields = array ('cod_incidencias');
		 ...
		 */
		public $mandatory_fields = array ('cod_incidencias');
