<?php
	...
	class reservaciones extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_reservaciones';
		public $table_index = 'reservacionesid';
		...
		public $customFieldTable = array ('vtiger_reservacionescf', 'reservacionesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_reservaciones', 'vtiger_reservacionescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_reservaciones'   => 'reservacionesid',
			'vtiger_reservacionescf' => 'reservacionesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('reservaciones', 'cod_reservaciones'),
			'Cliente' => array ('reservaciones', 'cliente_reser'),
			'Alias' => array ('reservaciones', 'alias_reservacion'),
			'Email' => array ('reservaciones', 'email_reserv'),
			'Inicio Reserva' => array ('reservaciones', 'inicio_reserva'),
			'Fin Reserva' => array ('reservaciones', 'fin_reserva'),
			'Centros' => array ('reservaciones', 'centro_reserva'),
			'Observaciones' => array ('reservaciones', 'observaciones_reserva'),
			'Recordatorio Reserva' => array ('reservaciones', 'recordatorio_reserva'),
			'Fecha Recordatorio' => array ('reservaciones', 'fecha_recordatorio'),
			'Pendiente Señal' => array ('reservaciones', 'pendiente_senal'),
			'Sabanas' => array ('reservaciones', 'sabanas_reservas'),
			'Más Información' => array ('reservaciones', 'mas_informacion_reserv'),
			'Vegetariano' => array ('reservaciones', 'vegetariano_reserv'),
			'Datos de Interés' => array ('reservaciones', 'datos_interes_reserva'),
			'¿Señal Pagada?' => array ('reservaciones', 'senal_pagada'),
			'Pago en Efectivo' => array ('reservaciones', 'pago_efectivo'),
			'Observaciones Contabilidad' => array ('reservaciones', 'observ_contabilidad_reservas'),
			'Puntuación' => array ('reservaciones', 'puntuacion_reserva')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_reservaciones',
			'Cliente' => 'cliente_reser',
			'Alias' => 'alias_reservacion',
			'Email' => 'email_reserv',
			'Inicio Reserva' => 'inicio_reserva',
			'Fin Reserva' => 'fin_reserva',
			'Centros' => 'centro_reserva',
			'Observaciones' => 'observaciones_reserva',
			'Recordatorio Reserva' => 'recordatorio_reserva',
			'Fecha Recordatorio' => 'fecha_recordatorio',
			'Pendiente Señal' => 'pendiente_senal',
			'Sabanas' => 'sabanas_reservas',
			'Más Información' => 'mas_informacion_reserv',
			'Vegetariano' => 'vegetariano_reserv',
			'Datos de Interés' => 'datos_interes_reserva',
			'¿Señal Pagada?' => 'senal_pagada',
			'Pago en Efectivo' => 'pago_efectivo',
			'Observaciones Contabilidad' => 'observ_contabilidad_reservas',
			'Puntuación' => 'puntuacion_reserva'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_reservaciones';
		 ...
		 */
		public $popup_fields = array ('cod_reservaciones');
		 ...
		 */
		public $mandatory_fields = array ('cod_reservaciones');
