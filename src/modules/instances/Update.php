<?php
	...
	try {
		...
		PlatformManager::getInstance ($masterAdb, $dbconfig ['db_serverForNewUsers'])->updateInstance ($instanceCode);
		$_SESSION ['flashmessage'] = array (
			'iserror' => false,
			'message' => "Se ha actualizado la instancia {$instanceCode}",
		);
	} catch (Exception $e) {
		$_SESSION ['flashmessage'] = array (
			'iserror' => true,
	...
	header ('Location: index.php?module=instances&action=index');
	exit ();
