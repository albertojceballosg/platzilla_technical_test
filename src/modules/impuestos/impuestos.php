<?php
	...
	class impuestos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_impuestos';
		public $table_index = 'impuestosid';
		...
		public $customFieldTable = array ('vtiger_impuestoscf', 'impuestosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_impuestos', 'vtiger_impuestoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_impuestos'   => 'impuestosid',
			'vtiger_impuestoscf' => 'impuestosid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('impuestos', 'cod_impuestos'),
			'Nombre' => array ('impuestos', 'nombre'),
			'Valor' => array ('impuestos', 'valor'),
			'Comentarios' => array ('impuestos', 'comentarios')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_impuestos';
		 ...
		 */
		public $popup_fields = array ('cod_impuestos');
		 ...
		 */
		public $mandatory_fields = array ('cod_impuestos');
