...
<div class="input-group col-xs-12">
	<input type="email" class="form-control login-form" id="usuarioEmail" name="usuarioEmail" placeholder="Email" readonly="readonly" value="{$USERNAME}">
...
<div class="row">
	<div class="col-xs-12">
		<button type="submit" class="btn btn-success col-xs-12 nextBtn" data-current-step="step-2">Terminar
