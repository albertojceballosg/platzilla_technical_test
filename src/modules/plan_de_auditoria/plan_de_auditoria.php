<?php
	...
	class plan_de_auditoria extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_plan_de_auditoria';
		public $table_index = 'plan_de_auditoriaid';
		...
		public $customFieldTable = array ('vtiger_plan_de_auditoriacf', 'plan_de_auditoriaid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_plan_de_auditoria', 'vtiger_plan_de_auditoriacf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_plan_de_auditoria'   => 'plan_de_auditoriaid',
			'vtiger_plan_de_auditoriacf' => 'plan_de_auditoriaid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('plan_de_auditoria', 'cod_plan_de_audi'),
			'Título auditoría' => array ('plan_de_auditoria', 'titulo_auditoria'),
			'xxx' => array ('plan_de_auditoria', 'xxx')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_plan_de_audi',
			'Título auditoría' => 'titulo_auditoria',
			'xxx' => 'xxx'
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_plan_de_audi';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_plan_de_audi';
		 ...
		 */
		public $popup_fields = array ('cod_plan_de_audi');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_plan_de_audi'));
