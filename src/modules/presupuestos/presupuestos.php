<?php
	...
	class presupuestos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_presupuestos';
		public $table_index = 'presupuestosid';
		...
		public $customFieldTable = array ('vtiger_presupuestoscf', 'presupuestosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_presupuestos', 'vtiger_presupuestoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_presupuestos'   => 'presupuestosid',
			'vtiger_presupuestoscf' => 'presupuestosid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('presupuestos', 'cod_presupuestos'),
			'Número factura' => array ('presupuestos', 'numero_factura'),
			'Cliente' => array ('presupuestos', 'cliente'),
			'Fecha de vencimiento' => array ('presupuestos', 'fecha_de_vencimiento'),
			'Forma de pago' => array ('presupuestos', 'forma_de_pago'),
			'Estado factura' => array ('presupuestos', 'estado_factura')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_presupuestos';
		 ...
		 */
		public $popup_fields = array ('cod_presupuestos');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_presupuestos'));
