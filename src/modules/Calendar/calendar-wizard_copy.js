(function (jQuery) {
	...
	var open = function (moduleName, entityId, entityLabel, returnTo, parameters) {
		alert("Estimado usuario,\n\nPara crear una nueva tarea o una acción, accede al registro específico del módulo al que estará asociada.\n\nDesde allí, utiliza la pestaña de acciones, o la sección correspondiente si se trata de un trabajo.");
		return false;
