...
if (obtenerValorVariable('CALENDAR_MODE_TURNOS','Calendar') == 'true')
	...
	$urlEvent = '<td class="dvtUnSelectedCell" align="center" nowrap="nowrap"><a href="index.php?action=ListView&module=Calendar&parenttab='.$category.'">'.$mod_strings["LBL_ALL_EVENTS_TODOS"].'</a></td>';
...
<tr>
	...
	<td width="20">&nbsp;</td>
				...
				if((isPermitted('Settings','index') == 'yes'))
					$html_string .= '<td style="padding-left:10px;"><a href="index.php?module=Settings&action=LayoutBlockList&formodule=Calendar&parenttab=Settings"><img src="'.$image_path.'settingsBox.png" alt="'.$app_strings['LBL_SETTINGS'].'" title="'.$app_strings['LBL_SETTINGS'].'" border="0"></a></td>';
				$html_string .= '</tr>
				</table>
	</td>
	</tr>
