<?php
	$mod_strings = array (
		...
		'AppLoc'                            => array ('0' => 'Oficina', '1' => 'Fuera', '2' => 'Vacaciones', '3' => 'Enfermo', '4' => 'Pospuesto', '5' => 'Optativo', '6' => 'Privado'),
		'cal_month_long'                    => array ('', 'Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'),
		'cal_weekdays_short'                => array ('Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sab', 'Dom'),
		'cal_weekdays_long'                 => array ('Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),
		'cal_month_short'                   => array ('', 'Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'),
		'LBL_TIME'                          => 'Horario',
		...
		'LBL_EVENTSTAT'                     => 'Fecha y hora de inicio',
		'LBL_EVENTEDAT'                     => 'Fecha y hora de vencimiento',
		'LBL_INVITE'                        => 'Invitar',
		'LBL_REPEAT'                        => 'Repetir',
		...
		'LBL_NAME_ENTITY'                   => 'Módulo',
		'LBL_ENTITY'                        => 'Entidad relacionada',
		'LBL_PROGRESS'                      => 'Progreso',
		'LBL_MATRIX_TITLE'                  => 'Clasificación tareas',
		'High-HIGH'                         => 'Importante - Urgente',
		'Low-HIGH'                          => 'Importante - No urgente',
		'High-LOW'                          => 'No importante - Urgente',
		'Low-LOW'                           => 'No importante - No urgente',
		'LBL_TASK_NOT_FOUND'                => 'La tarea/acción solicitada no existe',
		'LBL_NO_PERMISSION'                 => 'No tiene permisos para ver esta tarea',
		'LBL_RELATED_RECORD'                => 'Registro relacionado',
		'LBL_EXECUTOR'                      => 'Ejecutor',
		'LBL_SHOW_IN_MATRIX'                => 'Mostrar en matriz',
		'LBL_EVIDENCE_NOTE'                 => 'Podrá agregar evidencias a este reporte a través de la opción de modificación, una vez que el reporte haya sido creado.',
		...
		// Soft delete de reportes de avance
		'LBL_DELETE_REPORT_CONFIRM'         => '¿Está seguro de que desea eliminar este reporte de avance?',
		'LBL_REPORT_DELETED_SUCCESS'        => 'Reporte eliminado exitosamente',
		'LBL_ERROR_DELETING_REPORT'         => 'Error al eliminar el reporte',
		'LBL_REPORT_DELETE_PERMISSION_DENIED' => 'No tiene permisos para eliminar este reporte. Solo el creador o el administrador pueden eliminarlo.',
		'LBL_REPORT_MODIFIED_DATE'          => 'Fecha de modificación',
		'LBL_REPORT_DELETED_DATE'           => 'Fecha de eliminación',
		'LBL_REPORT_STATUS'                 => 'Estado del reporte',
		'LBL_REPORT_ACTIVE'                 => 'Activo',
		'LBL_REPORT_DELETED'                => 'Eliminado',
);
