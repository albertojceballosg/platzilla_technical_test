<?php
	...
	class corrective_actions extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_corrective_actions';
		public $table_index = 'corrective_actionsid';
		...
		public $customFieldTable = array ('vtiger_corrective_actionscf', 'corrective_actionsid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_corrective_actions', 'vtiger_corrective_actionscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_corrective_actions'   => 'corrective_actionsid',
			'vtiger_corrective_actionscf' => 'corrective_actionsid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('corrective_actions', 'cod_corrective_actions'),
			'Título' => array ('corrective_actions', 'title_ac'),
			'Otros involucrados' => array ('corrective_actions', 'others_involved_ac'),
			'Descripción' => array ('corrective_actions', 'description_ac'),
			'Resultados de la AC' => array ('corrective_actions', 'results_ac'),
			'Porcentaje de avance' => array ('corrective_actions', 'percent_completion_ac'),
			'Estado AC' => array ('corrective_actions', 'state_ac'),
			'Fecha de inicio' => array ('corrective_actions', 'start_date_ac'),
			'Fecha de finalización' => array ('corrective_actions', 'end_date_ac')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_corrective_actions',
			'Título' => 'title_ac',
			'Otros involucrados' => 'others_involved_ac',
			'Descripción' => 'description_ac',
			'Resultados de la AC' => 'results_ac',
			'Porcentaje de avance' => 'percent_completion_ac',
			'Estado AC' => 'state_ac',
			'Fecha de inicio' => 'start_date_ac',
			'Fecha de finalización' => 'end_date_ac'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_corrective_actions';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_corrective_actions';
		 ...
		 */
		public $popup_fields = array ('cod_corrective_actions');
		 ...
		 */
		public $mandatory_fields = array ('cod_corrective_actions');
