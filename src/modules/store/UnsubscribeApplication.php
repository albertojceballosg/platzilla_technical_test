<?php
	...
	try {
		...
		PlatformManager::getInstance ($masterAdb)->unsubscribeInstanceApplication ($_SESSION ['platInstancia'], $applicationCode);
		...
		echo json_encode ('La aplicación ha sido cancelada de tu suscripción');
	} catch (Exception $e) {
