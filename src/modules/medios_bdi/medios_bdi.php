<?php
	...
	class medios_bdi extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_medios_bdi';
		public $table_index   = 'medios_bdiid';
		...
		public $customFieldTable = array ('vtiger_medios_bdicf', 'medios_bdiid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_medios_bdi', 'vtiger_medios_bdicf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'    => 'crmid',
			'vtiger_medios_bdi'   => 'medios_bdiid',
			'vtiger_medios_bdicf' => 'medios_bdiid',
		);
		/**
		...
		public $list_fields = array (
			'Nombre del medio'                 => array ('medios_bdi', 'nombre_de_la_entidad'),
		);
		/**
		...
		public $search_fields = array (
			'Nombre del medio' => array ('medios_bdi', 'nombre_de_la_entidad'),
			'Tipo de medio'    => array ('medios_bdi', 'tipo_de_entidad'),
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		...
		public $def_basicsearch_col = 'nombre_de_la_entidad';
		 ...
		 */
		public $required_fields = array ('cod_medios_bdi' => 1);
		/** @var array Callback function list during Importing */
		public $special_functions = array ('set_import_assigned_user');
		/** @var string */
		public $default_order_by = 'nombre_de_la_entidad';
		/** @var string */
		 ...
		 */
		public $mandatory_fields = array ('cod_medios_bdi');
