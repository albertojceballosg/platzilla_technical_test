<?php
	...
	class no_conformidades extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_no_conformidades';
		public $table_index = 'no_conformidadesid';
		...
		public $customFieldTable = array ('vtiger_no_conformidadescf', 'no_conformidadesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_no_conformidades', 'vtiger_no_conformidadescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_no_conformidades'   => 'no_conformidadesid',
			'vtiger_no_conformidadescf' => 'no_conformidadesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('no_conformidades', 'cod_no_conformid'),
			'Título' => array ('no_conformidades', 'titulo'),
			'Descripción' => array ('no_conformidades', 'descripcion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_no_conformid';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_no_conformid';
		 ...
		 */
		public $popup_fields = array ('cod_no_conformid');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_no_conformid'));
