<?php
	$mod_strings = array (
		...
		'LBL_HELP_INFO'                        => 'Esto se utiliza como correo de respuesta al notificar un usuario recién creado, notificar de la asignación de un caso, otras notificaciones y recordatorios en general.',
