<?php
	...
	class etapas_proyecto extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_etapas_proyecto';
		public $table_index = 'etapas_proyectoid';
		...
		public $customFieldTable = array ('vtiger_etapas_proyectocf', 'etapas_proyectoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_etapas_proyecto', 'vtiger_etapas_proyectocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_etapas_proyecto'   => 'etapas_proyectoid',
			'vtiger_etapas_proyectocf' => 'etapas_proyectoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('etapas_proyecto', 'cod_etapas_proye'),
			'Título' => array ('etapas_proyecto', 'titulo'),
			'Descripción' => array ('etapas_proyecto', 'descripcion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_etapas_proye';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_etapas_proye';
		 ...
		 */
		public $popup_fields = array ('cod_etapas_proye');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_etapas_proye'));
