<?php
	...
	class clientes_colladito extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_clientes_colladito';
		...
		public $customFieldTable = array ('vtiger_clientes_colladitocf', 'clientesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_clientes_colladito', 'vtiger_clientes_colladitocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'  => 'crmid',
			'vtiger_clientes_colladito'   => 'clientesid',
			'vtiger_clientes_colladitocf' => 'clientesid',
		);
		/**
		...
		public $list_fields = array (
			'Nombre Social'	=> array ('clientes_colladito', 'nombre_social'),
		);
		/**
		 ...
		 */
		public $list_link_field = 'nombre_social';
		 ...
		 */
		public $popup_fields = array ('nombre_social');
		 ...
		 */
		public $mandatory_fields = array ('nombre_social');
