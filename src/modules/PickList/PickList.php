...
/*
Agregando código para determinar si viene desde la opción Configurar de los ListView de los módulos
*/
...
if ($return_module != ''){
	if ( !is_admin($current_user) ){
		$smarty->assign("USUARIO_CONTACTO",getAdminUsers());
		$smarty->assign("MODULE",$return_module);
		$smarty->display('Settings/LayoutBlockListPermissionFailed.tpl');
		return;
	}
}


$is_super_admin = is_superadmin($current_user);
$smarty->assign("IS_SUPERADMIN",$is_super_admin);
