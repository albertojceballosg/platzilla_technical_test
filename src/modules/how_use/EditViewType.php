<?php
	...
	try {
		$phu            = ProfilesHowToUseManager::getInstance ($adb);
		$companySectors = $phu->fetchCompanySector ();
		if (empty ($companySectors)) {
			throw new Exception ('Registrar al menos un sector de actividad económica!');
		}

		$smarty = new vtigerCRM_Smarty ();
		$smarty->assign ('COMPANY_TYPE', $phu->fetchCompanyTypeById ($record));
		...
		$smarty->display ('modules/how_use/EditViewType.tpl');
	} catch (Exception $e) {
