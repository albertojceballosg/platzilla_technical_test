<?php
	...
	try {
		if (empty ($record)) {
			throw new Exception ('Secttor no encontrado!');
		}
		HowToUseHelper::deleteSector ($adb, $record);

		$_SESSION ['flashmessage'] = array (
			'iserror' => false,
			'message' => 'Se ha eliminado el sector!',
		);
	} catch (Exception $e) {
		$_SESSION ['flashmessage'] = array (
			'iserror' => true,
	...
	header ('Location: index.php?module=how_use&action=ListView&tab=company_sector&parenttab=Settings');
