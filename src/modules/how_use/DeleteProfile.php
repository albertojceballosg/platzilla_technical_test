<?php
	...
	try {
		...
		HowToUseHelper::deleteProfileHowToUse ($adb, $record);

		$_SESSION ['flashmessage'] = array (
			'iserror' => false,
			'message' => 'Se ha eliminado el perfil de uso!',
		);
	} catch (Exception $e) {
		$_SESSION ['flashmessage'] = array (
			'iserror' => true,
	...
	header ('Location: index.php?module=how_use&action=ListView&tab=profile_use&parenttab=Settings');
