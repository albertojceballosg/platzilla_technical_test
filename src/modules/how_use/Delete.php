<?php
	...
	try {
		...
		HowToUseHelper::deleteHowToUse ($adb, $record);

		$_SESSION ['flashmessage'] = array (
			'iserror' => false,
			'message' => 'Se ha eliminado el modo de uso!',
		);
	} catch (Exception $e) {
		$_SESSION ['flashmessage'] = array (
			'iserror' => true,
	...
	header ('Location: index.php?module=how_use&action=ListView&parenttab=Settings');
