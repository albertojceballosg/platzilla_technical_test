<?php
	...
	class improvement_opportunities extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_improvement_opportunities';
		public $table_index = 'improvement_opportunitiesid';
		...
		public $customFieldTable = array ('vtiger_improvement_opportunitiescf', 'improvement_opportunitiesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_improvement_opportunities', 'vtiger_improvement_opportunitiescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_improvement_opportunities'   => 'improvement_opportunitiesid',
			'vtiger_improvement_opportunitiescf' => 'improvement_opportunitiesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('improvement_opportunities', 'cod_improvement_opportunities'),
			'Título' => array ('improvement_opportunities', 'title'),
			'Área donde impacta' => array ('improvement_opportunities', 'improvment_area'),
			'Descripción' => array ('improvement_opportunities', 'description'),
			'Duración estimada (horas)' => array ('improvement_opportunities', 'estimated_duration'),
			'Tipo de mejora' => array ('improvement_opportunities', 'type_of_improvement'),
			'Origen de la oportunidad' => array ('improvement_opportunities', 'improvement_origin'),
			'Seleccione Cliente' => array ('improvement_opportunities', 'cliente'),
			'Seleccione Asunto' => array ('improvement_opportunities', 'incidencia'),
			'Seleccione Proceso' => array ('improvement_opportunities', 'process'),
			'Seleccione Problema' => array ('improvement_opportunities', 'problem'),
			'Seleccione Riesgo' => array ('improvement_opportunities', 'risk'),
			'Seleccione Recurso' => array ('improvement_opportunities', 'resources'),
			'Seleccione Plan de Mejora' => array ('improvement_opportunities', 'action_plan'),
			'Seleccione No Conformidad' => array ('improvement_opportunities', 'nonconformities'),
			'Seleccione Proyecto' => array ('improvement_opportunities', 'proyecto'),
			'Seleccione Trabajo' => array ('improvement_opportunities', 'trabajo'),
			'Seleccione Campaña' => array ('improvement_opportunities', 'campaign'),
			'Seleccione Producto/Servicio' => array ('improvement_opportunities', 'articulos'),
			'Otro, especifique' => array ('improvement_opportunities', 'specify_other'),
			'Estado de la mejora' => array ('improvement_opportunities', 'improvment_phase'),
			'Modo de cierre' => array ('improvement_opportunities', 'closing mode'),
			'Fecha de inicio' => array ('improvement_opportunities', 'init_date'),
			'Fecha de cierre' => array ('improvement_opportunities', 'deadline'),
			'Acciones planificadas' => array ('improvement_opportunities', 'planned_actions'),
			'Horas utilizadas' => array ('improvement_opportunities', 'hours_used'),
			'Notas de desarrollo' => array ('improvement_opportunities', 'development_notes')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_improvement_opportunities',
			'Título' => 'title',
			'Área donde impacta' => 'improvment_area',
			'Descripción' => 'description',
			'Duración estimada (horas)' => 'estimated_duration',
			'Tipo de mejora' => 'type_of_improvement',
			'Origen de la oportunidad' => 'improvement_origin',
			'Seleccione Cliente' => 'cliente',
			'Seleccione Asunto' => 'incidencia',
			'Seleccione Proceso' => 'process',
			'Seleccione Problema' => 'problem',
			'Seleccione Riesgo' => 'risk',
			'Seleccione Recurso' => 'resources',
			'Seleccione Plan de Mejora' => 'action_plan',
			'Seleccione No Conformidad' => 'nonconformities',
			'Seleccione Proyecto' => 'proyecto',
			'Seleccione Trabajo' => 'trabajo',
			'Seleccione Campaña' => 'campaign',
			'Seleccione Producto/Servicio' => 'articulos',
			'Otro, especifique' => 'specify_other',
			'Estado de la mejora' => 'improvment_phase',
			'Modo de cierre' => 'closing mode',
			'Fecha de inicio' => 'init_date',
			'Fecha de cierre' => 'deadline',
			'Acciones planificadas' => 'planned_actions',
			'Horas utilizadas' => 'hours_used',
			'Notas de desarrollo' => 'development_notes'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname) selected on Creator
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_improvement_opportunities';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_improvement_opportunities';
		 ...
		 */
		public $popup_fields = array ('cod_improvement_opportunities');
		...
		public $def_basicsearch_col = 'cod_improvement_opportunities';
		/** @var string Column value to use on detail view record text display */
		public $def_detailview_recname = 'cod_improvement_opportunities';
		/**
		 * @var array Required Information for enabling Import feature
		 * $required_fields = array('payslipname'=>1);
		 */
		public $required_fields = array ('cod_improvement_opportunities' => 1);
		/** @var array Callback function list during Importing */
		public $special_functions = array ('set_import_assigned_user');
		/** @var string */
		public $default_order_by = 'cod_improvement_opportunities';
		/** @var string */
		 ...
		 */
		public $mandatory_fields = array ('cod_improvement_opportunities');
