<?php
	...
	class diagnostic_report extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_diagnostic_report';
		public $table_index = 'diagnostic_reportid';
		...
		public $customFieldTable = array ('vtiger_diagnostic_reportcf', 'diagnostic_reportid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_diagnostic_report', 'vtiger_diagnostic_reportcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_diagnostic_report'   => 'diagnostic_reportid',
			'vtiger_diagnostic_reportcf' => 'diagnostic_reportid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('diagnostic_report', 'cod_diagnostic_report'),
			'Titulo' => array ('diagnostic_report', 'report_title'),
			'Mapa situación' => array ('diagnostic_report', 'current_status'),
			'Situación actual' => array ('diagnostic_report', 'current_situation'),
			'Datos de la empresa' => array ('diagnostic_report', 'diagnostic_data'),
			'Video informativo' => array ('diagnostic_report', 'informative_video'),
			'Resultados de funciones' => array ('diagnostic_report', 'function_result'),
			'Oportunidades de mejoras' => array ('diagnostic_report', 'improvement_opportunities'),
			'Destino' => array ('diagnostic_report', 'destination'),
			'Plan de acción' => array ('diagnostic_report', 'action_plan')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_diagnostic_report',
			'Titulo' => 'report_title',
			'Mapa situación' => 'current_status',
			'Situación actual' => 'current_situation',
			'Datos de la empresa' => 'diagnostic_data',
			'Video informativo' => 'informative_video',
			'Resultados de funciones' => 'function_result',
			'Oportunidades de mejoras' => 'improvement_opportunities',
			'Destino' => 'destination',
			'Plan de acción' => 'action_plan'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'report_title';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_diagnostic_report';
		 ...
		 */
		public $popup_fields = array ('report_title');
		 ...
		 */
		public $mandatory_fields = array ('report_title');
