<?php
	...
	class productos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_productos';
		public $table_index = 'productosid';
		...
		public $customFieldTable = array ('vtiger_productoscf', 'productosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_productos', 'vtiger_productoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_productos'   => 'productosid',
			'vtiger_productoscf' => 'productosid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('productos', 'cod_productos'),
			'Nombre' => array ('productos', 'nombre'),
			'Código producto' => array ('productos', 'codigo_producto'),
			'Stock' => array ('productos', 'stock'),
			'Precio sin impuestos' => array ('productos', 'precio_sin_impuestos'),
			'Impuesto' => array ('productos', 'impuesto'),
			'Precio con impuestos' => array ('productos', 'precio_con_impuestos')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_productos';
		 ...
		 */
		public $popup_fields = array ('cod_productos');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_productos'));
