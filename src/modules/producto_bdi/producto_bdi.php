<?php
	...
	class producto_bdi extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_producto_bdi';
		public $table_index = 'producto_bdiid';
		...
		public $customFieldTable = array ('vtiger_producto_bdicf', 'producto_bdiid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_producto_bdi', 'vtiger_producto_bdicf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_producto_bdi'   => 'producto_bdiid',
			'vtiger_producto_bdicf' => 'producto_bdiid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('producto_bdi', 'cod_producto_bdi'),
			'Nombre' => array ('producto_bdi', 'nombre'),
			'Descripción' => array ('producto_bdi', 'descripcion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_producto_bdi';
		 ...
		 */
		public $popup_fields = array ('cod_producto_bdi');
		 ...
		 */
		public $mandatory_fields = array ('cod_producto_bdi');
