<?php
	...
	class campaign_marketing extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_campaign_marketing';
		public $table_index = 'campaign_marketingid';
		...
		public $customFieldTable = array ('vtiger_campaign_marketingcf', 'campaign_marketingid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_campaign_marketing', 'vtiger_campaign_marketingcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_campaign_marketing'   => 'campaign_marketingid',
			'vtiger_campaign_marketingcf' => 'campaign_marketingid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('campaign_marketing', 'cod_campaign_marketing'),
			'Título' => array ('campaign_marketing', 'title_campaign'),
			'Objetivo' => array ('campaign_marketing', 'objective_campaign'),
			'Descripción' => array ('campaign_marketing', 'description_campaign'),
			'Tipo de campaña' => array ('campaign_marketing', 'record_type_campaign'),
			'Clase de campaña' => array ('campaign_marketing', 'campaign_class'),
			'Clase de evento' => array ('campaign_marketing', 'event_class'),
			'¿Es interno o para un cliente?' => array ('campaign_marketing', 'campaign_internal_client'),
			'customer_campaign' => array ('campaign_marketing', 'sel_customer_campaign'),
			'¿Qué origina la campaña o evento?' => array ('campaign_marketing', 'campaign_origin'),
			'Seleccione Producto o Servicio' => array ('campaign_marketing', 'product_campaign'),
			'Seleccione Asunto' => array ('campaign_marketing', 'matter_campaign'),
			'Seleccione Contrato' => array ('campaign_marketing', 'contrat_campaign'),
			'Seleccione Oportunidad' => array ('campaign_marketing', 'oportunity_campaign'),
			'Seleccione Pedido' => array ('campaign_marketing', 'order_campaign'),
			'Objetivo estratégico' => array ('campaign_marketing', 'strategic_objective_campaign'),
			'Resultado clave' => array ('campaign_marketing', 'key_result_campaign'),
			'Iniciativa' => array ('campaign_marketing', 'related_initiative'),
			'Modalidad' => array ('campaign_marketing', 'modality_campaign'),
			'Público objetivo' => array ('campaign_marketing', 'target_audiences'),
			'Medios de divulgación' => array ('campaign_marketing', 'advertising_media'),
			'¿Se recibió Briefing?' => array ('campaign_marketing', 'briefing_campaign'),
			'¿Se dispone de instrumento de medición y control?' => array ('campaign_marketing', 'measuring_instrument'),
			'¿Cuenta con el programa del evento?' => array ('campaign_marketing', 'event_program_campaign'),
			'Duración (horas)' => array ('campaign_marketing', 'duration_campaign'),
			'Horario recomendado' => array ('campaign_marketing', 'recommended_schedule'),
			'Número máximo de participantes' => array ('campaign_marketing', 'max_num_participants'),
			'Requerimientos de espacio y equipamiento' => array ('campaign_marketing', 'space_equip_requerid'),
			'Otros detalles de logística' => array ('campaign_marketing', 'other_logistics_details'),
			'Estado' => array ('campaign_marketing', 'state_campaign'),
			'Fecha estimada de inicio' => array ('campaign_marketing', 'estimated_start_date'),
			'Fecha de inicio' => array ('campaign_marketing', 'init_date_campaign'),
			'Fecha de terminación' => array ('campaign_marketing', 'end_date_campaign'),
			'Forma de terminación' => array ('campaign_marketing', 'termination_form_campaign'),
			'Razón de la cancelación' => array ('campaign_marketing', 'reason_cancellation'),
			'Razón de la suspensión' => array ('campaign_marketing', 'reason_suspension'),
			'Costo estimado' => array ('campaign_marketing', 'estimated_total_cost'),
			'Esfuerzo estimado' => array ('campaign_marketing', 'estimated_effort'),
			'Porcentaje de avance general' => array ('campaign_marketing', 'overall_progress_perc'),
			'Costo ejecutado' => array ('campaign_marketing', 'cost_executed'),
			'Esfuerzo ejecutado' => array ('campaign_marketing', 'effort_executed'),
			'Ingresos esperados' => array ('campaign_marketing', 'expected_income'),
			'Ingresos reales' => array ('campaign_marketing', 'real_income'),
			'Comentarios de seguimiento' => array ('campaign_marketing', 'followup_comments'),
			'Gestión de Oportunidades' => array ('campaign_marketing', 'manag_opportunities_campaign'),
			'Gestión de Facturas' => array ('campaign_marketing', 'invoice_manag_campaign'),
			'Gestión de Pedidos' => array ('campaign_marketing', 'order_manag_campaign'),
			'Gestión de Prospectos' => array ('campaign_marketing', 'prospect_manag_campaign'),
			'Gestión de Ventas' => array ('campaign_marketing', 'sales_manag_campaign')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_campaign_marketing',
			'Título' => 'title_campaign',
			'Objetivo' => 'objective_campaign',
			'Descripción' => 'description_campaign',
			'Tipo de campaña' => 'record_type_campaign',
			'Clase de campaña' => 'campaign_class',
			'Clase de evento' => 'event_class',
			'¿Es interno o para un cliente?' => 'campaign_internal_client',
			'customer_campaign' => 'sel_customer_campaign',
			'¿Qué origina la campaña o evento?' => 'campaign_origin',
			'Seleccione Producto o Servicio' => 'product_campaign',
			'Seleccione Asunto' => 'matter_campaign',
			'Seleccione Contrato' => 'contrat_campaign',
			'Seleccione Oportunidad' => 'oportunity_campaign',
			'Seleccione Pedido' => 'order_campaign',
			'Objetivo estratégico' => 'strategic_objective_campaign',
			'Resultado clave' => 'key_result_campaign',
			'Iniciativa' => 'related_initiative',
			'Modalidad' => 'modality_campaign',
			'Público objetivo' => 'target_audiences',
			'Medios de divulgación' => 'advertising_media',
			'¿Se recibió Briefing?' => 'briefing_campaign',
			'¿Se dispone de instrumento de medición y control?' => 'measuring_instrument',
			'¿Cuenta con el programa del evento?' => 'event_program_campaign',
			'Duración (horas)' => 'duration_campaign',
			'Horario recomendado' => 'recommended_schedule',
			'Número máximo de participantes' => 'max_num_participants',
			'Requerimientos de espacio y equipamiento' => 'space_equip_requerid',
			'Otros detalles de logística' => 'other_logistics_details',
			'Estado' => 'state_campaign',
			'Fecha estimada de inicio' => 'estimated_start_date',
			'Fecha de inicio' => 'init_date_campaign',
			'Fecha de terminación' => 'end_date_campaign',
			'Forma de terminación' => 'termination_form_campaign',
			'Razón de la cancelación' => 'reason_cancellation',
			'Razón de la suspensión' => 'reason_suspension',
			'Costo estimado' => 'estimated_total_cost',
			'Esfuerzo estimado' => 'estimated_effort',
			'Porcentaje de avance general' => 'overall_progress_perc',
			'Costo ejecutado' => 'cost_executed',
			'Esfuerzo ejecutado' => 'effort_executed',
			'Ingresos esperados' => 'expected_income',
			'Ingresos reales' => 'real_income',
			'Comentarios de seguimiento' => 'followup_comments',
			'Gestión de Oportunidades' => 'manag_opportunities_campaign',
			'Gestión de Facturas' => 'invoice_manag_campaign',
			'Gestión de Pedidos' => 'order_manag_campaign',
			'Gestión de Prospectos' => 'prospect_manag_campaign',
			'Gestión de Ventas' => 'sales_manag_campaign'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'title_campaign';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_campaign_marketing';
		...
		public $search_fields_name = array (
			'Título' => 'title_campaign','Código' => 'cod_campaign_marketing'
		);
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('title_campaign');
		 ...
		 */
		public $mandatory_fields = array ('title_campaign');
