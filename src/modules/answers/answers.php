<?php
	...
	class answers extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_answers';
		public $table_index = 'answersid';
		...
		public $customFieldTable = array ('vtiger_answerscf', 'answersid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_answers', 'vtiger_answerscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_answers'   => 'answersid',
			'vtiger_answerscf' => 'answersid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('answers', 'cod_answers'),
			'Cuestionario' => array ('answers', 'questionnaire'),
			'Fundamento' => array ('answers', 'questiongroup'),
			'Etapa' => array ('answers', 'questionstage'),
			'Encuestado' => array ('answers', 'username'),
			'Correo' => array ('answers', 'useremail'),
			'Referencia' => array ('answers', 'reference'),
			'Pregunta' => array ('answers', 'question'),
			'Respuesta' => array ('answers', 'useranswer'),
			'¿Respuesta esperada?' => array ('answers', 'correctanswer'),
			'Posición' => array ('answers', 'sequence')
		);
		/**
		 ...
		 */
		public $popup_fields = array ('cod_answers');
		 ...
		 */
		public $mandatory_fields = array ('cod_answers');
