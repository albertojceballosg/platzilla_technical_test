<?php
	...
	class segmentos_objetivo extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_segmentos_objetivo';
		public $table_index = 'segmentos_objetivoid';
		...
		public $customFieldTable = array ('vtiger_segmentos_objetivocf', 'segmentos_objetivoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_segmentos_objetivo', 'vtiger_segmentos_objetivocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_segmentos_objetivo'   => 'segmentos_objetivoid',
			'vtiger_segmentos_objetivocf' => 'segmentos_objetivoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('segmentos_objetivo', 'cod_segmentos_ob'),
			'Nombre' => array ('segmentos_objetivo', 'nombre'),
			'Tipo segmento' => array ('segmentos_objetivo', 'tipo_segmento')
		);
		/**
		 ...
		 */
		public $popup_fields = array ('cod_segmentos_ob');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_segmentos_ob'));
