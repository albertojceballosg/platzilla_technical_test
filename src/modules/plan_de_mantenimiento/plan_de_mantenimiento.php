<?php
	...
	class plan_de_mantenimiento extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_plan_de_mantenimiento';
		public $table_index = 'plan_de_mantenimientoid';
		...
		public $customFieldTable = array ('vtiger_plan_de_mantenimientocf', 'plan_de_mantenimientoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_plan_de_mantenimiento', 'vtiger_plan_de_mantenimientocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_plan_de_mantenimiento'   => 'plan_de_mantenimientoid',
			'vtiger_plan_de_mantenimientocf' => 'plan_de_mantenimientoid',
		);
		 ...
		 */
		public $list_link_field = 'cod_plan_de_mant';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_plan_de_mant';
		...
		public $search_fields = array (
			'Código' => array ('plan_de_mantenimiento', 'cod_plan_de_mant')
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		 ...
		 */
		public $popup_fields = array ('cod_plan_de_mant');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_plan_de_mant'));
