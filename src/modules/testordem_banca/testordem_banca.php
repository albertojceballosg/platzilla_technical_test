<?php
	...
	class testordem_banca extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_testordem_banca';
		public $table_index = 'testordem_bancaid';
		...
		public $customFieldTable = array ('vtiger_testordem_bancacf', 'testordem_bancaid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_testordem_banca', 'vtiger_testordem_bancacf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_testordem_banca'   => 'testordem_bancaid',
			'vtiger_testordem_bancacf' => 'testordem_bancaid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('testordem_banca', 'cod_testordem_banca'),
			'Nombres Ordem Banca' => array ('testordem_banca', 'nombre_ob'),
			'Fecha Ordem Banca' => array ('testordem_banca', 'fecha_ob'),
			'Moneda Ordem Banca' => array ('testordem_banca', 'moneda_ob'),
			'Tipo Ordem Banca' => array ('testordem_banca', 'tipo_ob'),
			'Producto Ordem Banca' => array ('testordem_banca', 'productos_ob')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_testordem_banca',
			'Nombres Ordem Banca' => 'nombre_ob',
			'Fecha Ordem Banca' => 'fecha_ob',
			'Moneda Ordem Banca' => 'moneda_ob',
			'Tipo Ordem Banca' => 'tipo_ob',
			'Producto Ordem Banca' => 'productos_ob'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_testordem_banca';
		 ...
		 */
		public $popup_fields = array ('cod_testordem_banca');
		 ...
		 */
		public $mandatory_fields = array ('cod_testordem_banca');
