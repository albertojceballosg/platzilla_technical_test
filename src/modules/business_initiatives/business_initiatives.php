<?php
	...
	class business_initiatives extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_business_initiatives';
		public $table_index = 'business_initiativesid';
		...
		public $customFieldTable = array ('vtiger_business_initiativescf', 'business_initiativesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_business_initiatives', 'vtiger_business_initiativescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_business_initiatives'   => 'business_initiativesid',
			'vtiger_business_initiativescf' => 'business_initiativesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('business_initiatives', 'cod_business_initiatives'),
			'¿Qué origina esta iniciativa?' => array ('business_initiatives', 'initiative_source'),
			'KR relacionado' => array ('business_initiatives', 'kr_initiative'),
			'Objetivo relacionado' => array ('business_initiatives', 'related_objective'),
			'Asunto relacionado' => array ('business_initiatives', 'related_matter'),
			'Proceso relacionado' => array ('business_initiatives', 'related_process'),
			'Riesgo relacionado' => array ('business_initiatives', 'related_risk'),
			'Campaña relacionada' => array ('business_initiatives', 'related_campaing'),
			'Proyecto relacionado' => array ('business_initiatives', 'related_project'),
			'Especifique otros' => array ('business_initiatives', 'specify_others'),
			'Título de la iniciativa' => array ('business_initiatives', 'initiative_title'),
			'¿En qué consiste?' => array ('business_initiatives', 'try_do'),
			'URL de la ficha' => array ('business_initiatives', 'file_url'),
			'¿Por qué es importante?' => array ('business_initiatives', 'importance'),
			'Nivel de dificultad' => array ('business_initiatives', 'difficulty_level'),
			'¿Aplica esta iniciativa en tu empresa?' => array ('business_initiatives', 'apply_in_your_company'),
			'¿En qué momento la puedes aplicar?' => array ('business_initiatives', 'when_to_apply'),
			'¿Cuáles son las claves para desarrollarla?' => array ('business_initiatives', 'keys_to_develop'),
			'Ejemplos de buena aplicación' => array ('business_initiatives', 'good_application_eg'),
			'Vídeo explicativo' => array ('business_initiatives', 'url_video'),
			'Link al foro' => array ('business_initiatives', 'forum_link'),
			'Otro recurso web' => array ('business_initiatives', 'other_web_resource'),
			'Estado' => array ('business_initiatives', 'initiative_status'),
			'Forma de registro del avance' => array ('business_initiatives', 'progress_type'),
			'% avance manual' => array ('business_initiatives', 'progress_initiative'),
			'% avance calculado' => array ('business_initiatives', 'auto_advanced_initiative'),
			'Notas de seguimiento' => array ('business_initiatives', 'initiative_note'),
			'Fecha de terminación' => array ('business_initiatives', 'end_date'),
			'Condición' => array ('business_initiatives', 'initiative_condition')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_business_initiatives',
			'¿Qué origina esta iniciativa?' => 'initiative_source',
			'KR relacionado' => 'kr_initiative',
			'Objetivo relacionado' => 'related_objective',
			'Asunto relacionado' => 'related_matter',
			'Proceso relacionado' => 'related_process',
			'Riesgo relacionado' => 'related_risk',
			'Campaña relacionada' => 'related_campaing',
			'Proyecto relacionado' => 'related_project',
			'Especifique otros' => 'specify_others',
			'Título de la iniciativa' => 'initiative_title',
			'¿En qué consiste?' => 'try_do',
			'URL de la ficha' => 'file_url',
			'¿Por qué es importante?' => 'importance',
			'Nivel de dificultad' => 'difficulty_level',
			'¿Aplica esta iniciativa en tu empresa?' => 'apply_in_your_company',
			'¿En qué momento la puedes aplicar?' => 'when_to_apply',
			'¿Cuáles son las claves para desarrollarla?' => 'keys_to_develop',
			'Ejemplos de buena aplicación' => 'good_application_eg',
			'Vídeo explicativo' => 'url_video',
			'Link al foro' => 'forum_link',
			'Otro recurso web' => 'other_web_resource',
			'Estado' => 'initiative_status',
			'Forma de registro del avance' => 'progress_type',
			'% avance manual' => 'progress_initiative',
			'% avance calculado' => 'auto_advanced_initiative',
			'Notas de seguimiento' => 'initiative_note',
			'Fecha de terminación' => 'end_date',
			'Condición' => 'initiative_condition'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_business_initiatives';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_business_initiatives';
		 ...
		 */
		public $popup_fields = array ('cod_business_initiatives');
		 ...
		 */
		public $mandatory_fields = array ('cod_business_initiatives');
		...
		public function save_module ($module) {
			...
			try {
				ResourceToInitiative::getInstance ($adb)->buildResourceInitiatives ($current_user->id, $this->id, $this->mode);
			} catch (Exception $e) {
