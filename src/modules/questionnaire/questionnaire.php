<?php
	...
	class questionnaire extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_questionnaire';
		public $table_index = 'questionnaireid';
		...
		public $customFieldTable = array ('vtiger_questionnairecf', 'questionnaireid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_questionnaire', 'vtiger_questionnairecf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_questionnaire'   => 'questionnaireid',
			'vtiger_questionnairecf' => 'questionnaireid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('questionnaire', 'cod_questionnaire'),
			'Título' => array ('questionnaire', 'name'),
			'Descripción' => array ('questionnaire', 'descrption'),
			'Objetivo' => array ('questionnaire', 'objetive'),
			'Ayuda' => array ('questionnaire', 'help_text'),
			'Video' => array ('questionnaire', 'presentation_video'),
			'Url' => array ('questionnaire', 'presentation_url'),
			'Estado' => array ('questionnaire', 'status')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_questionnaire';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_questionnaire';
		 ...
		 */
		public $popup_fields = array ('cod_questionnaire');
		 ...
		 */
		public $mandatory_fields = array ('cod_questionnaire');
		...
		public function save_module ($module) {
			global $adb, $site_URL;
			try {
				Question::getInstance ($adb)->buildupAskingFor ($this->id, $_SESSION ['platInstancia'], $site_URL);
			} catch (Exception $e) {
