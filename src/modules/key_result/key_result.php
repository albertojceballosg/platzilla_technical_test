<?php
	...
	class key_result extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_key_result';
		public $table_index = 'key_resultid';
		...
		public $customFieldTable = array ('vtiger_key_resultcf', 'key_resultid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_key_result', 'vtiger_key_resultcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_key_result'   => 'key_resultid',
			'vtiger_key_resultcf' => 'key_resultid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('key_result', 'cod_key_result'),
			'Resultado clave (KR)' => array ('key_result', 'key_result'),
			'Tipo de valor' => array ('key_result', 'value_type'),
			'Valor sugerido' => array ('key_result', 'kr_suggested_value_one'),
			'Valor final del rango' => array ('key_result', 'kr_suggested_value_two'),
			'Descripción' => array ('key_result', 'kr_description'),
			'Área relacionada' => array ('key_result', 'area_name'),
			'Progreso del KR' => array ('key_result', 'kr_progress'),
			'Estado KR' => array ('key_result', 'kr_state'),
			'Forma de terminación' => array ('key_result', 'completion_mode'),
			'Observaciones' => array ('key_result', 'kr_observation')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_key_result',
			'Resultado clave (KR)' => 'key_result',
			'Tipo de valor' => 'value_type',
			'Valor sugerido' => 'kr_suggested_value_one',
			'Valor final del rango' => 'kr_suggested_value_two',
			'Descripción' => 'kr_description',
			'Área relacionada' => 'area_name',
			'Progreso del KR' => 'kr_progress',
			'Estado KR' => 'kr_state',
			'Forma de terminación' => 'completion_mode',
			'Observaciones' => 'kr_observation'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_key_result';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_key_result';
		...
		public $search_fields_name = array (
			'Resultado clave (KR)' => 'cod_key_result'
		);
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('cod_key_result');
		 ...
		 */
		public $mandatory_fields = array ('cod_key_result');
