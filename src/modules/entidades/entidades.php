<?php
	...
	class entidades extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_entidades';
		public $table_index   = 'entidadesid';
		...
		public $customFieldTable = array ('vtiger_entidadescf', 'entidadesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_entidades', 'vtiger_entidadescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'   => 'crmid',
			'vtiger_entidades'   => 'entidadesid',
			'vtiger_entidadescf' => 'entidadesid',
		);
		/**
		...
		public $list_fields = array (
			'Código'                           => array ('entidades', 'cod_entidades'),
			'Tipo de Entidad'                  => array ('entidades', 'tipo_de_entidad'),
			'Nombre de la Entidad'             => array ('entidades', 'nombre_de_la_entidad'),
			'Teléfono'                         => array ('entidades', 'telefono'),
			'Email'                            => array ('entidades', 'email'),
			'Dirección'                        => array ('entidades', 'direccion'),
			'Grupo prensa(accountsespecifico)' => array ('entidades', 'grupo_prensaaccountsespecifico'),
			'Categoría de empresa'             => array ('entidades', 'categoria_de_empresa'),
			'Actividades'                      => array ('entidades', 'actividades'),
			'Fecha última visita'              => array ('entidades', 'fecha_ultima_visita'),
			'Aportador de negocios'            => array ('entidades', 'aportador_de_negocios'),
		);
		/**
		...
		public $list_fields_name = array (
			'Código'                           => 'cod_entidades',
			'Tipo de Entidad'                  => 'tipo_de_entidad',
			'Nombre de la Entidad'             => 'nombre_de_la_entidad',
			'Teléfono'                         => 'telefono',
			'Email'                            => 'email',
			'Dirección'                        => 'direccion',
			'Grupo prensa(accountsespecifico)' => 'grupo_prensaaccountsespecifico',
			'Categoría de empresa'             => 'categoria_de_empresa',
			'Actividades'                      => 'actividades',
			'Fecha última visita'              => 'fecha_ultima_visita',
			'Aportador de negocios'            => 'aportador_de_negocios',
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_entidades';
		 ...
		 */
		public $popup_fields = array ('nombre_de_la_entidad');
		 ...
		 */
		public $mandatory_fields = array ('cod_entidades');
