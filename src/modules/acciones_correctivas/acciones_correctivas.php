<?php
	...
	class acciones_correctivas extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_acciones_correctivas';
		public $table_index = 'acciones_correctivasid';
		...
		public $customFieldTable = array ('vtiger_acciones_correctivascf', 'acciones_correctivasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_acciones_correctivas', 'vtiger_acciones_correctivascf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_acciones_correctivas'   => 'acciones_correctivasid',
			'vtiger_acciones_correctivascf' => 'acciones_correctivasid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('acciones_correctivas', 'cod_acciones_cor'),
			'Título' => array ('acciones_correctivas', 'titulo'),
			'Descripción' => array ('acciones_correctivas', 'descripcion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_acciones_cor';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_acciones_cor';
		 ...
		 */
		public $popup_fields = array ('cod_acciones_cor');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_acciones_cor'));
