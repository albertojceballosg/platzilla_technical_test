<?php
	...
	class predefined_initiatives extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_predefined_initiatives';
		public $table_index = 'predefined_initiativesid';
		...
		public $customFieldTable = array ('vtiger_predefined_initiativescf', 'predefined_initiativesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_predefined_initiatives', 'vtiger_predefined_initiativescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_predefined_initiatives'   => 'predefined_initiativesid',
			'vtiger_predefined_initiativescf' => 'predefined_initiativesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('predefined_initiatives', 'cod_predefined_initiatives'),
			'Título' => array ('predefined_initiatives', 'initiative_title'),
			'Tipo de empresa' => array ('predefined_initiatives', 'business_type'),
			'Etapa en la que se puede aplicar' => array ('predefined_initiatives', 'business_phase'),
			'Condición' => array ('predefined_initiatives', 'initiative_condition'),
			'¿En qué consiste?' => array ('predefined_initiatives', 'try_to'),
			'URL a la ficha' => array ('predefined_initiatives', 'url_to_tab'),
			'¿Por qué es importante?' => array ('predefined_initiatives', 'importance'),
			'Nivel de dificultad' => array ('predefined_initiatives', 'difficulty_level'),
			'¿Aplica esta iniciativa en tu empresa?' => array ('predefined_initiatives', 'apply_in_your_company'),
			'¿En qué momento la puedes aplicar?' => array ('predefined_initiatives', 'when_to_apply'),
			'¿Cuáles son las claves para desarrollarla?' => array ('predefined_initiatives', 'keys_to_develop'),
			'Ejemplos de buena aplicación' => array ('predefined_initiatives', 'good_application_eg'),
			'Etiquetas blog' => array ('predefined_initiatives', 'blog_lavel'),
			'Video explicativo' => array ('predefined_initiatives', 'url_video'),
			'Transcripción del vídeo' => array ('predefined_initiatives', 'video_transcript'),
			'Link al foro' => array ('predefined_initiatives', 'forum_link'),
			'Otro recurso web' => array ('predefined_initiatives', 'other_web_resource')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_predefined_initiatives',
			'Título' => 'initiative_title',
			'Tipo de empresa' => 'business_type',
			'Etapa en la que se puede aplicar' => 'business_phase',
			'Condición' => 'initiative_condition',
			'¿En qué consiste?' => 'try_to',
			'URL a la ficha' => 'url_to_tab',
			...
			'Etiquetas blog' => 'blog_lavel',
			'Video explicativo' => 'url_video',
			'Transcripción del vídeo' => 'video_transcript',
		 ...
		 */
		public $list_link_field = 'cod_predefined_initiatives';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_predefined_initiatives';
		...
		public $search_fields = array (
			'Título' => array ('predefined_initiatives', 'cod_predefined_initiatives')
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		...
		public $search_fields_name = array (
			'Título' => 'cod_predefined_initiatives'
		);
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('cod_predefined_initiatives');
		 ...
		 */
		public $mandatory_fields = array ('cod_predefined_initiatives');
