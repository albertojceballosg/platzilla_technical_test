<?php
	...
	class emailssent extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_emailssent';
		public $table_index   = 'emailssentid';
		...
		public $customFieldTable = array ('vtiger_emailssentcf', 'emailssentid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_emailssent', 'vtiger_emailssentcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'    => 'crmid',
			'vtiger_emailssent'   => 'emailssentid',
			'vtiger_emailssentcf' => 'emailssentid',
		);
		/**
		...
		public $list_fields = array (
			'Subject' => array ('emailssent', 'subject'),
			'From'    => array ('emailssent', 'from_'),
			'To'      => array ('emailssent', 'to_'),
			'CC'      => array ('emailssent', 'cc'),
			'BCC'     => array ('emailssent', 'bcc'),
			'Date'    => array ('emailssent', 'maildate'),
			'Body'    => array ('emailssent', 'body'),
		);
		/**
		...
		public function save_module () {
			...
			$arguments [] = $this->id;
			$adb->pquery ("UPDATE vtiger_emailssent SET {$setClause} WHERE emailssentid=?", $arguments);
		}
