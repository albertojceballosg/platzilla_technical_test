<?php
	...
	class usuarios_colladito extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_usuarios_colladito';
		public $table_index = 'usuarios_colladitoid';
		...
		public $customFieldTable = array ('vtiger_usuarios_colladitocf', 'usuarios_colladitoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_usuarios_colladito', 'vtiger_usuarios_colladitocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_usuarios_colladito'   => 'usuarios_colladitoid',
			'vtiger_usuarios_colladitocf' => 'usuarios_colladitoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('usuarios_colladito', 'cod_usuarios_col'),
			'Nombres' => array ('usuarios_colladito', 'nombres'),
			'Apellidos' => array ('usuarios_colladito', 'apellidos'),
			'Telf' => array ('usuarios_colladito', 'telf'),
			'Correo Electrónico' => array ('usuarios_colladito', 'correo_electronico'),
			'Clientes ' => array ('usuarios_colladito', 'clientes_'),
			'Dirección' => array ('usuarios_colladito', 'direccion'),
			'Pais' => array ('usuarios_colladito', 'pais'),
			'Provincia' => array ('usuarios_colladito', 'provincia'),
			'Zona Postal' => array ('usuarios_colladito', 'zona_postal')
		);
		/**
		 ...
		 */
		public $popup_fields = array ('cod_usuarios_col');
		 ...
		 */
		public $mandatory_fields = array ('cod_usuarios_col');
