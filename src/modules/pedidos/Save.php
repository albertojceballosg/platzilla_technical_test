<?php
	...
	$caseNumber = (isset ($_REQUEST ['case_number'])) ? $_REQUEST['case_number'] : '';
	
	header ("Location: index.php?module=$returnModule&action=$returnAction&record=$returnId&parenttab=$parentTab&mode={$modeEvent}&case_number={$caseNumber}&start={$pageNumber}{$search}{$urlPlatDb}");
