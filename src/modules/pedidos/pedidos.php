<?php
	...
	class pedidos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_pedidos';
		public $table_index = 'pedidosid';
		...
		public $customFieldTable = array ('vtiger_pedidoscf', 'pedidosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_pedidos', 'vtiger_pedidoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_pedidos'   => 'pedidosid',
			'vtiger_pedidoscf' => 'pedidosid',
		);
		/**
		...
		public $list_fields = array (
			'Código'      => array ('pedidos', 'cod_pedidos'),
			'Título'      => array ('pedidos', 'titulo'),
			'Descripción' => array ('pedidos', 'descripcion'),
			'Estado'      => array ('pedidos', 'estado_del_pedid'),
			'Tipo'        => array ('pedidos', 'tipo_de_pedido'),
			'Categoría'   => array ('pedidos', 'categoria_de_pedid'),
		);
		...
		public $list_fields_name = array (
			...
			'Estado'      => 'estado_del_pedid',
			'Tipo'        => 'tipo_de_pedido',
			'Categoría'   => 'categoria_de_pedid',
		);
		 ...
		 */
		public $popup_fields = array ('cod_pedidos');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_pedidos'));
