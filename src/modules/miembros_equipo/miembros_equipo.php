<?php
	...
	class miembros_equipo extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_miembros_equipo';
		public $table_index = 'miembros_equipoid';
		...
		public $customFieldTable = array ('vtiger_miembros_equipocf', 'miembros_equipoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_miembros_equipo', 'vtiger_miembros_equipocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_miembros_equipo'   => 'miembros_equipoid',
			'vtiger_miembros_equipocf' => 'miembros_equipoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('miembros_equipo', 'cod_miembros_equ'),
			'Nombre' => array ('miembros_equipo', 'nombre'),
			'Apellidos' => array ('miembros_equipo', 'apellidos'),
			'Sexo' => array ('miembros_equipo', 'sexo'),
			'Edad' => array ('miembros_equipo', 'edad'),
			'Tipo de miembro' => array ('miembros_equipo', 'tipo_de_miembro'),
			'Perfil' => array ('miembros_equipo', 'perfil'),
			'Nivel estudios' => array ('miembros_equipo', 'nivel_estudios')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_miembros_equ',
			'Nombre' => 'nombre',
			'Apellidos' => 'apellidos',
			'Sexo' => 'sexo',
			'Edad' => 'edad',
			'Tipo de miembro' => 'tipo_de_miembro',
			'Perfil' => 'perfil',
		 ...
		 */
		public $list_link_field = 'cod_miembros_equ';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_miembros_equ';
		 ...
		 */
		public $popup_fields = array ('cod_miembros_equ');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_miembros_equ'));
