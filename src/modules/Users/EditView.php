...
if(isset($_REQUEST['record']) && isset($_REQUEST['record'])) {
	...
	$mode='edit';
	if ((!is_admin($current_user) && $_REQUEST['record'] != $current_user->id) && !in_array($current_user->column_fields['roleid'],$lstRoles)) die ("Unauthorized access to user administration.");
...
if ($empresaFacil || $gestoriaFacil || $clienteGestoriaFacil)
	$smarty->assign("MENU", 'false');//Los clientes de estas plataformas no deben ver el men� de administraci�n
// END
