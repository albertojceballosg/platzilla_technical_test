...
if ($ajaxaction == "GET_LOGIN_TOKEN") {
	$tokenval = rand(0, 999999) . microtime();
	...
	$adb->pquery("insert into vtiger_logintoken (token, gentime, duration_hrs, loggeduserid, used) values (?,?,?,?,0)", array($tokenval, time(), 1, $current_user->id));
