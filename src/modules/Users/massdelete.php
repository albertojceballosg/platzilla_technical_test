 ...
 ********************************************************************************/
	...
	$isHome          = isset ($_REQUEST ['isHomeTab']) ? vtlib_purify ($_REQUEST ['isHomeTab']) : null;
	...
	if (!empty ($isHome)) {
		echo (!empty ($errormsg)) ? $errormsg : 'ok';
		exit ();
	}
	...
	} else if($return_action == 'ActivityAjax') {
