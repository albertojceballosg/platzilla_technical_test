<?php
	...
	class auditoria extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_auditoria';
		public $table_index = 'auditoriaid';
		...
		public $customFieldTable = array ('vtiger_auditoriacf', 'auditoriaid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_auditoria', 'vtiger_auditoriacf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_auditoria'   => 'auditoriaid',
			'vtiger_auditoriacf' => 'auditoriaid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('auditoria', 'cod_auditoria'),
			'Título ' => array ('auditoria', 'titulo_'),
			'xxx' => array ('auditoria', 'xxx')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_auditoria';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_auditoria';
		 ...
		 */
		public $popup_fields = array ('cod_auditoria');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_auditoria'));
