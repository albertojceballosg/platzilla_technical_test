<?php
	...
	class organizational_values extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_organizational_values';
		public $table_index = 'organizational_valuesid';
		...
		public $customFieldTable = array ('vtiger_organizational_valuescf', 'organizational_valuesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_organizational_values', 'vtiger_organizational_valuescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_organizational_values'   => 'organizational_valuesid',
			'vtiger_organizational_valuescf' => 'organizational_valuesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('organizational_values', 'cod_organizational_values'),
			'Fecha' => array ('organizational_values', 'value_date'),
			'Versión' => array ('organizational_values', 'version'),
			'Origen' => array ('organizational_values', 'origin'),
			'Estado' => array ('organizational_values', 'value_status'),
			'Fin de vigencia' => array ('organizational_values', 'end_date'),
			'Razón del descarte' => array ('organizational_values', 'discard_note'),
			'Valor' => array ('organizational_values', 'value'),
			'Descripción' => array ('organizational_values', 'description')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_organizational_values',
			'Fecha' => 'value_date',
			'Versión' => 'version',
			'Origen' => 'origin',
			'Estado' => 'value_status',
			'Fin de vigencia' => 'end_date',
			'Razón del descarte' => 'discard_note',
			'Valor' => 'value',
		 ...
		 */
		public $list_link_field = 'cod_organizational_values';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_organizational_values';
		 ...
		 */
		public $popup_fields = array ('cod_organizational_values');
		 ...
		 */
		public $mandatory_fields = array ('cod_organizational_values');
