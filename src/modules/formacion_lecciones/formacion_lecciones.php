<?php
	...
	class formacion_lecciones extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_formacion_lecciones';
		public $table_index = 'formacion_leccionesid';
		...
		public $customFieldTable = array ('vtiger_formacion_leccionescf', 'formacion_leccionesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_formacion_lecciones', 'vtiger_formacion_leccionescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_formacion_lecciones'   => 'formacion_leccionesid',
			'vtiger_formacion_leccionescf' => 'formacion_leccionesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('formacion_lecciones', 'cod_formacion_le'),
			'Título' => array ('formacion_lecciones', 'titulo'),
			'Descripción' => array ('formacion_lecciones', 'descripcion'),
			'Introducción' => array ('formacion_lecciones', 'introduccion'),
			'Actividades' => array ('formacion_lecciones', 'actividades'),
			'Materiales' => array ('formacion_lecciones', 'materiales'),
			'Contenido' => array ('formacion_lecciones', 'contenido'),
			'URL Video' => array ('formacion_lecciones', 'url_video'),
			'URL Página' => array ('formacion_lecciones', 'url_pagina')
		);
		/**
         ...
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_formacion_le';
