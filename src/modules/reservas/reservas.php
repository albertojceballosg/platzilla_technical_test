<?php
	...
	class reservas extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_reservas';
		public $table_index   = 'reservasid';
		...
		public $customFieldTable = array ('vtiger_reservascf', 'reservasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_reservas', 'vtiger_reservascf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'  => 'crmid',
			'vtiger_reservas'   => 'reservasid',
			'vtiger_reservascf' => 'reservasid',
		);
		/**
		...
		public $list_fields = array (
			'Código'         => array ('reservas', 'cod_reservas'),
			'Cliente'        => array ('reservas', 'cliente'),
			'Alias'          => array ('reservas', 'alias'),
			'Inicio Reserva' => array ('reservas', 'inicio_reserva'),
			'Fin de Reserva' => array ('reservas', 'fin_de_reserva'),
			'Observaciones'  => array ('reservas', 'observaciones'),
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_reservas';
		...
		public $search_fields = array (
			...
			'Inicio Reserva' => array ('reservas', 'inicio_reserva'),
			'Fin de Reserva' => array ('reservas', 'fin_de_reserva'),
			'Centro'         => array ('reservas', 'centro'),
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		 */
		public $search_fields_name = array ('Código' => 'cod_reservas');
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('cod_reservas', 'inicio_reserva', 'fin_de_reserva', 'centro');
		 ...
		 */
		public $mandatory_fields = array ('cod_reservas');
