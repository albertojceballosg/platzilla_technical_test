<?php
	...
	class unidad_negocio extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_unidad_negocio';
		public $table_index = 'unidad_negocioid';
		...
		public $customFieldTable = array ('vtiger_unidad_negociocf', 'unidad_negocioid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_unidad_negocio', 'vtiger_unidad_negociocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_unidad_negocio'   => 'unidad_negocioid',
			'vtiger_unidad_negociocf' => 'unidad_negocioid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('unidad_negocio', 'cod_unidad_negoc'),
			'Nombre' => array ('unidad_negocio', 'nombre'),
			'Descripción' => array ('unidad_negocio', 'descripcion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_unidad_negoc';
		 ...
		 */
		public $popup_fields = array ('cod_unidad_negoc');
		 ...
		 */
		public $mandatory_fields = array ('cod_unidad_negoc');
