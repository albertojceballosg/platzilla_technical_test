<?php
	...
	class presupuestos_cotizacion extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_presupuestos_cotizacion';
		public $table_index = 'presupuestos_cotizacionid';
		...
		public $customFieldTable = array ('vtiger_presupuestos_cotizacioncf', 'presupuestos_cotizacionid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_presupuestos_cotizacion', 'vtiger_presupuestos_cotizacioncf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_presupuestos_cotizacion'   => 'presupuestos_cotizacionid',
			'vtiger_presupuestos_cotizacioncf' => 'presupuestos_cotizacionid',
		);
		/**
		...
		public $list_fields = array (
			'Código'        => array ('presupuestos_cotizacion', 'cod_presupuestos_cotizacion'),
			'Cliente'       => array ('presupuestos_cotizacion', 'cliente'),
			'Prospecto'     => array ('presupuestos_cotizacion', 'potencial_cliente'),
			'Estado'        => array ('presupuestos_cotizacion', 'estado_presupuesto'),
			'Fecha de emisión' => array ('presupuestos_cotizacion', 'fecha_emision'),
			'Validez hasta' => array ('presupuestos_cotizacion', 'fecha_de_validez'),
			//'Observaciones' => array ('presupuestos_cotizacion', 'observaciones'),
			//'Campaña' => array ('presupuestos_cotizacion', 'campana')
		);
		...
		public $list_fields_name = array (
			'Código'        => 'cod_presupuestos_cotizacion',
			'Cliente'       => 'cliente',
			'Prospecto'     => 'potencial_cliente',
			'Estado'        => 'estado_presupuesto',
			'Fecha de emisión' => 'fecha_emision',
			'Validez hasta' => 'fecha_de_validez',
		 ...
		 */
		public $list_link_field = 'cod_presupuestos_cotizacion';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_presupuestos_cotizacion';
		 ...
		 */
		public $popup_fields = array ('cod_presupuestos_cotizacion');
		...
		public $def_basicsearch_col = 'cod_presupuestos_cotizacion';
		/** @var string Column value to use on detail view record text display */
		public $def_detailview_recname = 'cod_presupuestos_cotizacion';
		/**
		 * @var array Required Information for enabling Import feature
		 * $required_fields = array('payslipname'=>1);
		 */
		public $required_fields = array ('cod_presupuestos_cotizacion' => 1);
		/** @var array Callback function list during Importing */
		public $special_functions = array ('set_import_assigned_user');
		/** @var string */
		public $default_order_by = 'cod_presupuestos_cotizacion';
		/** @var string */
		 ...
		 */
		public $mandatory_fields = array ('cod_presupuestos_cotizacion');
