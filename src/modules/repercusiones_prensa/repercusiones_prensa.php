<?php
	...
	class repercusiones_prensa extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_repercusiones_prensa';
		public $table_index = 'repercusiones_prensaid';
		...
		public $customFieldTable = array ('vtiger_repercusiones_prensacf', 'repercusiones_prensaid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_repercusiones_prensa', 'vtiger_repercusiones_prensacf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_repercusiones_prensa'   => 'repercusiones_prensaid',
			'vtiger_repercusiones_prensacf' => 'repercusiones_prensaid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('repercusiones_prensa', 'cod_repercusione'),
			'Títular' => array ('repercusiones_prensa', 'titular'),
			'Tipo' => array ('repercusiones_prensa', 'tipo')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_repercusione';
		 ...
		 */
		public $popup_fields = array ('cod_repercusione');
		 ...
		 */
		public $mandatory_fields = array ('cod_repercusione');
