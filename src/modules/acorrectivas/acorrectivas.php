<?php
	...
	class acorrectivas extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_acorrectivas';
		public $table_index   = 'acorrectivasid';
		...
		public $customFieldTable = array ('vtiger_acorrectivascf', 'acorrectivasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_acorrectivas', 'vtiger_acorrectivascf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'      => 'crmid',
			'vtiger_acorrectivas'   => 'acorrectivasid',
			'vtiger_acorrectivascf' => 'acorrectivasid',
		);
		/**
		...
		public $list_fields = array (
			'Nombre'         => array ('acorrectivas', 'nombre'),
			'Descripción'    => array ('acorrectivas', 'descripcion'),
			'No Conformidad' => array ('acorrectivas', 'no_conformidad'),
			'Tipo'           => array ('acorrectivas', 'tipo'),
			'Notas'          => array ('acorrectivas', 'notas'),
			'Estado'         => array ('acorrectivas', 'estado'),
			'Resultado'      => array ('acorrectivas', 'resultado'),
		);
		/**
		 ...
		 * 'Payslip Name'=> 'payslipname'
		 */
		public $search_fields_name = array ('Nombre' => 'nombre');
		/**
		 ...
		 * Parameters: $module, $fieldname, $srcrecord, $query = ''
		 */
