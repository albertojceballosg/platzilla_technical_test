<?php
	...
	class nonconformities extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_nonconformities';
		public $table_index = 'nonconformitiesid';
		...
		public $customFieldTable = array ('vtiger_nonconformitiescf', 'nonconformitiesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_nonconformities', 'vtiger_nonconformitiescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_nonconformities'   => 'nonconformitiesid',
			'vtiger_nonconformitiescf' => 'nonconformitiesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('nonconformities', 'cod_nonconformities'),
			'Asunto que origina la NC' => array ('nonconformities', 'issue_originates_nc'),
			'Tipo de NC' => array ('nonconformities', 'nc_type'),
			'Clase de NC' => array ('nonconformities', 'nc_class'),
			'Especifique otra clase' => array ('nonconformities', 'specify_other_class_nc'),
			'Precisar la clase de NC' => array ('nonconformities', 'specify_class_nc'),
			'Seleccione Producto' => array ('nonconformities', 'product_nc'),
			'Seleccione Proveedor' => array ('nonconformities', 'supplier_nc'),
			'Título' => array ('nonconformities', 'title_nc'),
			'Descripción' => array ('nonconformities', 'description_nc'),
			'Evidencias que la sustentan' => array ('nonconformities', 'evidences_nc'),
			'Criterio o Requisito incumplido' => array ('nonconformities', 'criterion_not_met_nc'),
			'Consecuencias de la NC' => array ('nonconformities', 'consequence_nc'),
			'Acción correctiva' => array ('nonconformities', 'corrective_action_nc'),
			'Estado' => array ('nonconformities', 'state_nc'),
			'Fecha inicio atención' => array ('nonconformities', 'start_of_care_nc'),
			'Fecha de resolución' => array ('nonconformities', 'date_resolution_nc')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_nonconformities',
			'Asunto que origina la NC' => 'issue_originates_nc',
			'Tipo de NC' => 'nc_type',
			'Clase de NC' => 'nc_class',
			'Especifique otra clase' => 'specify_other_class_nc',
			'Precisar la clase de NC' => 'specify_class_nc',
			'Seleccione Producto' => 'product_nc',
			'Seleccione Proveedor' => 'supplier_nc',
			'Título' => 'title_nc',
			'Descripción' => 'description_nc',
			'Evidencias que la sustentan' => 'evidences_nc',
			'Criterio o Requisito incumplido' => 'criterion_not_met_nc',
			'Consecuencias de la NC' => 'consequence_nc',
			'Acción correctiva' => 'corrective_action_nc',
			'Estado' => 'state_nc',
			'Fecha inicio atención' => 'start_of_care_nc',
			'Fecha de resolución' => 'date_resolution_nc'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_nonconformities';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_nonconformities';
		 ...
		 */
		public $popup_fields = array ('cod_nonconformities');
		 ...
		 */
		public $mandatory_fields = array ('cod_nonconformities');
