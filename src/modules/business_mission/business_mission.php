<?php
	...
	class business_mission extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_business_mission';
		public $table_index = 'business_missionid';
		...
		public $customFieldTable = array ('vtiger_business_missioncf', 'business_missionid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_business_mission', 'vtiger_business_missioncf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_business_mission'   => 'business_missionid',
			'vtiger_business_missioncf' => 'business_missionid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('business_mission', 'cod_business_mission'),
			'Fecha de emisión' => array ('business_mission', 'mission_date'),
			'Versión' => array ('business_mission', 'version'),
			'Estado' => array ('business_mission', 'mission_status'),
			'Fin de vigencia' => array ('business_mission', 'end_date'),
			'Razón del descarte' => array ('business_mission', 'discard_notes'),
			'Misión' => array ('business_mission', 'mission'),
			'Descripción' => array ('business_mission', 'description')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_business_mission',
			'Fecha de emisión' => 'mission_date',
			'Versión' => 'version',
			'Estado' => 'mission_status',
			'Fin de vigencia' => 'end_date',
			'Razón del descarte' => 'discard_notes',
			'Misión' => 'mission',
		 ...
		 */
		public $list_link_field = 'cod_business_mission';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_business_mission';
		 ...
		 */
		public $popup_fields = array ('cod_business_mission');
		 ...
		 */
		public $mandatory_fields = array ('cod_business_mission');
