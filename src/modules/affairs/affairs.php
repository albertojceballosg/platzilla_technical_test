<?php
	...
	class affairs extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_affairs';
		public $table_index = 'affairsid';
		...
		public $customFieldTable = array ('vtiger_affairscf', 'affairsid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_affairs', 'vtiger_affairscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_affairs'   => 'affairsid',
			'vtiger_affairscf' => 'affairsid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('affairs', 'cod_affairs'),
			'Título' => array ('affairs', 'affair_title'),
			'Descripción' => array ('affairs', 'affair_description'),
			'Fecha' => array ('affairs', 'affair_date'),
			'Naturaleza' => array ('affairs', 'affair_nature'),
			'Prioridad' => array ('affairs', 'affair_priority'),
			'Estado' => array ('affairs', 'affair_status'),
			'¿Hay clientes afectados?' => array ('affairs', 'customer_affected'),
			'Comentarios' => array ('affairs', 'affair_results'),
			'Razón de cancelación/Descarte' => array ('affairs', 'closing_notes'),
			'Fecha de cierre' => array ('affairs', 'affair_closing_date')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_affairs',
			'Título' => 'affair_title',
			'Descripción' => 'affair_description',
			'Fecha' => 'affair_date',
			'Naturaleza' => 'affair_nature',
			'Prioridad' => 'affair_priority',
			'Estado' => 'affair_status',
			'¿Hay clientes afectados?' => 'customer_affected',
			'Comentarios' => 'affair_results',
			'Razón de cancelación/Descarte' => 'closing_notes',
			'Fecha de cierre' => 'affair_closing_date'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname) selected on Creator
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_affairs';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_affairs';
		 ...
		 */
		public $popup_fields = array ('cod_affairs');
		 ...
		 */
		public $mandatory_fields = array ('cod_affairs');
