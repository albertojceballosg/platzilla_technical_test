<?php
	...
	class campanas extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_campanas';
		public $table_index = 'campanasid';
		...
		public $customFieldTable = array ('vtiger_campanascf', 'campanasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_campanas', 'vtiger_campanascf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_campanas'   => 'campanasid',
			'vtiger_campanascf' => 'campanasid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('campanas', 'cod_campanas'),
			'Nombre campaña' => array ('campanas', 'nombre_campana'),
			'Lista' => array ('campanas', 'lista')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_campanas';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_campanas';
		 ...
		 */
		public $popup_fields = array ('cod_campanas');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_campanas'));
