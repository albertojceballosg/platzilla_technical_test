<?php
	...
	class equipamientos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_equipamientos';
		public $table_index = 'equipamientosid';
		...
		public $customFieldTable = array ('vtiger_equipamientoscf', 'equipamientosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_equipamientos', 'vtiger_equipamientoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_equipamientos'   => 'equipamientosid',
			'vtiger_equipamientoscf' => 'equipamientosid',
		);
		/**
		...
		public $list_fields = array (
			//'Código' => array ('equipamientos', 'cod_equipamiento'),
			'Nombre'   => array ('equipamientos', 'nombre'),
			'Tipo'     => array ('equipamientos', 'tipo_de_equipamiento'),
			'Estado'   => array ('equipamientos', 'estado_equipo'),
			//'Numero de serie' => array ('equipamientos', 'numero_de_serie'),
			'¿Propio?' => array ('equipamientos', 'es_propio'),
			'Cliente'  => array ('equipamientos', 'cliente')
		);
		//NombreTipo activoEstado activo¿Es propio?Cliente
		...
		public $list_fields_name = array (
			'Código'          => 'cod_equipamiento',
			'Nombre'          => 'nombre',
			'Tipo'            => 'tipo_de_equipamiento',
         ...
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_equipamiento';
		 ...
		 */
		public $popup_fields = array ('cod_equipamiento');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_equipamiento'));
