<?php
	...
	global $mod_strings, $app_strings, $app_list_strings, $current_language, $currentModule, $current_userid, $theme, $adb, $image_path;
	...
	$smarty->assign('NAVIGATION',$ret_arr['navigation']);
