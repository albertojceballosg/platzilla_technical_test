<?php
	...
	class articulos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_articulos';
		public $table_index = 'articulosid';
		...
		public $customFieldTable = array ('vtiger_articuloscf', 'articulosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_articulos', 'vtiger_articuloscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_articulos'   => 'articulosid',
			'vtiger_articuloscf' => 'articulosid',
		);
		/**
		...
		public $list_fields = array (
			//'Código' => array ('articulos', 'cod_articulos'),
			'Nombre del artículo'  => array ('articulos', 'nombre_del_articulo'),
			'Tipo'                 => array ('articulos', 'tipo_de_articulo'),
			'Descripción'          => array ('articulos', 'descripcion'),
			'Estado'               => array ('articulos', 'estado_del_articulo'),
			'Existencia'           => array ('articulos', 'cantidad_disponible'),
			'Precio sin impuestos' => array ('articulos', 'precio_sin_impuestos'),
			//'Impuesto' => array ('articulos', 'impuesto'),
		);
		...
		public $list_fields_name = array (
			'Código'               => 'cod_articulos',
			'Nombre del artículo'  => 'nombre_del_articulo',
			'Tipo'                 => 'tipo_de_articulo',
			'Descripción'          => 'descripcion',
			'Estado'               => 'estado_del_articulo',
			'Imagen artículo'      => 'imagen_articulo',
		 ...
		 */
		public $list_link_field = 'nombre_del_articulo';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_articulos';
		 ...
		 */
		public $popup_fields = array ('cod_articulos');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_articulos'));
