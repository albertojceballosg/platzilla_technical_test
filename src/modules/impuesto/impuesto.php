<?php
	...
	class impuesto extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_impuesto';
		public $table_index = 'impuestoid';
		...
		public $customFieldTable = array ('vtiger_impuestocf', 'impuestoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_impuesto', 'vtiger_impuestocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_impuesto'   => 'impuestoid',
			'vtiger_impuestocf' => 'impuestoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('impuesto', 'cod_impuesto'),
			'Nombre ' => array ('impuesto', 'nombre_'),
			'Valor' => array ('impuesto', 'valor')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_impuesto';
		 ...
		 */
		public $popup_fields = array ('cod_impuesto');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_impuesto'));
