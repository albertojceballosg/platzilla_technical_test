<?php
	...
	class formacion_pruebas extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_formacion_pruebas';
		public $table_index = 'formacion_pruebasid';
		...
		public $customFieldTable = array ('vtiger_formacion_pruebascf', 'formacion_pruebasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_formacion_pruebas', 'vtiger_formacion_pruebascf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_formacion_pruebas'   => 'formacion_pruebasid',
			'vtiger_formacion_pruebascf' => 'formacion_pruebasid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('formacion_pruebas', 'cod_formacion_pr'),
			'Título' => array ('formacion_pruebas', 'titulo'),
			'Descripción' => array ('formacion_pruebas', 'descripcion'),
			'Ponderación' => array ('formacion_pruebas', 'ponderacion'),
			'Puntaje mínimo' => array ('formacion_pruebas', 'puntaje_minimo'),
			'Tipo' => array ('formacion_pruebas', 'tipo_prueba')
		);
		/**
