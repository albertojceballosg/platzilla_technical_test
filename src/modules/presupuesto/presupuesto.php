<?php
	...
	class presupuesto extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_presupuesto';
		public $table_index = 'presupuestoid';
		...
		public $customFieldTable = array ('vtiger_presupuestocf', 'presupuestoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_presupuesto', 'vtiger_presupuestocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_presupuesto'   => 'presupuestoid',
			'vtiger_presupuestocf' => 'presupuestoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('presupuesto', 'cod_presupuesto'),
			'Número factura' => array ('presupuesto', 'numero_factura'),
			'Cliente' => array ('presupuesto', 'cliente'),
			'Fecha de vencimiento' => array ('presupuesto', 'fecha_de_vencimiento'),
			'Forma de pago' => array ('presupuesto', 'forma_de_pago'),
			'Estado factura' => array ('presupuesto', 'estado_factura')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_presupuesto';
		 ...
		 */
		public $popup_fields = array ('cod_presupuesto');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_presupuesto'));
