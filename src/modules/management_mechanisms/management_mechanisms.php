<?php
	...
	class management_mechanisms extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_management_mechanisms';
		public $table_index = 'management_mechanismsid';
		...
		public $customFieldTable = array ('vtiger_management_mechanismscf', 'management_mechanismsid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_management_mechanisms', 'vtiger_management_mechanismscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_management_mechanisms'   => 'management_mechanismsid',
			'vtiger_management_mechanismscf' => 'management_mechanismsid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('management_mechanisms', 'cod_management_mechanisms'),
			'Nombre' => array ('management_mechanisms', 'mechanisms_name'),
			'Descripción' => array ('management_mechanisms', 'description'),
			'Tipo' => array ('management_mechanisms', 'mechanisms_type'),
			'Naturaleza física' => array ('management_mechanisms', 'physical_nature')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_management_mechanisms',
			'Nombre' => 'mechanisms_name',
			'Descripción' => 'description',
			'Tipo' => 'mechanisms_type',
			'Naturaleza física' => 'physical_nature'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname) selected on Creator
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_management_mechanisms';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_management_mechanisms';
		 ...
		 */
		public $popup_fields = array ('cod_management_mechanisms');
		 ...
		 */
		public $mandatory_fields = array ('cod_management_mechanisms');
