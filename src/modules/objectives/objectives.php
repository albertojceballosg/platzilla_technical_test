<?php
	...
	class objectives extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_objectives';
		public $table_index = 'objectivesid';
		...
		public $customFieldTable = array ('vtiger_objectivescf', 'objectivesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_objectives', 'vtiger_objectivescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_objectives'   => 'objectivesid',
			'vtiger_objectivescf' => 'objectivesid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('objectives', 'cod_objectives'),
			'Título' => array ('objectives', 'title'),
			'¿Qué hacer?' => array ('objectives', 'to_do'),
			'¿Cómo hacerlo?' => array ('objectives', 'how_to_do_it'),
			'¿Para qué hacerlo?' => array ('objectives', 'why_do_it'),
			'Límite temporal' => array ('objectives', 'frequency'),
			'¿Es inspirador?' => array ('objectives', 'it_is_inspiring'),
			'¿Por qué es inspirador?' => array ('objectives', 'why_is_it_inspiring'),
			'¿Empuja a la empresa?' => array ('objectives', 'push_the_company'),
			'¿Por qué empuja a la empresa?' => array ('objectives', 'why_push_company'),
			'¿Exige un esfuerzo saludable?' => array ('objectives', 'demand_a_healthy_effort'),
			'¿Por qué exige un esfuerzo saludable?' => array ('objectives', 'why__require_a_effort'),
			'Resultado clave' => array ('objectives', 'key_result')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_objectives',
			'Título' => 'title',
			'¿Qué hacer?' => 'to_do',
			'¿Cómo hacerlo?' => 'how_to_do_it',
			'¿Para qué hacerlo?' => 'why_do_it',
			'Límite temporal' => 'frequency',
			'¿Es inspirador?' => 'it_is_inspiring',
			'¿Por qué es inspirador?' => 'why_is_it_inspiring',
			'¿Empuja a la empresa?' => 'push_the_company',
			'¿Por qué empuja a la empresa?' => 'why_push_company',
			'¿Exige un esfuerzo saludable?' => 'demand_a_healthy_effort',
			'¿Por qué exige un esfuerzo saludable?' => 'why__require_a_effort',
		 ...
		 */
		public $mandatory_fields = array ('title');
