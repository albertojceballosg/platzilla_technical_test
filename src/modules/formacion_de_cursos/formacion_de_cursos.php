<?php
	...
	class formacion_de_cursos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_formacion_de_cursos';
		public $table_index = 'formacion_de_cursosid';
		...
		public $customFieldTable = array ('vtiger_formacion_de_cursoscf', 'formacion_de_cursosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_formacion_de_cursos', 'vtiger_formacion_de_cursoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_formacion_de_cursos'   => 'formacion_de_cursosid',
			'vtiger_formacion_de_cursoscf' => 'formacion_de_cursosid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('formacion_de_cursos', 'cod_formacion_de'),
			'Título' => array ('formacion_de_cursos', 'titulo'),
			'Descripción' => array ('formacion_de_cursos', 'descripcion'),
			'Imagen' => array ('formacion_de_cursos', 'imagen'),
			'Puntuación' => array ('formacion_de_cursos', 'puntuacion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_formacion_de';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_formacion_de';
		 ...
		 */
		public $popup_fields = array ('cod_formacion_de');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_formacion_de'));
