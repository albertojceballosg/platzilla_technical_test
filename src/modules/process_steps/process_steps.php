<?php
	...
	class process_steps extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_process_steps';
		public $table_index = 'process_stepsid';
		...
		public $customFieldTable = array ('vtiger_process_stepscf', 'process_stepsid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_process_steps', 'vtiger_process_stepscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_process_steps'   => 'process_stepsid',
			'vtiger_process_stepscf' => 'process_stepsid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('process_steps', 'cod_process_steps'),
			'Nombre del paso' => array ('process_steps', 'step_name'),
			'Otros involucrados' => array ('process_steps', 'others_involved_step'),
			'Condiciones para su realización' => array ('process_steps', 'conditions_to_carry_out_step'),
			'Criterios de calidad' => array ('process_steps', 'quality_criteria_step'),
			'Descripción' => array ('process_steps', 'step_description'),
			'Entregables, resultados' => array ('process_steps', 'step_deliverables'),
			'Estado' => array ('process_steps', 'step_state')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_process_steps',
			'Nombre del paso' => 'step_name',
			'Otros involucrados' => 'others_involved_step',
			'Condiciones para su realización' => 'conditions_to_carry_out_step',
			'Criterios de calidad' => 'quality_criteria_step',
			'Descripción' => 'step_description',
			'Entregables, resultados' => 'step_deliverables',
			'Estado' => 'step_state'
		);
		/**
		 ...
		 */
		public $list_link_field = 'step_name';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_process_steps';
		 ...
		 */
		public $popup_fields = array ('step_name');
		 ...
		 */
		public $mandatory_fields = array ('step_name');
		...
		public function save_module ($module) {
			...
			try {
				StepsType::getInstance ($adb)->saveStep ($this->id, $current_user->id, $this->mode);
			} catch (Exception $e) {
