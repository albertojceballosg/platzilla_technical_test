...
?>
<div style="position: absolute; float: left; width:400px; margin-left: 25%; margin-top: -280px; border: 1px solid #dedede; padding: 6px;">
<h3> Informe de Consumo de Potencia de clientes</h3>
<?php
	$hoy = date("j-n-Y"); 
	$mes = date("M-Y");
	$hora = date("H:i:s"); 
	$consumoActual = rand(200, 800);
?>
<table style="margin-left: 6px; border: solid 1px #cdcccc;" cellspacing="0"> 
	<tr>
		<td width="200" style="border: solid 1px #cdcccc; background-color: #dedede;">
			Consumo Actual TOTAL(<?php echo $hora;?>)
		</td>
		<td width="75"style="border: solid 1px #cdcccc;">
			<span style="font-weight: bold; color: #f78b00;"><?php echo $consumoActual; ?> MWh </span>
		</td>
	</tr>
</table>

<h4> 5 Clientes más consumidores - Hoy </h4>
<p>  Este es el consumo acumulado por los 5 clientes que más potencia consumen</p>
	<script type="text/javascript" src="modules/Home/lib/swfobject.js"></script>
	<div id="flashcontent2">
		<strong>You need to upgrade your Flash Player</strong>
	</div>

	<script type="text/javascript">
		var so = new SWFObject("modules/Home/lib/amcolumn.swf", "amcolumn", "380", "180", "8", "#FFFFFF");
		so.addVariable("path", "modules/Home/lib/");
		so.addVariable("settings_file", encodeURIComponent("modules/Home/lib/amcolumn_settings2.xml"));        // you can set two or more different settings files here (separated by commas)
		so.addVariable("data_file", encodeURIComponent("modules/Home/lib/amcolumn_data2.xml"));			
