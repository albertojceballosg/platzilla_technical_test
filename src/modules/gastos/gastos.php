<?php
	...
	class gastos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_gastos';
		public $table_index = 'gastosid';
		...
		public $customFieldTable = array ('vtiger_gastoscf', 'gastosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_gastos', 'vtiger_gastoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_gastos'   => 'gastosid',
			'vtiger_gastoscf' => 'gastosid',
		);
		...
		public $list_fields = array (
			//'Código' => array ('gastos', 'cod_gastos'),
			'Documento' => array ('gastos', 'num_documento'),
			'Fecha'     => array ('gastos', 'fecha'),
			//'Imputación' => array ('gastos', 'imputacion'),
			'Concepto'  => array ('gastos', 'concepto'),
			'Importe'   => array ('gastos', 'importe'),
			//'Anotaciones' => array ('gastos', 'anotaciones'),
			'Proveedor'  => array ('gastos', 'proveedor_gastos'),
			//'Anexos' => array ('gastos', 'anexos'),
			'Naturaleza' => array ('gastos', 'naturaleza_gasto'),
			//'Cliente' => array ('gastos', 'cliente_gastos')
		);
		...
		public $list_fields_name = array (
			...
			'Proveedor'   => 'proveedor_gastos',
			'Anexos'      => 'anexos',
			'Naturaleza'  => 'naturaleza_gasto',
		 ...
		 */
		public $popup_fields = array ('cod_gastos');
		 ...
		 */
		public $mandatory_fields = array ('cod_gastos');
