<?php
	...
	class facturas extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_facturas';
		public $table_index = 'facturasid';
		...
		public $customFieldTable = array ('vtiger_facturascf', 'facturasid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_facturas', 'vtiger_facturascf');
		...
		public $list_fields = array (
			'Código' => array ('facturas', 'cod_facturas'),
			'Número factura'   => array ('facturas', 'numero_factura'),
			'Cliente'          => array ('facturas', 'cliente'),
			'Fecha de emisión' => array ('facturas', 'fecha_de_emision'),
			'Vencimiento'      => array ('facturas', 'fecha_de_vencimiento'),
			//'Forma de pago' => array ('facturas', 'forma_de_pago'),
			'Estado'           => array ('facturas', 'estado_factura')
		);
		...
		public $list_fields_name = array (
			...
			'Vencimiento'      => 'fecha_de_vencimiento',
		 ...
		 */
		public $list_link_field = 'cod_facturas';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_facturas';
		 ...
		 */
		public $popup_fields = array ('cod_facturas');
		/** @var array Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields */
		/*public $sortby_fields = array ();*/
		public $sortby_fields = array ('cod_facturas' 		=> 'vtiger_facturas.cod_facturas',
										'fecha_de_emision' 	=> 'vtiger_facturas.fecha_de_emision',
										'numero_factura' 	=> 'vtiger_facturas.numero_factura',
										'cliente' 			=> 'vtiger_facturas.cliente',
										'estado_factura' 	=> 'vtiger_facturas.estado_factura');
		/** @var string For Alphabetical search */
		public $def_basicsearch_col = 'cod_facturas';
		/** @var string Column value to use on detail view record text display */
		public $def_detailview_recname = 'cod_facturas';
		/**
		 * @var array Required Information for enabling Import feature
		 * $required_fields = array('payslipname'=>1);
		 */
		public $required_fields = array ('cod_facturas' => 1);
		/** @var array Callback function list during Importing */
		public $special_functions = array ('set_import_assigned_user');
		/** @var string */
		public $default_order_by = 'cod_facturas';
		/** @var string */
		 ...
		 */
		public $mandatory_fields = array (array ('cod_facturas'));
