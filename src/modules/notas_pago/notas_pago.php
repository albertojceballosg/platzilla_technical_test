<?php
	...
	class notas_pago extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_notas_pago';
		public $table_index   = 'notas_pagoid';
		...
		public $customFieldTable = array ('vtiger_notas_pagocf', 'notas_pagoid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_notas_pago', 'vtiger_notas_pagocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'    => 'crmid',
			'vtiger_notas_pago'   => 'notas_pagoid',
			'vtiger_notas_pagocf' => 'notas_pagoid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('notas_pago', 'cod_notas_pago'),
			'Título' => array ('notas_pago', 'titulo'),
			'Compra' => array ('notas_pago', 'compra'),
			'Valor'  => array ('notas_pago', 'valor'),
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_notas_pago';
		 ...
		 */
		public $popup_fields = array ('cod_notas_pago');
		 ...
		 */
		public $mandatory_fields = array ('cod_notas_pago');
