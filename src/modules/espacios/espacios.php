<?php
	...
	class espacios extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_espacios';
		public $table_index   = 'espaciosid';
		...
		public $customFieldTable = array ('vtiger_espacioscf', 'espaciosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_espacios', 'vtiger_espacioscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'  => 'crmid',
			'vtiger_espacios'   => 'espaciosid',
			'vtiger_espacioscf' => 'espaciosid',
		);
		/**
		...
		public $list_fields = array (
			'Código'    => array ('espacios', 'cod_espacios'),
			'Numero '   => array ('espacios', 'numero_'),
			'Tipo área' => array ('espacios', 'tipo_area'),
			'Capacidad' => array ('espacios', 'capacidad'),
			'Centro'    => array ('espacios', 'centro'),
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_espacios';
		 ...
		 * 'Payslip Name'=> 'payslipname'
		 */
		public $search_fields_name = array ('Numero ' => 'numero_');
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('numero_', 'tipo_area', 'centro');
		 ...
		 */
		public $mandatory_fields = array ('cod_espacios');
		...
		public function getQueryByModuleField ($module, $fieldname, $srcrecord, $query = '') {
			...
			if (($module != 'reservas') || ($centro == null)) {
				return null;
			}
			return "{$query} AND vtiger_espacios.centro='{$this->db->sql_escape_string ($centro)}'";
		}
