<?php
	...
	class process extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_process';
		public $table_index = 'processid';
		...
		public $customFieldTable = array ('vtiger_processcf', 'processid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_process', 'vtiger_processcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_process'   => 'processid',
			'vtiger_processcf' => 'processid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('process', 'cod_process'),
			'Título' => array ('process', 'process_title'),
			'Nivel del proceso' => array ('process', 'process_level'),
			'Área relacionada' => array ('process', 'process_area'),
			'Subárea' => array ('process', 'process_subarea'),
			'Requisitos para su realización' => array ('process', 'process_requirements'),
			'Descripción' => array ('process', 'process_description'),
			'Estado' => array ('process', 'process_state'),
			'Versión' => array ('process', 'process_version')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_process',
			'Título' => 'process_title',
			'Nivel del proceso' => 'process_level',
			'Área relacionada' => 'process_area',
			'Subárea' => 'process_subarea',
			'Requisitos para su realización' => 'process_requirements',
			'Descripción' => 'process_description',
			'Estado' => 'process_state',
			'Versión' => 'process_version'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_process';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_process';
		 ...
		 */
		public $popup_fields = array ('cod_process');
		 ...
		 */
		public $mandatory_fields = array ('cod_process');
		...
		public function save_module ($module) {
			...
			try {
				ProcessSteps::getInstance ($adb)->saveProcessSteps ($this->id, $this->mode);
			} catch (Exception $e) {
