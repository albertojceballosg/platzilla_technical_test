<?php
	...
	class procesos extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_procesos';
		public $table_index = 'procesosid';
		...
		public $customFieldTable = array ('vtiger_procesoscf', 'procesosid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_procesos', 'vtiger_procesoscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_procesos'   => 'procesosid',
			'vtiger_procesoscf' => 'procesosid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('procesos', 'cod_procesos'),
			'Título' => array ('procesos', 'titulo'),
			'Descripción' => array ('procesos', 'descripcion')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_procesos';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_procesos';
		 ...
		 */
		public $popup_fields = array ('cod_procesos');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_procesos'));
