<?php
	...
	class test4_create_module extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_test4_create_module';
		public $table_index = 'test4_create_moduleid';
		...
		public $customFieldTable = array ('vtiger_test4_create_modulecf', 'test4_create_moduleid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_test4_create_module', 'vtiger_test4_create_modulecf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_test4_create_module'   => 'test4_create_moduleid',
			'vtiger_test4_create_modulecf' => 'test4_create_moduleid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('test4_create_module', 'cod_test4_create_module'),
			'Titulo' => array ('test4_create_module', 'test_titulo'),
			'Nombres' => array ('test4_create_module', 'test_name'),
			'Descripción' => array ('test4_create_module', 'test_descripcion'),
			'Email' => array ('test4_create_module', 'test_email')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_test4_create_module',
			'Titulo' => 'test_titulo',
			'Nombres' => 'test_name',
			'Descripción' => 'test_descripcion',
			'Email' => 'test_email'
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_test4_create_module';
		 ...
		 */
		public $popup_fields = array ('cod_test4_create_module');
		 ...
		 */
		public $mandatory_fields = array ('cod_test4_create_module');
