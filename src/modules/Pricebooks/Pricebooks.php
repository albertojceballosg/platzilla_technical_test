<?php
	...
	class Pricebooks extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_pricebooks';
		...
		public $list_fields = array (
			'Código'        => array ('pricebooks', 'cod_pricebook'),
			'Nombre'        => array ('pricebooks', 'name'),
			'Multiplicador' => array ('pricebooks', 'multiplier'),
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_pricebook';
		 ...
		 * 'Payslip Name'=> 'payslipname'
		 */
		public $search_fields_name = array ('Código' => 'cod_pricebook');
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('cod_pricebook');
		 ...
		 */
		public $mandatory_fields = array ('cod_pricebook');
		...
		public static function runPreUninstallTasks (PearDatabase $adb) {
			if (!file_exists (__DIR__ . '/lib/PricebooksInstaller.class.php')) {
				return;
			}

			require_once ('modules/Pricebooks/lib/PricebooksInstaller.class.php');
			PricebooksInstaller::getInstance ()->runPreUninstallTasks ($adb);
		}
		...
		public static function runPostInstallTasks (PearDatabase $adb) {
			...
			require_once ('modules/Pricebooks/lib/PricebooksInstaller.class.php');
			PricebooksInstaller::getInstance ()->runPostInstallTasks ($adb);
		}
