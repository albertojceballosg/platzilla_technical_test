<?php
	...
	class business_objective extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_business_objective';
		public $table_index = 'business_objectiveid';
		...
		public $customFieldTable = array ('vtiger_business_objectivecf', 'business_objectiveid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_business_objective', 'vtiger_business_objectivecf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_business_objective'   => 'business_objectiveid',
			'vtiger_business_objectivecf' => 'business_objectiveid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('business_objective', 'cod_business_objective'),
			'Enunciado del objetivo' => array ('business_objective', 'objective_name'),
			'¿Qué persigue?' => array ('business_objective', 'looking_for'),
			'Tipo de objetivo' => array ('business_objective', 'objective_type'),
			'Áreas donde aplica' => array ('business_objective', 'area_name'),
			' ¿Cómo hacerlo?' => array ('business_objective', 'how_to_do'),
			'¿Para qué hacerlo?' => array ('business_objective', 'why_do_it'),
			'Criterio de evaluación' => array ('business_objective', 'evaluation_criteria'),
			'Más información' => array ('business_objective', 'objective_description'),
			'Fecha de formulación' => array ('business_objective', 'enunciation_date'),
			'Etapa donde aplica' => array ('business_objective', 'objective_phase'),
			'Tipo de empresa' => array ('business_objective', 'business_type'),
			'Estado' => array ('business_objective', 'objective_status'),
			'% de progreso' => array ('business_objective', 'progress_percentage'),
			'Forma de terminación' => array ('business_objective', 'completion_mode'),
			'Fecha de terminación' => array ('business_objective', 'completion_date'),
			'Observaciones' => array ('business_objective', 'objective_observation')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_business_objective',
			'Enunciado del objetivo' => 'objective_name',
			'¿Qué persigue?' => 'looking_for',
			'Tipo de objetivo' => 'objective_type',
			'Áreas donde aplica' => 'area_name',
			' ¿Cómo hacerlo?' => 'how_to_do',
			'¿Para qué hacerlo?' => 'why_do_it',
			'Criterio de evaluación' => 'evaluation_criteria',
			'Más información' => 'objective_description',
			'Fecha de formulación' => 'enunciation_date',
			'Etapa donde aplica' => 'objective_phase',
			'Tipo de empresa' => 'business_type',
			'Estado' => 'objective_status',
			'% de progreso' => 'progress_percentage',
			'Forma de terminación' => 'completion_mode',
			'Fecha de terminación' => 'completion_date',
			'Observaciones' => 'objective_observation'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_business_objective';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_business_objective';
		...
		public $search_fields = array (
			'Enunciado del objetivo' => array ('business_objective', 'cod_business_objective')
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		...
		public $search_fields_name = array (
			'Enunciado del objetivo' => 'cod_business_objective'
		);
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('cod_business_objective');
		 ...
		 */
		public $mandatory_fields = array ('cod_business_objective');
