<?php
	...
	class subscribers extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_subscribers';
		public $table_index = 'subscribersid';
		...
		public $customFieldTable = array ('vtiger_subscriberscf', 'subscribersid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_subscribers', 'vtiger_subscriberscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_subscribers'   => 'subscribersid',
			'vtiger_subscriberscf' => 'subscribersid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('subscribers', 'cod_subscribers'),
			'Correo Electronico' => array ('subscribers', 'correo_electronico'),
			'Nombre' => array ('subscribers', 'nombre'),
			'Apellido' => array ('subscribers', 'apellido'),
			'Cual es tu Perfil' => array ('subscribers', 'cual_es_tu_perfil'),
			'Imagen' => array ('subscribers', 'imagen')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_subscribers',
			'Correo Electronico' => 'correo_electronico',
			'Nombre' => 'nombre',
			'Apellido' => 'apellido',
			'Cual es tu Perfil' => 'cual_es_tu_perfil',
			'Imagen' => 'imagen'
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_subscribers';
		 ...
		 */
		public $popup_fields = array ('cod_subscribers');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_subscribers'));
