<?php
	...
	class clientes extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_clientes';
		public $table_index   = 'clientesid';
		...
		public $customFieldTable = array ('vtiger_clientescf', 'clientesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_clientes', 'vtiger_clientescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'  => 'crmid',
			'vtiger_clientes'   => 'clientesid',
			'vtiger_clientescf' => 'clientesid',
		);
		...
		public $list_fields = array (
			//'Código'           => array ('clientes', 'cod_clientes'),
			'Alias'            => array ('clientes', 'alias'),
			'Nombre comercial' => array ('clientes', 'nombre_comercial'),
			'Número Fiscal'    => array ('clientes', 'numero_fiscal'),
			'Email'            => array ('clientes', 'e_mail'),
			'Teléfono'         => array ('clientes', 'telefono'),
			'Ciudad'           => array ('clientes', 'ciudad'),
			//'Nombre sociedad'  => array ('clientes', 'nombre_sociedad'),
			//'N.I.F.'           => array ('clientes', 'nif'),
			//'Dirección'        => array ('clientes', 'direccion'),
			//'Provincia'        => array ('clientes', 'provincia'),
			//'País'             => array ('clientes', 'pais'),
			//'Comentarios'      => array ('clientes', 'comentarios'),
		);
		...
		public $list_fields_name = array (
			'Código'           => 'cod_clientes',
			'Alias'            => 'alias',
			'Nombre sociedad'  => 'nombre_sociedad',
         ...
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_clientes';
		 ...
		 * 'Payslip Name'=> 'payslipname'
		 */
		public $search_fields_name = array ('Nombre comercial' => 'nombre_comercial', 'Código' => 'cod_clientes',);
		/**
		 * @var array For Popup window record selection
		 * $popup_fields = array('payslipname');
		 */
		public $popup_fields = array ('nombre_comercial');
		 ...
		 */
		public $mandatory_fields = array ('nombre_comercial');
		...
		public static function runPreUninstallTasks (PearDatabase $adb) {
			if (!file_exists (__DIR__ . '/lib/CustomersInstaller.class.php')) {
				return;
			}

			require_once ('modules/clientes/lib/CustomersInstaller.class.php');
			CustomersInstaller::getInstance ()->runPreUninstallTasks ($adb);
		}
		...
		public static function runPostInstallTasks (PearDatabase $adb) {
			...
			require_once ('modules/clientes/lib/CustomersInstaller.class.php');
			CustomersInstaller::getInstance ()->runPostInstallTasks ($adb);
		}
