<?php
	...
	class almacenes extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_almacenes';
		public $table_index = 'almacenesid';
		...
		public $customFieldTable = array ('vtiger_almacenescf', 'almacenesid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_almacenes', 'vtiger_almacenescf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_almacenes'   => 'almacenesid',
			'vtiger_almacenescf' => 'almacenesid',
		);
		/**
		...
		public $list_fields = array (
			'Código'        => array ('almacenes', 'cod_almacenes'),
			'Nombre'        => array ('almacenes', 'nombre'),
			'Descripción'   => array ('almacenes', 'descripcion_almacen'),
			'Dirección'     => array ('almacenes', 'direccion'),
			'Código Postal' => array ('almacenes', 'codigo_postal'),
			'Provincia'     => array ('almacenes', 'provincia'),
			//'Ciudad' => array ('almacenes', 'ciudad')
		);
		/**
		...
		public $list_fields_name = array (
			'Código'        => 'cod_almacenes',
			'Nombre'        => 'nombre',
			'Descripción'   => 'descripcion_almacen',
			'Dirección'     => 'direccion',
		 ...
		 */
		public $list_link_field = 'cod_almacenes';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_almacenes';
