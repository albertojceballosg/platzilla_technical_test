<?php
	...
	try {
		...
		$repercussions      = RepercussionUtils::getRepercussionsByCustomerId ($adb, $customerId, $repercussionIds, $platzillaRootUri);
		...
		$fileName     = strtolower ("repercusiones-{$customer ['nombre_de_la_entidad']}-{$from->format ('Y_m_d')}-{$to->format ('Y_m_d')}.pdf");
	} catch (Exception $e) {
