<?php
	...
	class clientes_bdi extends CRMEntity {
		public $db;
		public $log;
		public $table_name    = 'vtiger_clientes_bdi';
		public $table_index   = 'clientes_bdiid';
		...
		public $customFieldTable = array ('vtiger_clientes_bdicf', 'clientes_bdiid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_clientes_bdi', 'vtiger_clientes_bdicf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'      => 'crmid',
			'vtiger_clientes_bdi'   => 'clientes_bdiid',
			'vtiger_clientes_bdicf' => 'clientes_bdiid',
		);
		/**
		...
		public $list_fields = array (
			'Nombre del cliente'               => array ('clientes_bdi', 'nombre_de_la_entidad'),
		);
		/**
		...
		public $search_fields = array (
			'Nombre del cliente' => array ('clientes_bdi', 'nombre_de_la_entidad'),
			'Tipo de cliente'    => array ('clientes_bdi', 'tipo_de_entidad'),
		);
		/**
		 * @var array Format: Field Label => fieldname
		 * 'Payslip Name'=> 'payslipname'
		...
		public $search_fields_name = array (
			'Nombre del cliente' => 'nombre_de_la_entidad',
			'Tipo de cliente'    => 'tipo_de_entidad',
		);
		/**
		...
		public $def_basicsearch_col = 'cod_clientes_bdi';
		 ...
		 */
		public $required_fields = array ('cod_clientes_bdi' => 1);
		/** @var array Callback function list during Importing */
		public $special_functions = array ('set_import_assigned_user');
		/** @var string */
		public $default_order_by = 'cod_clientes_bdi';
		/** @var string */
		 ...
		 */
		public $mandatory_fields = array ('cod_clientes_bdi');
