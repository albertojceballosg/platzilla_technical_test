<?php
	...
	class suscriptores_internet extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_suscriptores_internet';
		public $table_index = 'suscriptores_internetid';
		...
		public $customFieldTable = array ('vtiger_suscriptores_internetcf', 'suscriptores_internetid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_suscriptores_internet', 'vtiger_suscriptores_internetcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_suscriptores_internet'   => 'suscriptores_internetid',
			'vtiger_suscriptores_internetcf' => 'suscriptores_internetid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('suscriptores_internet', 'cod_suscriptores'),
			'Nombre' => array ('suscriptores_internet', 'nombre'),
			'E-mail' => array ('suscriptores_internet', 'e_mail')
		);
		/**
		 ...
		 */
		public $list_link_field = 'cod_suscriptores';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_suscriptores';
		 ...
		 */
		public $popup_fields = array ('cod_suscriptores');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_suscriptores'));
