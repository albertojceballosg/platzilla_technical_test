<?php
	...
	$selectcolumns = array(
		...
		array(
			'vtiger_activity:subject:Calendar_Subject:subject:V',
		...
		array(
			'vtiger_troubletickets:title:HelpDesk_Title:ticket_title:V',
		...
		array(
			'vtiger_quotes:subject:Quotes_Subject:subject:V',
		...
		array(
			'vtiger_purchaseorder:subject:PurchaseOrder_Subject:subject:V',
		...
		array(
			'vtiger_salesorder:subject:SalesOrder_Subject:subject:V',
		...
		array(
			'vtiger_campaign:campaignname:Campaigns_Campaign_Name:campaignname:V',
	...
	$sortorder = array(
		array(
			array(
				'columnname'=>'vtiger_leaddetails:leadsource:Leads_Lead_Source:leadsource:V',
				'sortorder'=>'Ascending',
			),
		),
		...
		array(
			array(
				'columnname'=>'vtiger_leaddetails:leadstatus:Leads_Lead_Status:leadstatus:V',
				'sortorder'=>'Ascending',
			),
		),
		...
		array(
			array(
				'columnname'=>'vtiger_potential:sales_stage:Potentials_Sales_Stage:sales_stage:V',
				'sortorder'=>'Ascending',
			),
		),
		...
		array(
			array(
				'columnname'=>'vtiger_troubletickets:priority:HelpDesk_Priority:ticketpriorities:V',
				'sortorder'=>'Ascending',
			),
		),
	);
	...
	$stdfilters = array(
		array(
			'columnname'=>'vtiger_crmentity:modifiedtime:modifiedtime:Calendar_Modified_Time',
	...
	$advfilters = array(
		array(
			array(
				'columnname'=>'vtiger_contactdetails:accountid:Contacts_Account_Name:account_id:V',
				'comparator'=>'n',
				'value'=>'',
			),
		),
		...
		array(
			array(
				'columnname'=>'vtiger_potential:potentialname:Potentials_Potential_Name:potentialname:V',
				'comparator'=>'n',
				'value'=>'',
			),
		),
		...
		array(
			array(
				'columnname'=>'vtiger_troubletickets:status:HelpDesk_Status:ticketstatus:V',
				'comparator'=>'n',
				'value'=>'Closed',
			),
		),
		...
		array(
			array(
				'columnname'=>'vtiger_quotes:quotestage:Quotes_Quote_Stage:quotestage:V',
				'comparator'=>'n',
				'value'=>'Accepted',
			),
