<?php
	...
	echo "<td style='border-bottom: 1px solid rgb(204, 204, 204);'  width='70%'><span class='genHeaderSmall'>".$mod_strings['LBL_NO_PERMISSION'].' '.$primarymodule.' '.$secondarymodule.'</span></td>';
	echo '</tr>';
	echo '<tr>';
