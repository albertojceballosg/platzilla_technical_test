<?php
	...
	class business_destination extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_business_destination';
		public $table_index = 'business_destinationid';
		...
		public $customFieldTable = array ('vtiger_business_destinationcf', 'business_destinationid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_business_destination', 'vtiger_business_destinationcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_business_destination'   => 'business_destinationid',
			'vtiger_business_destinationcf' => 'business_destinationid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('business_destination', 'cod_business_destination'),
			'Nombre' => array ('business_destination', 'destination_name'),
			'Descripción' => array ('business_destination', 'destination_description'),
			'Plazo de ejecución' => array ('business_destination', 'destination_term'),
			'Unidad del plazo' => array ('business_destination', 'term_unit'),
			'Categoría' => array ('business_destination', 'destination_category'),
			'Tipo empresa' => array ('business_destination', 'business_type_m'),
			'Etapa' => array ('business_destination', 'business_phase_m')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_business_destination',
			'Nombre' => 'destination_name',
			'Descripción' => 'destination_description',
			'Plazo de ejecución' => 'destination_term',
			'Unidad del plazo' => 'term_unit',
			'Categoría' => 'destination_category',
			'Tipo empresa' => 'business_type_m',
			'Etapa' => 'business_phase_m'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_business_destination';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_business_destination';
		 ...
		 */
		public $popup_fields = array ('cod_business_destination');
		 ...
		 */
		public $mandatory_fields = array ('cod_business_destination');
