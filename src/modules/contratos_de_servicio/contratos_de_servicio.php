<?php
	...
	class contratos_de_servicio extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_contratos_de_servicio';
		public $table_index = 'contratos_de_servicioid';
		...
		public $customFieldTable = array ('vtiger_contratos_de_serviciocf', 'contratos_de_servicioid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_contratos_de_servicio', 'vtiger_contratos_de_serviciocf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_contratos_de_servicio'   => 'contratos_de_servicioid',
			'vtiger_contratos_de_serviciocf' => 'contratos_de_servicioid',
		);
		/**
		...
		public $list_fields = array (
			'Código'           => array ('contratos_de_servicio', 'cod_contratos_de'),
			'Tipo de contrato' => array ('contratos_de_servicio', 'tipo_de_contrato'),
			'Estado'           => array ('contratos_de_servicio', 'estado_contrato'),
			'Naturaleza'       => array ('contratos_de_servicio', 'naturaleza_contr'),
			'Inicio'           => array ('contratos_de_servicio', 'fecha_de_inicio'),
			'Fecha de Finalización' => array ('contratos_de_servicio', 'fecha_finalizacion'),
			//'Descripción' => array ('contratos_de_servicio', 'descripcion'),
			//'Cliente' => array ('contratos_de_servicio', 'cliente'),
			//'Tipo de contrato' => array ('contratos_de_servicio', 'tipo_de_contrato'),
			//'Horas del contrato' => array ('contratos_de_servicio', 'horas_del_contrato'),
			//'Renovación automática' => array ('contratos_de_servicio', 'renovacion_automatica'),
			//'Horas consumidas' => array ('contratos_de_servicio', 'horas_consumidas'),
			//'Horas restantes' => array ('contratos_de_servicio', 'horas_restantes')
		);
		...
		public $list_fields_name = array (
			...
			'Naturaleza'            => 'naturaleza_contr',
			'Horas del contrato'    => 'horas_del_contrato',
		 ...
		 */
		public $list_link_field = 'cod_contratos_de';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_contratos_de';
		 ...
		 */
		public $popup_fields = array ('cod_contratos_de');
		 ...
		 */
		public $mandatory_fields = array (array ('cod_contratos_de'));
