<?php
	...
	class business_risk extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_business_risk';
		public $table_index = 'business_riskid';
		...
		public $customFieldTable = array ('vtiger_business_riskcf', 'business_riskid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_business_risk', 'vtiger_business_riskcf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_business_risk'   => 'business_riskid',
			'vtiger_business_riskcf' => 'business_riskid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('business_risk', 'cod_business_risk'),
			'Título' => array ('business_risk', 'risk_title'),
			'Descripción' => array ('business_risk', 'risk_description'),
			'Consecuencias' => array ('business_risk', 'risk_consequences'),
			'Probabilidad' => array ('business_risk', 'risk_likelihood'),
			'Factor de probabilidad' => array ('business_risk', 'risk_likelihood_factor'),
			'Impacto' => array ('business_risk', 'risk_impact'),
			'Factor de impacto' => array ('business_risk', 'risk_impact_factor'),
			'Tipo de acción a aplicar' => array ('business_risk', 'risk_action'),
			'¿Riesgo interno o de cliente?' => array ('business_risk', 'internal_customer_risk'),
			'Cliente relacionado' => array ('business_risk', 'risk_related_client'),
			'Fuente del riesgo' => array ('business_risk', 'risk_source'),
			'Especifique otra fuente' => array ('business_risk', 'specify_another_risk_source'),
			'¿Con qué elemento se relaciona?' => array ('business_risk', 'risk_related_element'),
			'Proyecto relacionado' => array ('business_risk', 'risk_related_project'),
			'Especifique, por favor' => array ('business_risk', 'related_indicator'),
			'Otro elemento relacionado' => array ('business_risk', 'another_element'),
			'Oportunidad relacionada' => array ('business_risk', 'risk_related_opportunity'),
			'Venta relacionada' => array ('business_risk', 'risk_related_sale'),
			'Artículo de inventario' => array ('business_risk', 'risk_related_item'),
			'Pedido relacionado' => array ('business_risk', 'risk_related_request'),
			'Plan de Servicios relacionado' => array ('business_risk', 'risk_related_service_plan'),
			'Trabajo relacionado' => array ('business_risk', 'related_work'),
			'Contrato relacionado' => array ('business_risk', 'risk_related_contract'),
			'Activo relacionado' => array ('business_risk', 'risk_related_asset'),
			'Tipo de empresa' => array ('business_risk', 'sys_business_type'),
			'Etapa de la empresa' => array ('business_risk', 'sys_business_phase'),
			'Fase del riesgo' => array ('business_risk', 'risk_phase'),
			'Bitácora de seguimiento' => array ('business_risk', 'follow_up_log'),
			'Horas empleadas' => array ('business_risk', 'hours_spent_at_risk'),
			'Fecha de terminación' => array ('business_risk', 'risk_termination_date')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_business_risk',
			'Título' => 'risk_title',
			'Descripción' => 'risk_description',
			'Consecuencias' => 'risk_consequences',
			'Probabilidad' => 'risk_likelihood',
			'Factor de probabilidad' => 'risk_likelihood_factor',
			'Impacto' => 'risk_impact',
			'Factor de impacto' => 'risk_impact_factor',
			'Tipo de acción a aplicar' => 'risk_action',
			'¿Riesgo interno o de cliente?' => 'internal_customer_risk',
			'Cliente relacionado' => 'risk_related_client',
			'Fuente del riesgo' => 'risk_source',
			'Especifique otra fuente' => 'specify_another_risk_source',
			'¿Con qué elemento se relaciona?' => 'risk_related_element',
			'Proyecto relacionado' => 'risk_related_project',
			'Especifique, por favor' => 'related_indicator',
			'Otro elemento relacionado' => 'another_element',
			'Oportunidad relacionada' => 'risk_related_opportunity',
			'Venta relacionada' => 'risk_related_sale',
			'Artículo de inventario' => 'risk_related_item',
			'Pedido relacionado' => 'risk_related_request',
			'Plan de Servicios relacionado' => 'risk_related_service_plan',
			'Trabajo relacionado' => 'related_work',
			'Contrato relacionado' => 'risk_related_contract',
			'Activo relacionado' => 'risk_related_asset',
			'Tipo de empresa' => 'sys_business_type',
			'Etapa de la empresa' => 'sys_business_phase',
			'Fase del riesgo' => 'risk_phase',
			'Bitácora de seguimiento' => 'follow_up_log',
			'Horas empleadas' => 'hours_spent_at_risk',
			'Fecha de terminación' => 'risk_termination_date'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_business_risk';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = 'cod_business_risk';
		 ...
		 */
		public $popup_fields = array ('cod_business_risk');
		 ...
		 */
		public $mandatory_fields = array ('cod_business_risk');
