<?php
	...
	class risk_control_actions extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_risk_control_actions';
		public $table_index = 'risk_control_actionsid';
		...
		public $customFieldTable = array ('vtiger_risk_control_actionscf', 'risk_control_actionsid');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_risk_control_actions', 'vtiger_risk_control_actionscf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_risk_control_actions'   => 'risk_control_actionsid',
			'vtiger_risk_control_actionscf' => 'risk_control_actionsid',
		);
		/**
		...
		public $list_fields = array (
			'Código' => array ('risk_control_actions', 'cod_risk_control_actions'),
			'Nombre de la acción' => array ('risk_control_actions', 'control_action_name'),
			'Tipo de estrategia de control' => array ('risk_control_actions', 'type_control_strategy'),
			'Tipo de empresa' => array ('risk_control_actions', 'sys_business_type'),
			'Descripción de la acción' => array ('risk_control_actions', 'control_action_description'),
			'Fecha de inicio' => array ('risk_control_actions', 'init_date_action'),
			'Estado de la acción' => array ('risk_control_actions', 'control_action_state'),
			'Forma de terminación' => array ('risk_control_actions', 'completion_status_action'),
			'Notas de seguimiento' => array ('risk_control_actions', 'control_action_note'),
			'Razón de la suspensión/cancelación' => array ('risk_control_actions', 'completion_status_reason')
		);
		/**
		...
		public $list_fields_name = array (
			'Código' => 'cod_risk_control_actions',
			'Nombre de la acción' => 'control_action_name',
			'Tipo de estrategia de control' => 'type_control_strategy',
			'Tipo de empresa' => 'sys_business_type',
			'Descripción de la acción' => 'control_action_description',
			'Fecha de inicio' => 'init_date_action',
			'Estado de la acción' => 'control_action_state',
			'Forma de terminación' => 'completion_status_action',
			'Notas de seguimiento' => 'control_action_note',
			'Razón de la suspensión/cancelación' => 'completion_status_reason'
		);
		/**
		 * @var string Make the field link to detail view from list view (Fieldname)
		 * $list_link_field = 'payslipname';
		 */
		public $list_link_field = 'cod_risk_control_actions';
		 ...
		 */
		public $popup_fields = array ('cod_risk_control_actions');
		 ...
		 */
		public $mandatory_fields = array ('cod_risk_control_actions');
