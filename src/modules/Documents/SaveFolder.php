...
global $adb;
	...
	$parentfolder = $_REQUEST['folder_id'];
	...
	if(isset($_REQUEST['savemode']) && $_REQUEST['savemode'] == 'Save')
	{
		if($folderid == "")
		{
			...
			if($flag == 0)
			{
				...
				$sql="insert into vtiger_attachmentsfolder (folderid,foldername,description,createdby,sequence,parentfolder)values ($fid,'".$foldername."','".$folderdesc."',".$current_user->id.",$sequence,$parentfolder)";
