<?php
	...
	global $adb, $app_strings, $app_list_strings, $current_user, $currentModule, $log, $mod_strings, $theme;
	...
	if ($disp_view == 'edit_view') {
		...
		$smarty->assign ("BLOCKS", getBlocks ($currentModule, $disp_view, $mode, $focus->column_fields, 'BAS'));
	}
...
<script language="javascript">
	jQuery (document).ready (function () {
		var dummy = jQuery ('#privado');
		if (dummy.prop ('checked') === true) {
			jQuery ("#usuariospermitidos").prop ('disabled', false);
		} else {
			jQuery ("#usuariospermitidos").prop ('disabled', true);
		}
		dummy.on ("change", "", function () {
			if (jQuery ('#privado').prop ('checked') == true) {
				jQuery ("#usuariospermitidos").prop ('disabled', false);
			} else {
				jQuery ("#usuariospermitidos").prop ('disabled', true);
			}
