...
if($ticketid != '')
{
	...
	{
		$list .= '
		   <tr><td colspan="4" class="detailedViewHeader"><b>'.getTranslatedString('LBL_ADD_COMMENT').'</b></td></tr>
		   ...
		   <tr>
			    <td><input class="crmbutton small cancel" title="'.getTranslatedString('LBL_SUBMIT').'" accesskey="S" class="small"  name="submit" value="'.getTranslatedString('LBL_SUBMIT').'" style="width: 70px;" type="submit" onclick="this.form.module.value=\'HelpDesk\';this.form.action.value=\'index\';this.form.fun.value=\'updatecomment\'; if(trim(this.form.comments.value) != \'\')	return true; else return false;"/></td>
		   </form>
			    <td colspan="2">&nbsp;</td>
			    <td>&nbsp;</td>
		   </tr>';
	...
	if($files_array[0] != "#MODULE INACTIVE#"){
		$list .= '
			   ...
			   <tr><td colspan="4" class="detailedViewHeader"><b>'.getTranslatedString('LBL_ATTACHMENTS').'</b></td></tr>';
