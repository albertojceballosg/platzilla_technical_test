...
class Vtiger_FieldBasic {
	...
	var $helpinfo = '';
	var $masseditable = 2; // Default: Enable massedit for field Modificado por Johana Romero pedido [TT11132] Fallas Editor Disposición - Platzilla
	...
	var	$sequence      = false;
	var	$quickcreate   = 2; //Modificado por Johana Romero pedido [TT11132] Fallas Editor Disposición - Platzilla
