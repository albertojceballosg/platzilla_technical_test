<?php
	...
	class {$_MODULE_NAME} extends CRMEntity {
		public $db;
		public $log;
		public $table_name = 'vtiger_{$_MODULE_NAME}';
		public $table_index = '{$_MODULE_NAME}id';
		...
		public $customFieldTable = array ('vtiger_{$_MODULE_NAME}cf', '{$_MODULE_NAME}id');
		/** @var array Mandatory for Saving, Include tables related to this module. */
		public $tab_name = array ('vtiger_crmentity', 'vtiger_{$_MODULE_NAME}', 'vtiger_{$_MODULE_NAME}cf');
		/** @var array Mandatory for Saving, Include tablename and tablekey columnname here. */
		public $tab_name_index = array (
			'vtiger_crmentity'         => 'crmid',
			'vtiger_{$_MODULE_NAME}'   => '{$_MODULE_NAME}id',
			'vtiger_{$_MODULE_NAME}cf' => '{$_MODULE_NAME}id',
		);
		/**
		 ...
		 */
		public $list_link_field = '{$_LINK_NAME}';
        
        /**
         * @var string Make the field link to detail view from list view alwys set
         * $defaultListLink = '';
         */
        public $defaultListLink = '{$_DEFAULT_LIST_LINK}';
		 ...
		 */
		public $popup_fields = {$_POPUP_FIELDS};
		 ...
		 */
		public $mandatory_fields = array ({$_MANDATORY_FIELDS});
